...
function perf_ui.draw()
	...
	lg.print(string.format("FPS: %d Memory: %d MB%s Frames: %d Coros: %d, Stms: %d", love.timer.getFPS(), collectgarbage("count") / 1024, mode_tag, perf.frames, perf.coros, perf.stms), x + 8, y + 6)
