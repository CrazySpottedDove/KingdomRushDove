...
function screen_map:ensure_config_panel_view()
	...
	local config_panel_view = ConfigPanelView:new(self.sw, self.sh, self.numeric_keyboard, self.window)
...
function screen_map:ensure_criket_panel_view()
	...
	local criket_panel_view = CriketPanelView:new(self.sw, self.sh, self.numeric_keyboard, self.window)
...
function screen_map:ensure_keyset_panel_view()
	...
	local keyset_panel_view = KeysetPanelView:new(self.sw, self.sh, self.numeric_keyboard, self.window)
...
function screen_map:ensure_ui_settings_panel_view()
	...
	local ui_settings_panel_view = UISettingsPanelView:new(self.sw, self.sh, self.numeric_keyboard, self.window)
...
function screen_map:ensure_launch_options_panel_view()
	...
	local launch_options_panel_view = LaunchOptionsPanelView:new(self.sw, self.sh, self.numeric_keyboard, self.window)
