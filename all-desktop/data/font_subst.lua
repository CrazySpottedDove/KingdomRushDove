...
return {
	...
	["zh-Hant"] = {
		...
		{"body_slides", "NotoSansCJKkr-Regular", {
			size = 1,
			["bottom-caps"] = 0,
			["middle-caps"] = -0.1,
			base = 0,
		...
		{"button", "NotoSansCJKkr-Bold", {
			top = -0.1,
			size = 1,
			middle = -0.1
		}},
		{"capitals", "NotoSansCJKkr-Bold"},
		{"h", "NotoSansCJKkr-Bold", {
			middle = -0.1,
			size = 1
		}},
		{"h_book", "NotoSansCJKkr-Bold"},
		{"h_map", "NotoSansCJKkr-Bold"},
		{"h_noti", "NotoSansCJKkr-Bold"},
		{"h_popup", "NotoSansCJKkr-Bold", {
			middle = 0,
			size = 1
		}},
		...
		{"hud", "NotoSansCJKkr-Bold", {
			size = 1.4
		}},
		{"infobar_name", "NotoSansCJKkr-Regular", {
			bottom = 0.15,
			size = 1
		}},
		{"infobar_stats", "NotoSansCJKkr-Regular", {
			size = 1
		}},
		{"sans", "NotoSansCJKkr-Regular"},
		{"sans_bold", "NotoSansCJKkr-Bold"},
		{"taunts", "NotoSansCJKkr-Bold", {
			["middle-caps"] = -0.05,
			size = 1.2
		}}
	},
	ja = {
		{"body", "ZinPenCiro_B"},
		{"body_bold", "ZinPenCiro_B"},
		{"body_slides", "ZinPenCiro_B"},
		{"button", "tetsubin_gothic", {
			middle = -0.05,
			size = 1
		}},
		{"capitals", "ZinHenaBokuryu_CRF"},
		{"h", "tetsubin_gothic"},
		{"h_book", "ZinHenaBokuryu_CRF"},
		{"h_map", "tetsubin_gothic", {
			middle = 0.15,
			size = 1
		}},
		{"h_noti", "tetsubin_gothic", {
			middle = 0.15,
			size = 1
		}},
		{"h_popup", "tetsubin_gothic", {
			middle = 0.25,
			size = 1
		}},
		...
		{"infobar_stats", "ZinPenCiro_B"},
		{"sans", "NotoSansCJKjp-Regular"},
		{"sans_bold", "NotoSansCJKjp-Bold"},
		{"taunts", "ZinPenCiro_B", {
			["middle-caps"] = 0,
			size = 1
		}}
	...
	ko = {
		...
		{"body_slides", "NanumPen", {
			size = 1.5
		}},
		{"button", "JejuHallasan_Regular", {
			bottom = 0.2,
			size = 1.3
		}},
		{"capitals", "BMYEONSUNG"},
		{"h", "JejuHallasan_Regular", {
			bottom = 0.2,
			size = 1.3
		}},
		{"h_book", "BMYEONSUNG"},
		{"h_map", "JejuHallasan_Regular", {
			middle = 0.1,
			size = 1.3,
			bottom = 0.2
		}},
		{"h_noti", "JejuHallasan_Regular", {
			middle = 0.1,
			size = 1.3,
			bottom = 0.2
		}},
		{"h_popup", "JejuHallasan_Regular", {
			middle = 0.1,
			size = 1.3,
			bottom = 0.2
		}},
		...
		{"infobar_name", "JejuHallasan_Regular", {
			bottom = 0,
			size = 1.2
		}},
		{"infobar_stats", "NanumPen", {
			size = 1.6
		}},
		{"sans", "NotoSansCJKkr-Regular"},
		{"sans_bold", "NotoSansCJKkr-Bold"},
