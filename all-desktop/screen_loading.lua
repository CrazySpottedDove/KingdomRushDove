...
function screen:draw()
	...
	for y = 0, h do
		local t = y / h
		g.setColor(0.08 - 0.03 * t, 0.10 - 0.03 * t, 0.14 - 0.02 * t, 1)
	...
	draw_pixel_dove(sprite_x, sprite_y, pixel_scale, phase, 1)
