...
zip -r "$ARCHIVE_DIR" . -x "*.dds" -x ".versions/*" -x "tmp/*" -x "*.exe" -x ".git/*" -x "KingdomRushDoveUpdater" -x "client.log" -x "client" -q
...
scp -P 60001 "$LOVE_FILE" root@10.112.99.5:/srv/files/王国保卫战Dove版-安卓端/