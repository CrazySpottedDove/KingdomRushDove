...
return {
	...
	tower_data = {
		...
		{
			name = "tower_shadow_archer",
			icon = 7,
			detail_icon = 7,
			from_kr = 4
		},
		{
			name = "tower_rotten_forest",
			icon = 9,
			detail_icon = 9,
			from_kr = 4
		},
		{
			name = "tower_bone_flingers",
			icon = 11,
			detail_icon = 11,
			from_kr = 4
		},
		{
			name = "tower_infernal_mage",
			icon = 10,
			detail_icon = 10,
			from_kr = 4
		}
	...
	map_animations3 = {
		...
		},
		{
			...
			sequence = {{"default", 3, 5}, {"go_out", 1, 3}, {"left", 1, 3}, {"right", 1, 3}, {"left", 1, 2}, {"right", 1, 2}, {"go_in", 0, 0}},
			animations = {
				default = {
					to = 89,
					prefix = "ma_ewok",
