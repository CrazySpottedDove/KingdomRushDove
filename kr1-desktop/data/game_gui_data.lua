...
local TOWER_MENU_BUTTON_X_UNIT = 56
...
return {
	...
	tower_menu_button_places = {
		...
		v(24, 120),
		v(124, 120),
		tower_menu_button_pos(0, 2),
		tower_menu_button_pos(-1, 1),
		tower_menu_button_pos(1, 1),
		v(128, 118),
		v(74, 140),
		tower_menu_button_pos(-2, 2),
		tower_menu_button_pos(2, 2),
		tower_menu_button_pos(-2, 1),
		tower_menu_button_pos(2, 1),
		tower_menu_button_pos(-3, 1),
		tower_menu_button_pos(3, 1),
		tower_menu_button_pos(-1, 2),
		tower_menu_button_pos(1, 2),
		tower_menu_button_pos(-3, 2),
		tower_menu_button_pos(3, 2),
		tower_menu_button_pos(0, 3),
		tower_menu_button_pos(-2, 3),
		tower_menu_button_pos(2, 3),
		tower_menu_button_pos(-4, 2),
		tower_menu_button_pos(4, 2),
		tower_menu_button_pos(-4, 1),
		tower_menu_button_pos(4, 1),
		tower_menu_button_pos(-4, 3),
		tower_menu_button_pos(4, 3)
	},
	...
	damage_icons = {
		default = "base_info_icons_sword",
		magic = "base_info_icons_magic",
		sword = "base_info_icons_sword",
		fireball = "base_info_icons_explosion",
		arrow = "base_info_icons_arrow",
		shot = "base_info_icons_shot",
		[DAMAGE_TRUE] = "base_info_icons_true",
		-- 远程的物理攻击在 game_gui 中额外处理，显示为箭伤
		[DAMAGE_PHYSICAL] = "base_info_icons_sword",
		[DAMAGE_MAGICAL] = "base_info_icons_magic",
		[DAMAGE_MAGICAL_EXPLOSION] = "base_info_icons_magic_explosion",
		[DAMAGE_EXPLOSION] = "base_info_icons_explosion",
		[DAMAGE_ELECTRICAL] = "base_info_icons_electrical",
		[DAMAGE_SHOT] = "base_info_icons_shot",
		[DAMAGE_RUDE] = "base_info_icons_rude",
		[DAMAGE_STAB] = "base_info_icons_stab",
