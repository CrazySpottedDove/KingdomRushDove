...
local kr5 = {
    ...
    TOWER_DARK_ELF_4_SKILL_BUFF_1_DESCRIPTION = "立刻提升暮光长弓手10%攻速，并使暮光长弓手每杀死一名敌人，伤害提升%$towers.dark_elf.skill_buff.extra_damage_min[1]%$-%$towers.dark_elf.skill_buff.extra_damage_max[1]%$，攻速额外加快1%（最多加快攻速15%），并使附近随机一座防御塔提升伤害0.8%。",
