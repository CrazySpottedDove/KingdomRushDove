...
PLEASE DON'T"] = "单击此处以跳过。\n请不要",
    ...
    TOWER_DARK_ELF_4_SKILL_BUFF_1_DESCRIPTION = "提升暮光长弓手10%攻速，并使暮光长弓手每杀死一名敌人，伤害提升%$towers.dark_elf.skill_buff.extra_damage_min[1]%$-%$towers.dark_elf.skill_buff.extra_damage_max[1]%$，攻速额外加快1%（最多加快攻速15%），并使附近随机一座防御塔提升伤害0.8%。以上效果最多触发20次。",
    TOWER_DARK_ELF_4_SKILL_BUFF_1_NAME = "猎杀戾气Ⅰ",
    TOWER_DARK_ELF_4_SKILL_BUFF_2_DESCRIPTION = "提升暮光长弓手10%攻速，并使暮光长弓手每杀死一名敌人，伤害提升%$towers.dark_elf.skill_buff.extra_damage_min[1]%$-%$towers.dark_elf.skill_buff.extra_damage_max[1]%$，攻速额外加快1%（最多加快攻速15%），并使附近随机一座防御塔提升伤害0.8%。以上效果最多触发50次。",
    TOWER_DARK_ELF_4_SKILL_BUFF_2_NAME = "猎杀戾气Ⅱ",
    TOWER_DARK_ELF_4_SKILL_BUFF_3_DESCRIPTION = "提升暮光长弓手10%攻速，并使暮光长弓手每杀死一名敌人，伤害提升%$towers.dark_elf.skill_buff.extra_damage_min[1]%$-%$towers.dark_elf.skill_buff.extra_damage_max[1]%$，攻速额外加快1%（最多加快攻速15%），并使附近随机一座防御塔提升伤害0.8%。以上效果无次数限制。",
