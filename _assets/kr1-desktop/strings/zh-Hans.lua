...
local kr2 = {
    ...
    ENDLESS_BOSS_GNOLL_TAUNT_GENERIC_0004 = "你管这个叫军队？这才叫军队！",
    rain_scorched_earth_DESCRIPTION = "陨石点燃地面5秒，灼烧走过的敌人。",
...
local kr5 = {
    ...
    JOYSTICK_HELP_INGAME_DPAD_UP = "英雄能力1",
    ...
    TOWER_DARK_ELF_4_SKILL_SOLDIERS_2_NAME = "利刃援军Ⅱ",
    ...
    TOWER_DARK_ELF_4_SKILL_SOLDIERS_3_NAME = "利刃援军Ⅲ",
    ...
    TOWER_DARK_ELF_4_SKILL_SOLDIERS_1_NAME = "利刃援军Ⅰ",
    ...
    TOWER_TRICANNON_4_BOMBARDMENT_2_DESCRIPTION = string.format(
        "扩大范围，发射更多炸弹，每枚造成%s-%s点物理伤害。",
        balance.towers.tricannon.bombardment.damage_min[2], balance.towers.tricannon.bombardment.damage_max[2]),
    ENEMY_DARKSTEEL_SHIELDER_EXTRA = "- 被击败后变成锤兵",
    SOLDIER_STAGE_10_YMCA_POLICIA_NAME = "维克多",
    heroes_visual_learning_NAME = "并肩作战",
    TOWER_TRICANNON_4_BOMBARDMENT_3_DESCRIPTION = string.format(
        "扩大范围，发射超多炸弹，每枚造成%s-%s点物理伤害。",
        balance.towers.tricannon.bombardment.damage_min[3], balance.towers.tricannon.bombardment.damage_max[3]),
    ...
    TOWER_TRICANNON_4_OVERHEAT_1_DESCRIPTION = string.format(
        "每隔%s秒，加农炮进入过载状态%s秒，使炸弹灼烧地面，对敌人每秒造成%s点真实伤害，持续%s秒。",
        balance.towers.tricannon.overheat.cooldown[1], balance.towers.tricannon.overheat.duration[1],
    ...
    TOWER_TRICANNON_4_BOMBARDMENT_1_DESCRIPTION = string.format(
        "在大范围内迅速发射多枚炸弹，每枚造成%s-%s点物理伤害。",
        balance.towers.tricannon.bombardment.damage_min[1], balance.towers.tricannon.bombardment.damage_max[1]),
    ...
    GIFT_CLAIMED = "礼物已领取！",
    None = "无",
    JOYSTICK_HELP_INGAME_DPAD_RIGHT = "英雄能力2",
    ...
    TOWER_DARK_ELF_CHANGE_MODE_FOREMOST_DESCRIPTION = "当前：瞄准最近敌人。若有敌人可一击杀死，则瞄准可一击毙命的敌人中生命值最高的。切换：瞄准生命值最高的敌人。",
