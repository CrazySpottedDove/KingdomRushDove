    ...
    groups = {
        ...
        hero_10yr = {
            sounds = {"TenShiTaunt", "TenShiTauntBuffed", "TenShiTauntIntro", "TenShiTauntSelect", "TenShiRespawn",
                      ...
                      "TenShiRainOfFireStart", "TenShiRainOfFireEnd", "TenShiBuffedSpinAttack",
                      "TenShiBuffedBombAttack", "TenShiBuffedBombAttackLong", "TenShiTransformToBuffedSfx",
                      "TenShiTransformToNormalSfx", "TenShiDeathSfx", "TenShiTeleportSfx"}
        },
        hero_alien = {
            alias = "HeroAlien"
        },
