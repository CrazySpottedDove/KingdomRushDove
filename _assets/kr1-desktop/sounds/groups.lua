return {
	...
	BossEfreeti = {
		files = {"boss_efreeti_clapping.ogg", "boss_efreeti_death.ogg", "boss_efreeti_evillaugh.ogg", "boss_efreeti_snapping.ogg", "boss_efreeti_summon.ogg", "efreeti_doors.ogg", "efreeti_towers_released.ogg"}
	},
	BossMonkey = {
		files = {"boss_mono_attack.ogg", "boss_mono_chestdrum.ogg", "boss_mono_chimps_1.ogg", "boss_mono_chimps_2.ogg", "boss_mono_chimps_3.ogg", "boss_mono_death.ogg", "boss_mono_enterscene.ogg", "boss_mono_saltototem.ogg", "boss_mono_totem.ogg"}
	},
	DwarfHeroSounds = {
		files = {"dwarfHero_taunt_confirm_1.ogg", "dwarfHero_taunt_confirm_2.ogg", "dwarfHero_taunt_confirm_3.ogg", "dwarfHero_taunt_death.ogg"}
	},
	DwarfSounds = {
		files = {"dwarfArcher_taunt_1.ogg", "dwarfArcher_taunt_2.ogg", "dwarfBarracks_taunt_1.ogg", "dwarf_taunt_1.ogg", "dwarf_taunt_2.ogg"}
	},
	ElvenWoodsAmbienceSounds = {
		files = {"kre_sfx_ambience_singlebirdandstream.ogg"}
	},
	ElvesBajNimenBossSounds = {
		files = {"kro_sfx_bitteringrancor_boss-death[conriser].ogg", "kro_sfx_bitteringrancor_boss-heal.ogg", "kro_sfx_bitteringrancor_boss-rangedattack[op2].ogg", "kro_sfx_bitteringrancor_boss-shadowstorm[cast].ogg", "kro_sfx_bitteringrancor_boss-shadowstorm[impact].ogg", "kro_sfx_bitteringrancor_boss-shadowstorm[travel].ogg", "kro_sfx_bitteringrancor_boss-tailwhip.ogg"}
	},
	ElvesBossBramSounds = {
		files = {"kro_sfx_bram_death[conexplo].ogg", "kro_sfx_bram_fistcharge.ogg", "kro_sfx_bram_groundstomp.ogg", "kro_sfx_bram_sopapo[conwhoosh].ogg"}
	},
	ElvesCommonSounds = {
		files = {
	...
	ElvesForgottenTreasureBalrogSounds = {
		files = {"kro_sfx_godieth_attack.ogg", "kro_sfx_godieth_bloodpool.ogg", "kro_sfx_godieth_death[op2].ogg", "kro_sfx_godieth_spit.ogg"}
	},
	...
	ElvesGnome = {
		files = {"kro_sfx_gnome_desintegrate_v2[comic].ogg", "kro_sfx_gnome_poison_v2[confrasco].ogg", "kro_sfx_gnome_polymorf[conchimes].ogg", "kro_sfx_gnome_polymorf[conchimes].ogg", "kro_sfx_veznan_teleport_v1.ogg"}
	},
	ElvesGryphon = {
		files = {"kre_sfx_gryphon_land_v3[op1].ogg", "kre_sfx_gryphon_shot_v2[end].ogg", "kre_sfx_gryphon_shot_v2[end].ogg", "kre_sfx_gryphon_shot_v2[op3].ogg", "kre_sfx_gryphon_takeoff_v2.ogg"}
	},
	ElvesHeroAlleria = {
		files = {"Female-Elven-Archer-01c.ogg", "Female-Elven-Archer-02c.ogg", "Female-Elven-Archer-03a.ogg", "Female-Elven-Archer-04b.ogg", "Female-Elven-Archer-Death_a.ogg", "Level_up.ogg"}
	},
	ElvesHeroArivan = {
		files = {
	...
	ElvesHeroBabyMalik = {
		files = {"Motumbo_charge_special.ogg", "Motumbo_hit.ogg", "Motumbo_jump_special.ogg", "Reinforcement-01a.ogg", "Reinforcement-02c.ogg", "Reinforcement-03c.ogg", "Reinforcement-04b.ogg", "Reinforcement-Death_c.ogg"}
	},
	ElvesHeroBolverk = {
		files = {"VarlBerserker_confirm-01a.ogg", "VarlBerserker_confirm-02a.ogg", "VarlBerserker_confirm-03c.ogg", "VarlBerserker_confirm-04a.ogg", "VarlBerserker_death-01c.ogg", "kro_sfx_bolverk_bearcry[op1].ogg", "kro_sfx_bolverk_doubleslash[gore].ogg"}
	},
	ElvesHeroBruce = {
		files = {
	...
	ElvesHeroEldritch = {
		files = {"Eridan_Death-01a.ogg", "Level_up.ogg", "Reg'son-confirm_01a.ogg", "Reg'son-confirm_02c.ogg", "Reg'son-confirm_03d.ogg", "Reg'son-death_01c.ogg", "kro_sfx_regson_bladescast_v3[conenergia].ogg", "kro_sfx_regson_bladescast_v3[sinenergia].ogg", "kro_sfx_regson_slash_v1.ogg", "kro_sfx_regson_vindicator_v3.ogg"}
	},
	ElvesHeroEridan = {
		files = {"Eridan_Confirm-01d.ogg", "Eridan_Confirm03-01a.ogg", "Eridan_Death-01a.ogg", "Eridan_confirmextra-01a.ogg", "Level_up.ogg", "kre_sfx_eridan_doublestrike_v2[mid].ogg", "kre_sfx_eridan_nimblefencing.ogg"}
	},
	ElvesHeroFaustus = {
		files = {
	...
	ElvesHeroLynn = {
		files = {"Level_up.ogg", "Lynn_confirm_02c.ogg", "Lynn_confirm_03a.ogg", "Lynn_confirm_04d.ogg", "Lynn_death_01b.ogg", "kro_sfx_bitteringrancor_lynn-curseofdispair[conprecarga].ogg", "kro_sfx_bitteringrancor_lynn-fatesealed.ogg", "kro_sfx_bitteringrancor_lynn-hexfury[op3].ogg", "kro_sfx_bitteringrancor_lynn-weakeningcurse[sincrackle].ogg"}
	},
	ElvesHeroPhoenix = {
		files = {
			"Level_up.ogg",
	...
	ElvesHyena = {
		files = {"kre_sfx_hyena_death.ogg", "kre_sfx_hyena_howl[op1_singrowl].ogg", "kre_sfx_hyena_specialstomp.ogg", "kre_sfx_hyena_wagonexplosion.ogg", "kre_sfx_hyena_wagonloop[concadenas].ogg", "kre_sfx_hyena_wagonloop[ending].ogg"}
	},
	ElvesLevelEightSounds = {
		files = {"kro_sfx_bean.ogg", "kro_sfx_bean_loop.ogg", "kro_sfx_hanselandgretel_escape[arpayrisas].ogg", "kro_sfx_peekaboo_v2[op2].ogg", "kro_sfx_witch_outsidecurse[op2].ogg", "kro_sfx_witch_touch[op1].ogg", "kro_sfx_witchdeath_v1[op2].ogg"}
	},
	...
	ElvesLevelFourteen = {
		files = {"kr3_sfx_mactans_touch.ogg", "kro_sfx_ambience_spiders_v2[op1].ogg", "kro_sfx_spidereggs[huevo+aranias].ogg"}
	},
	ElvesLevelHRSounds = {
		files = {"kr3_sfx_tree_path_explosion.ogg", "kro_sfx_crystallizedgnoll_v2.ogg", "kro_sfx_crystalskull_touch[conrisa].ogg", "kro_sfx_gnoll_outofbush_modif.ogg", "kro_sfx_hulkingrage_mining_v2[op1].ogg", "kro_sfx_hulkingrage_mining_v2[op2].ogg", "kro_sfx_unstablecrystal_crystallize[op1].ogg"}
	},
	ElvesLevelNineSounds = {
		files = {"kro_sfx_crystalserpent_crystalshatter.ogg", "kro_sfx_crystalserpent_emerge.ogg", "kro_sfx_crystalserpent_passby[sinsublows]_B.ogg", "kro_sfx_crystalserpent_scream[op4_pocodelay].ogg", "kro_sfx_crystalserpent_serpentsattack.ogg", "kro_sfx_crystalserpent_submerge_B.ogg", "kro_sfx_faerydragon_attack[solocristalizacion].ogg", "kro_sfx_faerydragon_buydragon[op1].ogg", "kro_sfx_faerydragon_extraability[solochimes].ogg", "kro_sfx_faerydragon_sfx_attack[op2][soloattack]_B.ogg"}
	},
	...
	ElvesLevelTenSounds = {
		files = {"kro_sfx_gnome_death[op1].ogg", "kro_sfx_gnome_death[op4].ogg", "kro_sfx_gnome_death[op7].ogg", "kro_sfx_simon_activate_v2.ogg", "kro_sfx_simon_blue_v2.ogg", "kro_sfx_simon_green_v2.ogg", "kro_sfx_simon_red_v2.ogg", "kro_sfx_simon_wrong_v2.ogg", "kro_sfx_simon_yellow_v2.ogg"}
	},
	ElvesLevelThirteen = {
		files = {
	...
	ElvesLevelThreeSounds = {
		files = {"kr_yellow_submarine_custom.ogg", "kre_sfx_achievement_mario.ogg", "kre_sfx_waterfall_strong.ogg", "kro_sfx_dwarfdeath[barrel].ogg", "kro_sfx_wilson[op1].ogg"}
	},
	ElvesMalicia = {
		files = {"kro_sfx_mactans_webspin[towers].ogg", "kro_sfx_malicia_comet-end_v3.ogg", "kro_sfx_malicia_comet-start_v3[sinfuego].ogg", "kro_sfx_malicia_death.ogg", "kro_sfx_malicia_shieldbreak[op1].ogg", "kro_sfx_malicia_spellcast_[op2].ogg", "kro_sfx_malicia_spellcast_[op2]_nolaugh.ogg", "kro_sfx_malicia_spiderin.ogg", "kro_sfx_malicia_spiderout.ogg", "kro_sfx_maliciazealot_summon[wololo_op1].ogg"}
	},
	...
	EndlessGnollSounds = {
		files = {"kro_sfx_ambience_wardrums[op1].ogg", "kro_sfx_ambience_wardrums[op2].ogg", "kro_sfx_ambience_wardrums[op3].ogg", "kro_sfx_creep_death[op1].ogg", "kro_sfx_creep_doublesword[op1].ogg", "kro_sfx_heehaw_call[op2].ogg", "kro_sfx_heehaw_netfalling_v2[op3].ogg", "kro_sfx_heehaw_nethitsfloor.ogg"}
	},
	EndlessTwilightSounds = {
		files = {"kro_sfx_ainyl_disable.ogg", "kro_sfx_ainyl_shield.ogg", "kro_sfx_ainyl_teleport[op2].ogg", "kro_sfx_bannerbearer_death[op1-SD].ogg", "kro_sfx_twlightinvasionambience-2.ogg", "kro_sfx_twlightinvasionambience-3.ogg"}
	},
	...
	FrontiersEndlessToeeBossSounds = {
		files = {"krf_toee_aliengoddess_screech[op3].ogg", "krf_toee_aliengoddess_spit.ogg", "krf_toee_alienqueen_acid[impact].ogg", "krf_toee_alienqueen_spawn.ogg"}
	},
	...
	HWFrankensteinTower = {
		files = {"FrankyTower-01d.ogg", "FrankyTower-02f.ogg", "FrankyTower-03c.ogg", "FrankyTower-04a.ogg", "Sound_Tesla_attack_1.ogg", "Sound_Tesla_attack_2.ogg", "halloween_tesla_charge.ogg"}
	},
	HWHeadlessHorseman = {
		files = {"HeadlessHorseman-03a_WET.ogg", "halloween_headless_sinrisa_conacorde.ogg"}
	},
	HWVampireBoss = {
		files = {"halloween_vampireboss_death.ogg", "halloween_vampireboss_drainlife.ogg", "halloween_vampireboss_gates.ogg"}
	},
	HWVampiress = {
		files = {"Vampiress-01c.ogg", "Vampiress-02c.ogg", "Vampiress-03c.ogg", "Vampiress-Death02c.ogg", "halloween_vampiress_areaattack_confilo.ogg", "halloween_vampiress_drainlifeOP2.ogg"}
	},
	HalloweenSounds = {
		files = {"halloween_werewolf_alfawolf.ogg", "halloween_werewolf_minormoans.ogg", "halloween_werewolf_transformation.ogg", "halloween_abominationexplosion.ogg"}
	},
	HeroAlien = {
		files = {
	...
	HeroAlric = {
		files = {"alric_taunt_confirm_1.ogg", "alric_taunt_confirm_3.ogg", "alric_taunt_confirm_4.ogg", "alric_taunt_death.ogg", "hero_alric_flurry.ogg", "hero_alric_sandwarrior.ogg"}
	},
	HeroArcher = {
		files = {"Aleria_special_arrow.ogg", "Aleria_sumon.ogg", "Aleria_wildcat_hit.ogg", "Female-Elven-Archer-01c.ogg", "Female-Elven-Archer-03a.ogg", "Female-Elven-Archer-04b.ogg", "Female-Elven-Archer-Death_a.ogg", "Level_up.ogg"}
	},
	HeroBeastMaster = {
		files = {"beastmaster_taunt_confirm_1.ogg", "beastmaster_taunt_confirm_2.ogg", "beastmaster_taunt_confirm_4.ogg", "beastmaster_taunt_death.ogg", "hero_beastmaster_bird_attack.ogg", "hero_beastmaster_jabali_attack2.ogg", "hero_beastmaster_rhino_stampede.ogg", "hero_beastmaster_summon_boar.ogg", "hero_beastmaster_summon_rhino.ogg", "hero_cronan_whiplash.ogg"}
	},
	HeroCrab = {
		files = {"Hero_Karkinos_Burrow_in.ogg", "Hero_Karkinos_Burrow_out.ogg", "Hero_Karkinos_Cannon.ogg", "Hero_Karkinos_Cannon_explosion.ogg", "Hero_Karkinos_Pincer.ogg", "Hero_Karkinos_Shield.ogg", "Karkinos_01b.ogg", "Karkinos_02b.ogg", "Karkinos_04b.ogg", "Karkinos_Death.ogg"}
	},
	HeroDenas = {
		files = {"KingDenas-01d.ogg", "KingDenas-02d.ogg", "KingDenas-03g.ogg", "KingDenas-05c.ogg", "KingDenas_sfx_attack.ogg", "KingDenas_sfx_order1.ogg", "KingDenas_sfx_order3.ogg", "Level_up.ogg"}
	},
	HeroDracolich = {
		files = {"Bonehart-01a_WET.ogg", "Bonehart-03b_WET.ogg", "Bonehart-04c_WET.ogg", "Bonehart-Death01c_WET.ogg", "halloween_bonedragon_attack.ogg", "halloween_bonedragon_bonerain.ogg", "halloween_bonedragon_kamikaze2.ogg", "halloween_bonedragon_respawn_simple.ogg", "halloween_bonedragon_soulsplague.ogg", "halloween_bonedragon_spawn_congrowl.ogg"}
	},
	HeroDragon = {
		files = {"dragonHero_confirm1.ogg", "dragonHero_confirm2.ogg", "dragonHero_confirm3.ogg", "hero_dragon_birth.ogg", "hero_dragon_death.ogg", "hero_dragon_fireball_explode.ogg", "hero_dragon_flamethrower.ogg", "hero_dragon_napalm.ogg", "hero_dragon_smoke.ogg", "hero_dragon_spit.ogg"}
	},
	HeroDwarf = {
	...
	HeroFrost = {
		files = {"Elora_GroundFreeze.ogg", "Elora_IceShard.ogg", "Elora_IceShardBreak.ogg", "Elora_IceShardSummon.ogg", "Frost-Mage-02c.ogg", "Frost-Mage-03d.ogg", "Frost-Mage-04a.ogg", "Frost-Mage-Death_01c.ogg", "Level_up.ogg"}
	},
	HeroGiant = {
		files = {"giant_taunt_confirm_1.ogg", "giant_taunt_confirm_2.ogg", "giant_taunt_confirm_3.ogg", "giant_taunt_death.ogg", "hero_grawl_bigpunch.ogg", "hero_grawl_boulder_hit.ogg", "hero_grawl_boulder_throw.ogg", "hero_grawl_stomp.ogg"}
	},
	HeroMage = {
		files = {"Level_up.ogg", "Mage_blue_rain_charge.ogg", "Mage_blue_rain_drop.ogg", "Mage_shadows.ogg", "Young-Mage-01d.ogg", "Young-Mage-03c.ogg", "Young-Mage-04c.ogg", "Young-Mage-Death_c.ogg"}
	},
	HeroMinotaur = {
	...
	HeroPaladin = {
		files = {"Holy-Paladin-02c.ogg", "Holy-Paladin-03b.ogg", "Holy-Paladin-04a.ogg", "Holy-Paladin-Death_b.ogg", "Level_up.ogg", "Paladin_deflect.ogg", "Paladin_shield_buff.ogg"}
	},
	HeroPirate = {
		files = {"blackthorne_taunt_confirm_1.ogg", "blackthorne_taunt_confirm_2.ogg", "blackthorne_taunt_confirm_4.ogg", "blackthorne_taunt_death.ogg", "hero_blackthorne_barrel.ogg", "hero_blackthorne_kraken.ogg"}
	},
	HeroPriest = {
		files = {"hero_priest_consecrate.ogg", "hero_priest_healing.ogg", "hero_priest_teleport.ogg", "priest_taunt_confirm_1.ogg", "priest_taunt_confirm_2.ogg", "priest_taunt_confirm_3.ogg", "priest_taunt_confirm_4.ogg", "priest_taunt_death.ogg"}
	},
	HeroRainOfFire = {
		files = {"Cinder_special_area.ogg", "Cinder_special_fireball_1_start.ogg", "Cinder_special_fireball_2_end.ogg", "Elemental-02c.ogg", "Elemental-03b.ogg", "Elemental-04c.ogg", "Elemental-Death_c.ogg", "Level_up.ogg", "Motumbo_hit.ogg"}
	},
	HeroReinforcement = {
		files = {"Motumbo_jump_special.ogg", "Reinforcement-Death_c.ogg", "Motumbo_charge_special.ogg", "Level_up.ogg", "Reinforcement-04b.ogg", "Motumbo_hit.ogg", "Reinforcement-03c.ogg", "Reinforcement-02c.ogg"}
	},
	HeroRifleman = {
	...
	HeroSamurai = {
		files = {"Level_up.ogg", "Oni-01c.ogg", "Oni-02c.ogg", "Oni-04a.ogg", "Oni-Death01a.ogg", "inferno_oni_groundSwords.ogg", "inferno_oni_instakill.ogg"}
	},
	HeroThor = {
		files = {"KR_sfx_thor_ataqueelectrico.ogg", "KR_sfx_thor_lanzamartillo_op2.ogg", "KR_sfx_thor_muerte.ogg", "KR_sfx_thor_thunder.ogg", "Level_up.ogg", "Thor_02a.ogg", "Thor_03c.ogg", "Thor_04c.ogg", "Thor_05c.ogg"}
	},
	HeroVanHelsing = {
		files = {"Dante-02a.ogg", "Dante-03a.ogg", "Dante-04d.ogg", "Dante-Death01c.ogg", "halloween_helsing_holywater_conquemadura.ogg", "halloween_helsing_relic.ogg"}
	},
	HeroViking = {
		files = {"Level_up.ogg", "Viking-01b.ogg", "Viking-02c.ogg", "Viking-03b.ogg", "Viking-Death_01d.ogg", "Viking_Call.ogg", "Viking_Hit.ogg", "Viking_StartAttack.ogg", "Viking_Transform.ogg"}
	},
	HeroVoodooWitch = {
		files = {"KRF_sfx_vodoo_ataqueV3.ogg", "KRF_sfx_vodoo_calaveraV3_op2.ogg", "KRF_sfx_vodoo_kamikazegolpev3.ogg", "KRF_sfx_vodoo_kamikazelanza.ogg", "KRF_sfx_vodoo_munieco.ogg", "Vodoo_02b.ogg", "Vodoo_03b.ogg", "Vodoo_04b.ogg", "Vodoo_05d.ogg"}
	},
	HeroWizard = {
		files = {"hero_nivus_attack.ogg", "hero_nivus_desintegrate.ogg", "hero_nivus_magicmissile_hit.ogg", "hero_nivus_magicmissile_summon.ogg", "hero_nivus_teleport.ogg", "wizzard_taunt_confirm_2.ogg", "wizzard_taunt_confirm_3.ogg", "wizzard_taunt_confirm_4.ogg", "wizzard_taunt_death.ogg"}
	},
	InfernoSounds = {
		files = {"inferno_boss_death.ogg", "inferno_boss_horns.ogg", "inferno_boss_stomp.ogg"}
	},
	JtEffects = {
		files = {"Sound_EnemyJtAttack.ogg", "Sound_EnemyJtDeath.ogg", "Sound_EnemyJtEat.ogg", "Sound_EnemyJtExplode.ogg", "Sound_EnemyJtRest.ogg", "Sound_HitIce1.ogg", "Sound_HitIce2.ogg", "Sound_HitIce3.ogg"}
	},
	LegionnaireSounds = {
	...
	MushroomSounds = {
		files = {"KR_sfx_mushroomboss_gas_op1.ogg", "KR_sfx_mushroomboss_muerte.ogg", "KR_sfx_mushroomcreep_muerte_edit_vanzen.ogg", "KR_sfx_mushroomcreep_nacimiento.ogg"}
	},
	PirateBigSounds = {
	...
	SaurianKingBoss = {
		files = {"KRF_sfx_saurianboss_martillo_1t.ogg", "KRF_sfx_saurianboss_muerte.ogg", "KRF_sfx_saurianboss_op1.ogg", "KRF_sfx_saurianboss_temblor.ogg"}
	},
	SaurianSniperSounds = {
	...
	SpecialBlackDragon = {
		files = {"dragonHero_confirm1.ogg", "dragonHero_confirm2.ogg", "dragonHero_confirm3.ogg", "dragonHero_confirm4.ogg", "hero_dragon_flamethrower.ogg"}
	},
	...
	stage_02 = {
		files = {"kra_sfx_stageMechanic_guardianTree_roots_v1.ogg", "kra_sfx_stageMechanic_guardianTree_cast_v1.ogg", "kra_sfx_stageMechanic_guardianTree_pre-cast_v1.ogg", "kra_sfx_easterEgg_runeStage2-3_v1.ogg", "kra_sfx_easterEgg_linkFishing_var3_v1.ogg", "kra_sfx_easterEgg_linkFishing_var2_v1.ogg", "kra_sfx_easterEgg_linkFishing_var1_v1.ogg", "kra_sfx_easterEgg_lionKing_op1_v1.ogg", "kra_sfx_stage02_cinematic_raelyn_teleport_v1.ogg", "kra_sfx_stage02_cinematic_veznan_teleport_v1.ogg"}
	},
	stage_03 = {
		files = {"kra_sfx_stageMechanic_heartOfTheForest_ready_v1.ogg", "kra_sfx_stageMechanic_heartOfTheForest_cast_v1.ogg", "kra_sfx_stageMechanic_heartOfTheForest_energyBlasts_var1_v1.ogg", "kra_sfx_stageMechanic_heartOfTheForest_energyBlasts_var2_v1.ogg", "kra_sfx_stageMechanic_heartOfTheForest_energyBlasts_var3_v1.ogg", "kra_sfx_stageMechanic_heartOfTheForest_energyBlasts_var4_v1.ogg", "kra_sfx_easterEgg_runeStage2-3_v1.ogg"}
	},
	stage_04 = {
		files = {"kra_sfx_stageMechanic_wildbeastElevator_break_v1.ogg", "kra_sfx_stage04_wildbeastElevator_in_op1_v3.ogg", "kra_sfx_stage04_wildbeastElevator_out_v3.ogg", "kra_sfx_stage04_wildbeastElevator_inFull_op1.ogg", "kra_sfx_easterEgg_runeStage4_v1.ogg", "kr_voice_arboreanthornspears_taunt01_a.ogg", "kr_voice_arboreanthornspears_taunt02_b.ogg", "kra_sfx_easterEgg_arboreanFall_op2_v1.ogg", "kra_sfx_easterEgg_sheepyTerrain1_fall_v1.ogg", "kra_sfx_easterEgg_sheepyTerrain1_impact_v1.ogg"}
	},
	stage_05 = {
		files = {"kra_sfx_stageMechanic_woodcutterBear_chop_2_v1.ogg", "kra_sfx_stageMechanic_woodcutterBear_chop_1_v1.ogg", "kra_sfx_stageMechanic_woodcutterBear_roar_v1.ogg", "kra_sfx_easterEgg_runeStage5-6_v1.ogg"}
	},
	stage_06 = {
		files = {
	...
	stage_07 = {
		files = {"kra_sfx_stage07_cultTempleBridge_v1.ogg", "kra_sfx_easterEgg_witcher_v1.ogg", "kra_sfx_easterEgg_crow_fly_v1.ogg", "kra_sfx_easterEgg_crow_caw_v1.ogg"}
	},
	stage_08 = {
		files = {"kr_voice_rescuedelves_taunt01_b.ogg", "kr_voice_rescuedelves_taunt02_c.ogg", "kra_sfx_easterEgg_basket_tap_v1.ogg", "kra_sfx_easterEgg_basket_break_v1.ogg"}
	},
	stage_09 = {
		files = {"kra_sfx_stage09_cultBridge_v1.ogg", "kra_sfx_stage09_nightmarePortalOn-candles_v1.ogg", "kra_sfx_stage09_nightmarePortalOn-eye_v1.ogg", "kra_stage09_cultBridge_rumble_v1.ogg", "kra_sfx_easterEgg_dryBones_break_v1.ogg", "kra_sfx_easterEgg_dryBones_reform_v1.ogg", "kra_sfx_easterEgg_sheepyTerrain2_camera_v1.ogg", "kra_sfx_easterEgg_sheepyTerrain2_bridgeBaa_v1.ogg"}
	},
	stage_10 = {
		files = {"kra_sfx_stage10_obelisk_activation_op1_v3.ogg", "kra_sfx_stage10_obelisk_effectStun_cast_v1.ogg", "kra_sfx_stage10_obelisk_effectHeal_cast_loopStart.ogg", "kra_sfx_stage10_obelisk_effectHeal_cast_LOOP_v1.ogg", "kra_sfx_stage10_obelisk_effectChange_v2.ogg", "kra_sfx_stage10_obelisk_golemSpawn_cast.ogg", "kra_sfx_stage10_obelisk_golemSpawn_golem.ogg", "kra_sfx_easterEgg_villagePeople_statuePuff_op1_v1.ogg", "kra_sfx_easterEgg_villagePeople_fireworks_v1.ogg", "kra_sfx_easterEgg_villagePeople_hits_op2_v2.ogg"}
	},
	stage_11 = {
		files = {
	...
	stage_13 = {
		files = {"kra_sfx_stage13_darkRayTower_repair_v1.ogg", "kra_sfx_stage13_darkRayTower_attack_op2_v1.ogg", "kra_sfx_stage13_darkRayTower_specialAttack_v1.ogg", "kra_sfx_stage13_darkRayTower_destroy_v1.ogg"}
	},
	stage_14 = {
		files = {
	...
	stage_17 = {
		files = {"kra_sfx_stage17_weirdwood_basicAttack_throw_var1_v1.ogg", "kra_sfx_stage17_weirdwood_basicAttack_throw_var2_v1.ogg", "kra_sfx_stage17_weirdwood_basicAttack_throw_var3_v1.ogg", "kra_sfx_stage17_weirdwood_basicAttack_explosion_v1.ogg", "kra_sfx_stage17_weirdwood_deathwoodTransform_v1.ogg", "kra_sfx_stage17_weirdwood_leavesFall_v1.ogg", "kra_sfx_stage17_rootSoulcaller_in.ogg", "kra_sfx_stage17_rootSoulcaller_out.ogg", "kra_sfx_stage17_rootSoulcaller_cast.ogg"}
	},
	stage_18 = {
		files = {"kr_voice_elvenmercenaries_taunt-01_c.ogg", "kr_voice_elvenmercenaries_taunt-02_b.ogg", "kra_sfx_stage18_eridan_in-out_v2.ogg", "kra_sfx_stage18_eridan_instakill_v2.ogg", "kra_sfx_tower_paladinCovenant_unitDeath_var1_v1.ogg", "kra_sfx_tower_paladinCovenant_unitDeath_var2_v1.ogg", "kra_sfx_tower_paladinCovenant_unitDeath_var3_v1.ogg", "kra_sfx_stage18_lamp_break_op1_v1.ogg", "kra_sfx_easterEgg_stage18Sheepy_tap-OPEN_v1.ogg", "kra_sfx_easterEgg_stage18Sheepy_tap-CLOSE_v1.ogg"}
	},
	stage_19 = {
		files = {
	...
	stage_23 = {
		files = {"kra_sfx_stage23_automatonFoot_open_v1.ogg", "kra_sfx_stage23_automatonFoot_close_v1.ogg", "kra_sfx_stage23_darksteelGuardian_activation_v1.ogg", "kra_sfx_stage23_darksteelGuardian_rockBreak_v1.ogg", "kra_sfx_easterEgg_truck_oneShot_v1.ogg", "kra_sfx_easterEgg_truck_tap3_full_v1.ogg"}
	},
	stage_24 = {
		files = {
	...
	stage_29 = {
		files = {"kra_sfx_spiders_mechanic_spawner_prev_v1.ogg", "kra_sfx_spiders_mechanic_spawner_explode_v1.ogg", "kra_sfx_spiders_mechanic_spawner_regenerate_v1.ogg"}
	},
	stage_30 = {
		files = {
	...
	stage_31 = {
		files = {"kra_sfx_wukong_mechanic_stage1_fountain_refill_v1.ogg", "kra_sfx_wukong_mechanic_stage1_fountain_splash_v1.ogg", "kra_sfx_wukong_mechanic_stage1_fountain_tapon_var1_v1.ogg", "kra_sfx_wukong_mechanic_stage1_fountain_tapon_var2_v1.ogg", "kra_sfx_wukong_mechanic_stage1_fountain_tapon_var3_v1.ogg", "kra_sfx_wukong_mechanic_stage1_meteorites_LOOP_in_faded_martin.ogg", "kra_sfx_wukong_mechanic_stage1_meteorites_impact_v2.ogg", "kra_sfx_wukong_mechanic_stage1_meteorites_travel-LOOP_v1.ogg"}
	},
	stage_32 = {
		files = {
	...
	stage_33 = {
		files = {"kra_sfx_wukong_mechanic_stage3_storm_ambience_LOOPStart_v1.ogg", "kra_sfx_wukong_mechanic_stage3_storm_ambience_LOOP_v1.ogg", "kra_sfx_wukong_mechanic_stage3_storm_ambience_distantThunder_var1_v1.ogg", "kra_sfx_wukong_mechanic_stage3_storm_ambience_distantThunder_var2_v1.ogg", "kra_sfx_wukong_mechanic_stage3_storm_ambience_distantThunder_var3_v1.ogg", "kra_sfx_wukong_mechanic_stage3_storm_lightning_strike_var1_v1.ogg", "kra_sfx_wukong_mechanic_stage3_storm_lightning_strike_var2_v1.ogg", "kra_sfx_wukong_mechanic_stage3_storm_lightning_strike_var3_v1.ogg", "kra_sfx_wukong_mechanic_stage3_storm_lightning_mark_v1.ogg", "kra_sfx_wukong_mechanic_stage3_boat_drum_op2_v1.ogg"}
	},
	stage_34 = {
		files = {
	...
	stage_136 = {
		files = {"kra_sfx_dragons_mechanic_stage1_path_open_1_v1.ogg", "kra_sfx_dragons_mechanic_stage1_path_open_2_v1.ogg", "kra_sfx_dragons_ee_s1_spyro_1_v1.ogg", "kra_sfx_dragons_ee_s1_spyro_2_fallOnly_v1.ogg", "kra_sfx_dragons_ee_s1_granger_1_v1.ogg", "kra_sfx_dragons_ee_s1_granger_2_fullSeq_v1.ogg", "kra_sfx_enemy_noxiousHorror_death_op1_v1.ogg"}
	},
	stage_137 = {
		files = {
	...
	terrain_2_common = {
		files = {"kra_sfx_terrain2Ambient_wind_var1_v1.ogg", "kra_sfx_terrain2Ambient_wind_var2_v1.ogg", "kra_sfx_terrain2Ambient_wind_var3_v1.ogg", "kra_sfx_terrain2Ambient_bats_var1_v1.ogg", "kra_sfx_terrain2Ambient_bats_var2_v1.ogg", "kra_sfx_terrain2Ambient_bats_var3_v1.ogg", "kra_sfx_terrain2Ambient_waterDrops_var1_v1.ogg", "kra_sfx_terrain2Ambient_waterDrops_var2_v1.ogg", "kra_sfx_terrain2Ambient_waterDrops_var3_v1.ogg"}
	},
	terrain_3_common = {
		files = {"kra_sfx_terrain3_glareOn_littleEye_op1_v1.ogg", "kra_sfx_terrain3_glareOn_littleEye_op2_v1.ogg", "kra_sfx_terrain3_glareOn_bigEye_v1.ogg", "kra_sfx_terrain3_glare_off_v1.ogg", "kra_sfx_terrain3Ambient_gutural_var2_v1.ogg", "kra_sfx_terrain3Ambient_gutural_var3_v1.ogg", "kra_sfx_terrain3Ambient_gutural_var5_v1.ogg"}
	},
	terrain_4_common = {
		files = {"kra_sfx_easterEgg_cheshireCat_appear_v1.ogg", "kra_sfx_easterEgg_cheshireCat_disappear_v1.ogg", "kra_sfx_easterEgg_howlingTree_var1_v1.ogg", "kra_sfx_easterEgg_howlingTree_var2_v1.ogg", "kra_sfx_easterEgg_howlingTree_var3_v1.ogg", "kra_sfx_update1Ambient_wind_var1.ogg", "kra_sfx_update1Ambient_wind_var2.ogg", "kra_sfx_update1Ambient_wind_var3.ogg", "kra_sfx_update1Ambient_wind_var4.ogg"}
	},
	terrain_6_common = {
		files = {"kra_sfx_dlc1Ambient_windRocks_var1_v1.ogg", "kra_sfx_dlc1Ambient_windRocks_var2_v1.ogg", "kra_sfx_dlc1Ambient_windRocks_var3_v1.ogg", "kra_sfx_dlc1Ambient_forge_var1_v1.ogg", "kra_sfx_dlc1Ambient_forge_var2_v1.ogg", "kra_sfx_dlc1Ambient_forge_var3_v1.ogg", "kra_sfx_easterEgg_exodiaPart_v1.ogg"}
	},
	terrain_wukong_common = {
		files = {"kra_sfx_wukong_mechanic_stage1_holder_active_vines_v1.ogg", "kra_sfx_wukong_mechanic_stage1_holder_evolve_v1.ogg", "kra_sfx_wukong_mechanic_stage1_holder_unlock.ogg", "kra_sfx_wukong_mechanic_stage2_holder_active_instakill_v1_in.ogg", "kra_sfx_wukong_mechanic_stage2_holder_active_instakill_v1_kill.ogg", "kra_sfx_wukong_mechanic_stage34_holder_active_summon_v1.ogg", "kra_sfx_wukong_mechanic_stage35_holder_active_steal_op2_v1.ogg"}
	},
	...
	tower_arcane_wizard = {
		files = {"kr_voice_arcanewizard_skill_a_var1a.ogg", "kr_voice_arcanewizard_skill_b_var1a.ogg", "kr_voice_arcanewizard_taunt_var1c.ogg", "kr_voice_arcanewizard_taunt2_var1a.ogg", "kr_voice_arcanewizard_taunt3_var1b.ogg", "kra_sfx_tower_arcaneWizard_basicAttack_var1_v1.ogg", "kra_sfx_tower_arcaneWizard_basicAttack_var2_v1.ogg", "kra_sfx_tower_arcaneWizard_basicAttack_var3_v1.ogg", "kra_sfx_tower_arcaneWizard_skill_disintegration_v1.ogg", "kra_sfx_tower_arcaneWizard_skill_empowerment_v1.ogg"}
	},
	tower_ballista = {
		files = {
			"kr_voice_ballistaoutpost_taunt01_d.ogg",
	...
	tower_dark_elf = {
		files = {"kr_voice_twilightlongbows_select_b.ogg", "kr_voice_twilightlongbows_skill-a_g.ogg", "kr_voice_twilightlongbows_skill-b_d.ogg", "kr_voice_twilightlongbows_taunt-01_a.ogg", "kr_voice_twilightlongbows_taunt-02_b.ogg", "kra_sfx_tower_twlightLongbows_basicAttack_cast-noCharge_var1_v1.ogg", "kra_sfx_tower_twlightLongbows_basicAttack_cast-noCharge_var2_v1.ogg", "kra_sfx_tower_twlightLongbows_basicAttack_cast-noCharge_var3_v1.ogg", "kra_sfx_tower_twlightLongbows_supportBlades_spawn_v1.ogg", "kra_sfx_tower_twlightLongbows_thrillOfTheHunt_cast-travelOnly_v1.ogg"}
	},
	tower_demon_pit = {
		files = {
			"kr_voice_demonpit_taunt3_var1a.ogg",
	...
	tower_rotten_forest = {
		files = {"kr4_rotten_forest_build_taunt_1.ogg", "kr4_rotten_forest_build_taunt_2.ogg", "kr4_rotten_forest_build_taunt_3.ogg", "kr4_rotten_forest_build_taunt_4.ogg", "kr4_rotten_forest_ents_upg.ogg", "kr4_rotten_forest_mist_upg.ogg", "kr4_rotten_forest_branches_upg.ogg", "kr4_rotten_forest_attack.ogg", "kr4_rotten_forest_rootsevil.ogg"}
	},
	tower_infernal_mage = {
		files = {"kr4_ember_lords_mage_taunt_4.ogg", "kr4_ember_lords_mage_taunt_1.ogg", "kr4_ember_lords_mage_taunt_2.ogg", "kr4_ember_lords_mage_taunt_3.ogg", "kr4_ember_lords_mage_affliction_upg.ogg", "kr4_ember_lords_mage_infernal_teleport_upg.ogg", "kr4_ember_lords_mage_overcharge_upg.ogg", "kr4_ember_lords_mage_attack.ogg", "kr4_ember_lords_mage_overcharge.ogg", "kr4_ember_lords_mage_affliction.ogg"}
	},
	tower_bone_flingers = {
		files = {"kr4_fallen_ones_bone_flingers_taunt_1.ogg", "kr4_fallen_ones_bone_flingers_taunt_2.ogg", "kr4_fallen_ones_bone_flingers_taunt_3.ogg", "kr4_fallen_ones_bone_flingers_taunt_4.ogg", "kr4_fallen_ones_bone_flingers_bone_golem_upg.ogg", "kr4_fallen_ones_bone_flingers_calcified_bones_upg.ogg", "kr4_fallen_ones_bone_flingers_walking_army_upg.ogg", "kr4_fallen_ones_bone_flingers_summon.ogg"}
	}
}
