...
tt.particle_offsets = {vec_2(-25.714285714285715, 25.714285714285715), vec_2(-15.714285714285715, 37.142857142857146), vec_2(0, 45.714285714285715), vec_2(8.571428571428571, 42.85714285714286), vec_2(14.285714285714286, 32.85714285714286), vec_2(21.42857142857143, 21.42857142857143)}
tt.flip_offset = vec_2(3, 0)
...
tt.info.portrait = "kr2_info_portraits_towers_0019"
tt.render.sprites[1].animated = false
...
tt.tween.props[2].keys = {{fts(0), vec_2(1, 1)}, {fts(9), vec_2(1, 1)}, {fts(11), vec_2(0.77, 0.77)}, {fts(13), vec_2(0.85, 0.85)}, {fts(19), vec_2(0.65, 0.45)}}
tt.tween.props[3] = CC("tween_prop")
...
for i, pos in ipairs({vec_2(-22, 8), vec_2(7, 0), vec_2(-2, 2), vec_2(23, 15), vec_2(-29, 5), vec_2(11, -4), vec_2(-4, 21)}) do
	local s = CC("sprite")
...
tt.editor.props = {{"tower.default_rally_pos", PT_COORDS}, {"tower.holder_id", PT_STRING}, {"editor.game_mode", PT_NUMBER}}
...
tt.info.portrait = "kr3_info_portraits_towers_0020"
...
tt.aura.allowed_templates = {"enemy_drider", "enemy_spider_tarantula", "enemy_spider_arachnomancer", "enemy_spider_son_of_mactans", "enemy_sword_spider", "enemy_webspitting_spider"}
...
tt.tween.props[3] = CC("tween_prop")
tt.tween.props[3].name = "offset"
tt.tween.props[3].keys = {{0, vec_2(0, -10)}, {fts(55), vec_2(30, -20)}, {fts(110), vec_2(35, -5)}, {fts(165), vec_2(-35, -8)}, {fts(220), vec_2(25, -20)}, {fts(275), vec_2(-30, -20)}}
tt.tween.props[3].loop = true
tt.tween.props[3].sprite_id = 2
...
tt.info.portrait = "kr3_info_portraits_towers_0015"
...
tt.damage_min = 0.0072
tt.damage_max = 0.0072
tt.damage_type = bor(DAMAGE_ARMOR, DAMAGE_NO_SHIELD_HIT)

tt = RT("mod_archer_tear_small", "mod_archer_tear")
tt.damage_min = 0.0044
tt.damage_max = 0.0044

tt = RT("mod_archer_tear_big", "mod_archer_tear")
tt.damage_min = 0.01
tt.damage_max = 0.01

tt = RT("mod_archer_tear_tiny", "mod_archer_tear")
tt.damage_min = 0.0016
...
tt.eyes_t = {"decal_terrain_3_glare_eye_big", "decal_terrain_3_glare_eye_small_1", "decal_terrain_3_glare_eye_small_2", "decal_terrain_3_glare_eye_small_3"}
...
tt.render.sprites[1].z = Z_OBJECTS_COVERS + 1
tt.tween.props[1].name = "offset"
tt.tween.props[1].keys = {{0, v(0, 0)}, {0.5, v(0, 3)}, {1, v(0, 0)}, {1.5, v(0, -3)}, {2, v(0, 0)}}
tt.tween.props[1].loop = true
tt.tween.remove = false
...
tt.tween.props[1].name = "offset"
tt.tween.props[1].loop = true
tt.tween.props[1].keys = {{0, v(0, 0)}, {fts(35), v(0, 7)}, {fts(70), v(0, 0)}}
tt.tween.props[1].interp = "sine"
tt.tween.disabled = true
tt.tween.remove = false
...
tt.tween.props[1].keys = {{0, 255}, {fts(67), 0}}
tt.tween.props[2] = E:clone_c("tween_prop")
tt.tween.props[2].name = "offset"
tt.tween.props[2].keys = {{0, v(25, 50)}, {fts(22), v(50, 50)}, {fts(67), v(100, 25)}}
...
tt.render.sprites[1].name = "idle1"
tt.life_thresholds = {0.66, 0.33, 0}
...
tt.render.sprites[1].z = Z_OBJECTS
tt.render.sprites[1].sort_y_offset = -5
tt.tween.props[1].keys = {{0, 255}, {fts(40), 255}, {fts(60), 255}, {fts(72), 0}}
...
tt.tween.props[1].keys = {{0, 255}, {fts(50), 255}, {fts(70), 255}, {fts(82), 0}}
...
tt.prev_duration = 5 + 1
tt.scale_timing = 5
tt.scale_duration = 1
tt.decal_duration = 2.5
tt.tween.props[1].keys = {{0, 0}, {0.8, 255}, {tt.prev_duration - 0.1, 255}, {tt.prev_duration + 1, 0}}
tt.tween.props[2] = E:clone_c("tween_prop")
tt.tween.props[2].keys = {{0, 0}, {tt.scale_timing - 0.1, 0}, {tt.scale_timing, 255}, {tt.scale_timing + tt.scale_duration, 0}}
tt.tween.props[2].sprite_id = 2
tt.tween.props[3] = E:clone_c("tween_prop")
tt.tween.props[3].keys = {{0, 0}, {tt.prev_duration - 0.1, 0}, {tt.prev_duration, 255}, {tt.prev_duration + tt.decal_duration - 1, 255}, {tt.prev_duration + tt.decal_duration, 0}}
tt.tween.props[3].sprite_id = 3
tt.tween.props[4] = E:clone_c("tween_prop")
tt.tween.props[4].name = "scale"
tt.tween.props[4].keys = {{fts(0), v(1, 1)}, {tt.scale_timing - 0.1, v(1, 1)}, {tt.scale_timing + tt.scale_duration, v(1.5, 1.5)}}
tt.tween.props[4].sprite_id = 2
tt.tween.props[5] = E:clone_c("tween_prop")
tt.tween.props[5].keys = {{0, 0}, {tt.scale_timing - 0.1, 0}, {tt.scale_timing, 255}, {tt.scale_timing + tt.scale_duration + 1, 0}}
...
tt = E:register_t("bullet_vile_spawner_spawn", "bomb")
...
tt = E:register_t("bullet_vile_spawner_spawn_particle", "bomb")
tt.bullet.flight_time = fts(30)
tt.bullet.align_with_trajectory = true
tt.bullet.ignore_hit_offset = true
tt.bullet.pop = nil
...
AC(tt, "render", "dps")
tt.dps.damage_min = 140
tt.dps.damage_max = 260
...
tt.aura.damage_type = DAMAGE_DISINTEGRATE
tt.aura.cycle_time = fts(2)
...
E:add_comps(tt, "dps")
tt.modifier.duration = fts(60)
tt.dps.damage_min = 560
tt.dps.damage_max = 780
...
tt.info.enc_icon = 12
tt.info.portrait = "kr5_info_portraits_soldiers_0037" -- TODO: 我暂时不知道迪纳斯是哪个头像
tt.info.fn = scripts.soldier_reinforcement.get_info
tt.info.random_name_format = nil
tt.render.sprites[1].anchor = v(0.5, 0.5)
...
tt.melee.attacks[1].damage_max = 49
tt.melee.attacks[1].damage_type = DAMAGE_TRUE
...
tt.melee.attacks[3].damage_min = 400
tt.melee.attacks[3].damage_max = 500
...
tt.power_cooldown = 30
tt.spawn_stun_radius = 50
...
tt.attacks.list[1].min_range = 40
tt.render.sprites[1].animated = false
...
tt = E:register_t("bullet_tower_stage_17_weirdwood", "bomb")
...
tt.info.portrait = "kr5_portraits_towers_0028"
...
tt.render.sprites[3].exo = true
tt.attacks.list[1] = E:clone_c("custom_attack")
tt.attacks.list[1].price = 250
tt.attacks.list[1].price_iron = 100
tt.attacks.list[1].cast_time = fts(60)
tt.attacks.list[1].bullet = "bullet_stage_20_arborean_oldtree"
tt.attacks.list[1].path_index = 2
tt.attacks.list[1].node_index = 170
tt.attacks.list[1].path_index_iron = 3
tt.attacks.list[1].node_index_iron = 105
tt.attacks.list[1].cooldown = 90
...
tt.info.portrait = "kr5_portraits_towers_0027"
...
tt.render.sprites[2] = E:clone_c("sprite")
tt.render.sprites[2].loop = false
tt.render.sprites[2].prefix = "arborean_honey_tower_unit"
tt.render.sprites[2].name = "idle"
tt.render.sprites[2].hidden = true
tt.render.sprites[2].draw_order = 3
tt.render.sprites[3] = E:clone_c("sprite")
tt.render.sprites[3].loop = false
tt.render.sprites[3].prefix = "arborean_honey_tower_deco_unit"
tt.render.sprites[3].name = "idle_1"
tt.render.sprites[3].hidden = true
tt.render.sprites[3].draw_order = 4
tt.render.sprites[4] = E:clone_c("sprite")
tt.render.sprites[4].loop = false
tt.render.sprites[4].name = "arborean_honey_tower_smoke"
tt.render.sprites[4].hidden = true
tt.render.sprites[4].draw_order = 5
tt.render.sprites[5] = E:clone_c("sprite")
tt.render.sprites[5].prefix = ""
tt.render.sprites[5].name = "arborean_honey_tower_tower_0001"
tt.render.sprites[5].animated = false
tt.render.sprites[5].offset.y = 0
tt.render.sprites[5].draw_order = 2
...
tt.info.portrait = "kr5_portraits_towers_0026"
...
tt.render.sprites[tt.render.sid_base].z = Z_DECALS
...
tt.life_thresholds = {0.7, 0.4, 0}
tt.user_selection.ignore_point = true
tt.ui.has_nav_mesh = true
tt.attacks.list[1] = E:clone_c("custom_attack")
tt.attacks.list[1].price = 50
tt.attacks.list[1].cast_time = fts(10)
tt.attacks.list[1].cooldown_min = 0.3
tt.attacks.list[1].cooldown_max = 0.6
tt.attacks.list[1].cooldown_disable = 2
...
tt.health_bar.colors = {}
tt.health_bar.colors.fg = {255, 128, 255, 255}
tt.health_bar.colors.bg = {22, 46, 59, 255}
tt.health.ignore_delete_after = true
tt.vis.flags = bor(F_FRIEND, F_RANGED)
tt.vis.bans = bor(F_AREA, F_MOD)
...
tt.attacks.range = 260
tt.attacks.list[1] = E:clone_c("bullet_attack")
tt.attacks.list[1].bullet = "bullet_stage_20_arborean_watchtower"
tt.attacks.list[1].cooldown = 2.4
tt.attacks.list[1].shoot_time = fts(6)
tt.attacks.list[1].bullet_start_offset = {v(0, 25), v(0, 25), v(0, 25)}
tt.attacks.list[1].vis_flags = bor(F_RANGED)
...
tt.render.sprites[5].angles.idle = {"idle", "idle"}
tt.render.sprites[5].angles.shoot = {"ranged_attack", "ranged_attack"}
...
tt.picked_enemies_to_destroy = {2, 4, 6}
tt.tunnel_check_cooldown = 3
...
tt.tower.range_offset = v(0, 10)
tt.tower.price = 0
tt.info.portrait = "kr5_portraits_towers_0023"
...
tt = E:register_t("bullet_crocs_egg_spawner_spawn", "bomb")
tt.bullet.flight_time = fts(30)
tt.bullet.align_with_trajectory = false
tt.bullet.ignore_hit_offset = true
tt.bullet.pop = nil
...
tt = E:register_t("bullet_stage_20_arborean_oldtree", "bomb")
tt.bullet.flight_time = fts(25)
tt.bullet.hit_fx = nil
tt.bullet.pop = nil
tt.bullet.hit_decal = nil
...
tt = E:register_t("bullet_stage_20_arborean_honey", "bomb")
tt.bullet.flight_time = fts(25)
...
tt.render.sprites[1].name = "run"
tt.bullet.damage_min = 38
tt.bullet.damage_max = 52
...
tt.particle_system.particle_lifetime = {fts(24), fts(24)}
...
tt.particle_system.animated = true
tt.particle_system.particle_lifetime = {fts(66), fts(66)}
...
tt.particle_system.particle_lifetime = {fts(48), fts(48)}
tt.particle_system.scales_x = {1, 0.05}
tt.particle_system.scales_y = {1, 0.05}
...
tt.entity_t = {{"enemy_crocs_basic_egg", "enemy_crocs_basic"}, {"enemy_crocs_basic", "enemy_killertile"}, {"enemy_killertile", "enemy_crocs_tank"}}
...
E:add_comps(tt, "render", "tween")
tt.balance_slow_factor = 0.6
tt.balance_duration = 0.5
tt.slow.factor = 0.6
...
tt.modifier.duration = 1e+99
tt.render.sprites[1].prefix = "boss_gator_tower_killDef"
tt.render.sprites[1].name = "attack1"
tt.render.sprites[1].exo = true
...
tt = E:register_t("bullet_boss_spider_queen_lifesteal", "bomb")
tt.main_script.update = scripts.bullet_boss_spider_queen_tower_stun.update
tt.bullet.flight_time = fts(10)
tt.bullet.vis_flags = bor(F_RANGED, F_MOD)
...
tt.tower_holder.unblock_price = 65
tt.prices = {65, 65, 30}
...
tt.modifier.duration = 1
tt.dps.fx = "fx_water_sorceress_bolt_hit"
tt.dps.damage_min = 280
tt.dps.damage_max = 320
tt.dps.damage_every = 1e+99
...
tt.powers.increase_damage.damage_factor = {1.5, 2, 3}
tt.powers.increase_damage.price_base = 150
tt.powers.increase_damage.price_inc = 300
tt.powers.increase_rate = E:clone_c("power")
tt.powers.increase_rate.attack_cooldown = {3, 2.4, 1.6}
tt.powers.increase_rate.price_base = 150
tt.powers.increase_rate.price_inc = 250
...
tt.render.sprites[tt.render.sid_rune].name = "terrain_mage_0007"
tt.render.sprites[tt.render.sid_rune].hidden = true
tt.render.sprites[2] = E:clone_c("sprite")
...
tt.melee.attacks[1].damage_max = 75 / #tt.melee.attacks[1].hit_times
tt.melee.attacks[1].damage_min = 60 / #tt.melee.attacks[1].hit_times
...
-- kr6 关卡 202（kr6 stage02）所需模板
tt = RT("controller_stage_202_masterclass_achievement_tracker", "decal")

AC(tt, "main_script", "pos")

tt.main_script.update = scripts.controller_stage_202_masterclass_achievement_tracker.update

tt = RT("controller_stage_202_scrolls", "decal")

AC(tt, "pos", "main_script")

tt.main_script.update = scripts.controller_stage_202_scrolls.update
tt.amount_for_achievement = 4
tt.scrolls_obtained = 0

tt = RT("controller_stage_202_teleport_left", "decal")

AC(tt, "main_script")

tt.main_script.update = scripts.controller_stage_202_teleport.update
...
tt = RT("controller_stage_202_teleport_right", "decal")
...
tt = RT("decal_stage_202_book", "decal_scripted")
...
tt.render.sprites[1].exo = true
tt.render.sprites[1].z = Z_OBJECTS
tt.main_script.update = scripts.decal_stage_202_book.update
tt.sound = "Stage02BookFountainTap"
tt.ui.click_rect = r(-42.5, -35, 85, 60)

tt = RT("decal_stage_202_chess_bishop_black", "decal")
...
tt = RT("decal_stage_202_chess_knight", "decal_scripted")
...
tt.render.sprites[1].exo = true
tt.render.sprites[1].z = Z_OBJECTS
tt.main_script.insert = scripts.decal_stage_202_chess.insert
tt.main_script.update = scripts.decal_stage_202_chess.update
tt.controller_t = "controller_stage_202_chess"
...
tt = RT("decal_stage_202_chess_bishop", "decal_scripted")
...
tt = RT("decal_stage_202_chess_knight_black", "decal")
tt.controller_t = "controller_stage_202_chess"
...
tt = RT("decal_stage_202_chess_rook", "decal_scripted")
...
tt = RT("decal_stage_202_chess_rook_black", "decal")
tt.controller_t = "controller_stage_202_chess"
...
tt = RT("decal_stage_202_lamp", "decal_scripted")
...
tt = RT("decal_stage_202_mage_1_2", "decal")
...
tt = RT("decal_stage_202_mage_1", "decal")
...
tt = RT("decal_stage_202_mage_3_2", "decal_scripted")

tt.render.sprites[1].prefix = "mage2_animationsDef"
tt.render.sprites[1].name = "idle"
tt.render.sprites[1].exo = true
tt.render.sprites[1].z = Z_OBJECTS
tt.main_script.update = scripts.decal_stage_202_mage_2.update

tt.render.sprites[1].prefix = "mage3_animationsDef"
tt.main_script.update = scripts.decal_stage_202_mage_3.update

tt.render.sprites[1].prefix = "mage3_2_animationsDef"

tt = RT("decal_stage_202_mage_3", "decal_scripted")
...
tt = RT("decal_stage_202_mage_2", "decal_scripted")
...
tt = RT("decal_stage_202_mage_4_2", "decal_scripted")
...
tt.render.sprites[1].name = "idle1"
tt.main_script.update = scripts.decal_stage_202_mage_4.update

tt.render.sprites[1].prefix = "mage4_2_animationsDef"
tt.render.sprites[1].flip_x = true

tt = RT("decal_stage_202_mage_4", "decal_scripted")
...
tt = RT("decal_stage_202_mage_4_3", "decal_scripted")
...
tt = RT("decal_stage_202_magnus", "decal_scripted")
...
tt.render.sprites[1].name = "idle"
tt.render.sprites[1].exo = true
tt.main_script.update = scripts.decal_stage_202_magnus.update
...
tt = RT("decal_stage_202_mask_1", "decal")

tt.render.sprites[1].name = "KR6_stage_202_mask1"
tt.render.sprites[1].animated = false
tt.render.sprites[1].z = Z_OBJECTS_COVERS

tt = RT("decal_stage_202_mask_2", "decal")

tt.render.sprites[1].name = "KR6_stage_202_mask2"
tt.render.sprites[1].animated = false
tt.render.sprites[1].z = Z_OBJECTS

tt = RT("decal_stage_202_mask_3", "decal")
...
tt = RT("decal_stage_202_merlin", "decal_scripted")
...
tt.main_script.update = scripts.decal_stage_202_merlin.update
tt.sound_p1 = "Stage02MerlinPart1"
tt.sound_p2 = "Stage02MerlinPart2"
tt.ui.click_rect = r(-50, -60, 110, 120)

tt = RT("decal_stage_202_scroll_2", "decal_scripted")
...
tt.main_script.update = scripts.decal_stage_202_scroll.update
tt.ui.click_rect = r(-476, -76, 25, 18)

tt.render.sprites[1].prefix = "scroll_2Def"
tt.ui.click_rect = r(249, 141, 25, 18)

tt = RT("decal_stage_202_scroll_1", "decal_scripted")
...
tt = RT("decal_stage_202_scroll_3", "decal_scripted")
...
tt = RT("decal_stage_202_scroll_4", "decal_scripted")
...
tt = RT("decal_stage_202_water_small", "decal")
...
tt = RT("decal_stage_202_water", "decal")
...
tt = RT("decal_stage_202_wisp", "decal_scripted")

tt.render.sprites[1].prefix = "magewispDef"
tt.render.sprites[1].name = "run"
tt.render.sprites[1].exo = true
tt.render.sprites[1].random_ts = fts(30)
tt.main_script.update = scripts.decal_stage_202_wisp.update

tt = RT("controller_stage_202_chess")

AC(tt, "main_script")

tt.main_script.update = scripts.controller_stage_202_chess.update
...
-- kr6 关卡 202：传送门链（控制器引用的模板）
tt = RT("decal_stage_202_teleport_book_left", "decal")
tt.render.sprites[1].prefix = "stage202_tpDef"
tt.render.sprites[1].name = "idle_active"
tt.render.sprites[1].exo = true
tt.render.sprites[1].z = Z_OBJECTS_COVERS + 1

tt = RT("decal_stage_202_teleport_book_right", "decal_stage_202_teleport_book_left")
tt.render.sprites[1].prefix = "stage202_tp2Def"

tt = RT("decal_stage_202_teleport", "decal_timed")
tt.render.sprites[1].prefix = "stage202_teleport_decalDef"
tt.render.sprites[1].name = "run"
tt.render.sprites[1].exo = true

tt = RT("mod_stage_202_teleport_mark", "modifier")
...
tt = RT("mod_stage_202_teleport", "mod_teleport")
tt.modifier.vis_flags = bor(F_MOD)
tt.modifier.vis_bans = bor(F_BOSS)
tt.modifier.duration = 1
...
tt = RT("controller_stage_202_teleport_left")
...
tt = RT("controller_stage_202_teleport_right", "controller_stage_202_teleport_left")
tt.book_t = "decal_stage_202_teleport_book_right"

tt = RT("fx_stage_202_teleport", "fx")
...
tt.info.fn = scripts.enemy_ranged.get_info
...
tt.bullet.flight_time = fts(22)
tt.bullet.damage_type = DAMAGE_PHYSICAL
tt.bullet.pop = {"pop_archer", "pop_archer2"}
...
tt.main_script.update = scripts.arrow_KR6.update
tt.sound_events.insert = "ArrowSound"
tt.bullet.prediction_error = true
tt.bullet.predict_target_pos = true
tt.bullet.hide_radius = 6
tt.bullet.flip_hit_fx = false

tt = RT("arrow_KR6_fixed_height", "arrow_KR6")
tt.main_script.insert = scripts.arrow_KR6_fixed_height.insert

tt = RT("bullet_shadow_archer", "arrow_KR6_fixed_height")
tt.main_script.insert = scripts.arrow_KR6.insert
tt.main_script.update = scripts.arrow_KR6.update
...
tt.bullet.damage_type = 2

tt = RT("pop_archer", "pop")
tt.render.sprites[1].name = "pop_0002"

tt = RT("pop_archer2", "pop")
