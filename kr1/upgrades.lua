...
function upgrades:arrows()
    return {"arrow_1", "arrow_2", "arrow_3", "arrow_ranger", "shotgun_musketeer", "shotgun_musketeer_sniper",
            ...
            "arrow_hero_alleria", "multishot_crossbow", "knife_catha","bullet_tower_dark_elf_lvl4","bullet_tower_sand_lvl4", "bullet_tower_sand_skill_gold", "arrow_armor_piercer_royal_archers","tower_royal_archers_arrow_lvl4","bullet_tower_ballista_lvl4", "bullet_tower_ballista_skill_final_shot"}
end
