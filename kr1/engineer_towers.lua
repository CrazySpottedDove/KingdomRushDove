...
tt.powers.watcher.price_base = 250
...
tt.attacks.list[3].hit_time = fts(11)
tt.attacks.list[3].start_offset = v(0, -10 + balloon_offset_y)
tt.attacks.list[3].max_range = 60
tt.attacks.list[3].min_range = 0
tt.attacks.list[4] = E:clone_c("custom_attack")
tt.attacks.list[4].bullet = "bullet_tower_balloon_big_guy"
tt.attacks.list[4].cooldown = 12
tt.attacks.list[4].bullet_start_offset = v(-25, 105)
