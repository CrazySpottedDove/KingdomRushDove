...
tt.attacks.list[1].bomb_amount = b.basic_attack.bomb_amount
...
tt.attacks.list[1].node_prediction = fts(25)
tt.attacks.list[1].range = b.basic_attack.range
tt.attacks.list[1].shoot_time = fts(48)
...
tt.level = 4
tt.health.hp_max = b.basic_attack.hp_max
...
tt.melee.attacks[1].damage_max = b.basic_attack.melee_attack.damage_max
tt.melee.attacks[1].damage_min = b.basic_attack.melee_attack.damage_min
...
tt.attacks.list[1].damage_min = b.basic_attack.damage_min
tt.attacks.list[1].damage_max = b.basic_attack.damage_max
...
tt.attacks.list[1].ray_timing_max = b.basic_attack.ray_timing_max
tt.attacks.list[1].ray_timing_min = b.basic_attack.ray_timing_min
