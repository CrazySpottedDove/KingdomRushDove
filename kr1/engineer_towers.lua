...
tower_dwaarp.attacks.list[2].mods = {"mod_slow_dwaarp_lava"}
...
tower_dwaarp.attacks.list[3].cooldown_base = 29
...
tt = E:register_t("mod_slow_dwaarp_lava", "mod_slow")
tt.modifier.duration = E:get_template("mod_slow_dwaarp").modifier.duration * 2
tt.slow.factor = 0.25
...
decal_dwaarp_scorched_water.timed.runs = INT_32_MAX
...
tt.attacks.list[1].bomb_amount = 3
...
tt.attacks.list[1].time_between_bombs = fts(1)
...
tt.powers.master_exploders.price_base = 150
tt.powers.master_exploders.price_inc = 200
tt.powers.master_exploders.explosion_damage_factor = {1.2, 1.4, 1.6}
tt.powers.master_exploders.burning_duration = {3, 4, 5}
tt.powers.master_exploders.burning_damage_min = {2, 4, 6}
tt.powers.master_exploders.burning_damage_max = {4, 6, 10}
...
tt.powers.big_guy.price_base = 225
tt.powers.big_guy.price_inc = 125
tt.powers.big_guy.cooldown = {33, 33, 33}
...
tt.health_bar.type = HEALTH_BAR_SIZE_MEDIUM
tt.health_level = {100, 150, 200}
tt.explosion_damage = {100, 175, 250}
tt.explosion_range = {65, 65, 65}
tt.explosion_damage_type = DAMAGE_EXPLOSION
tt.explosion_sound = "TowerDemonPitDemonExplosion"
tt.info.fn = scripts.soldier_reinforcement.get_info
...
tt.damage_max = {29, 42, 55}
tt.damage_min = {19, 28, 37}
tt.melee.range = 40
...
tt.attacks.attack_delay_on_spawn = fts(5)
tt.attacks.list[1] = CC("bullet_attack")
tt.attacks.list[1].cooldown = 3.9
...
tt.attacks.list[1].duration = 1.2
...
tt.attacks.list[1].cycle_time = 0.12
tt.attacks.list[1].damage_min = 8
tt.attacks.list[1].damage_max = 11
...
tt.attacks.list[2].max_range = 300
tt.attacks.list[2].min_range = 100
tt.attacks.list[2].cooldown = 20
tt.attacks.list[2].shoot_time = fts(20)
tt.attacks.list[2].vis_bans = bor(F_FRIEND, F_FLYING, F_CLIFF)
tt.attacks.list[2].vis_flags = bor(F_AREA)
tt.attacks.list[2].bullet_start_offset = vec_2(32, 40)
tt.attacks.list[2].node_prediction = fts(88)
tt.attacks.list[2].damage_type = DAMAGE_EXPLOSION
tt.attacks.list[2].damage_max = {80, 180, 280}
tt.attacks.list[2].damage_min = {80, 180, 280}
...
tt.powers.skill_bomb.price_base = 225
tt.powers.skill_bomb.price_inc = 200
tt.powers.skill_bomb.cooldown = {20, 20, 20}
tt.powers.skill_columns = CC("power")
tt.powers.skill_columns.cooldown = {25, 25, 25}
tt.powers.skill_columns.price_base = 225
tt.powers.skill_columns.price_inc = 250
tt.powers.skill_columns.column_template = "controller_tower_flamespitter_column"
tt.powers.skill_columns.stun_time = 30
tt.powers.skill_columns.columns = 6
tt.powers.skill_columns.damage_in_max = {70, 180, 300}
tt.powers.skill_columns.damage_in_min = {70, 180, 300}
tt.powers.skill_columns.damage_out_max = {42, 108, 180}
tt.powers.skill_columns.damage_out_min = {42, 108, 180}
tt.powers.skill_columns.decal_start_offset = vec_2(-20, 0)
tt.tower_top_offset = vec_2(0, 20)
tt.tower.range_offset = v(0, 20)
tt.turn_speed = 8
...
tt.damage_in_type = DAMAGE_DISINTEGRATE + DAMAGE_TRUE
tt.damage_out_type = DAMAGE_PHYSICAL
tt.radius_in = 30
tt.radius_out = 55
...
tt.attacks.list[1].cooldown = 2.64
tt.attacks.list[1].shoot_time = fts(8)
tt.attacks.list[1].vis_bans = bor(F_FLYING, F_CLIFF)
tt.attacks.list[1].node_prediction = fts(25)
tt.attacks.list[1].animation = "attack"
...
tt.powers.skill_warrior.price_base = 200
tt.powers.skill_warrior.price_inc = 150
tt.powers.skill_warrior.cooldown = {12, 11, 10}
tt.powers.skill_warrior.hp_max = {300, 375, 450}
tt.powers.skill_warrior.armor = {0, 0, 0}
...
tt.powers.skill_barrel.cooldown = {27, 24, 21}
tt.powers.skill_barrel.price_base = 225
tt.powers.skill_barrel.price_inc = 175
...
tt.melee.attacks[1].damage_min_config = {30, 48, 64}
tt.melee.attacks[1].damage_max_config = {45, 72, 99}
...
tt.modifier.level = 4
tt.modifier.duration = 5
tt.inflicted_damage_factor = 0.6
...
tt.explosion_damage_min = {80, 130, 180}
tt.explosion_damage_max = {120, 200, 280}
tt.explosion_damage_type = DAMAGE_PHYSICAL
tt.explosion_damage_radius = 75
...
tt.powers.crystalize.price_base = 225
tt.powers.crystalize.price_inc = 225
tt.powers.crystalize.cooldown = {27.5, 20}
tt.powers.crystalize.max_level = #tt.powers.crystalize.cooldown
tt.powers.spike_burst = CC("power")
tt.powers.spike_burst.price_base = 300
tt.powers.spike_burst.price_inc = 300
-- cooldown 先赋值，max_level 由它的长度派生（与该技能只有 2 级保持一致）
tt.powers.spike_burst.cooldown = {32, 24}
tt.powers.spike_burst.max_level = #tt.powers.spike_burst.cooldown
...
tt.attacks.range = 190
tt.attacks.attack_delay_on_spawn = fts(5)
tt.attacks.attack_count_for_min_cooldown = 8
tt.attacks.attack_count_for_min_cooldown_base = 8
tt.attacks.list[1] = CC("bullet_attack")
...
tt.attacks.list[1].ray_timing_max = 0.65
tt.attacks.list[1].ray_timing_min = 0.48
tt.attacks.list[1].targeting_style = 1
...
tt.attacks.list[2].duration = {5, 6}
tt.attacks.list[2].received_damage_factor = {1.25, 1.25}
tt.attacks.list[2].vis_flags = bor(F_STUN, F_MOD, F_CUSTOM)
tt.attacks.list[2].vis_bans = bor(F_BOSS, F_MINIBOSS, F_FLYING, F_STUN, F_CUSTOM)
tt.attacks.list[2].cast_time = fts(16)
tt.attacks.list[2].max_targets = {4, 5}
...
tt.attacks.list[3].duration = {8, 12}
...
tt.bullet.level = 4
tt.bullet.damage_type = DAMAGE_TRUE
tt.bullet.damage_min = ({3, 5, 7, 10})[tt.bullet.level]
tt.bullet.damage_max = ({4, 6, 9, 13})[tt.bullet.level]
...
tt.bounces_min = ({1, 2, 3, 4})[tt.bullet.level]
tt.bounces_max = ({1, 2, 3, 4})[tt.bullet.level]
tt.bounce_range = 140
tt.bounce_vis_flags = F_RANGED
tt.bounce_vis_bans = 0
tt.bounce_damage_factor = ({1.05, 1.1, 1.15, 1.3})[tt.bullet.level]
tt.bounce_delay = fts(2)
tt.bounce_scale_y = 1
...
tt.modifier.duration = 0.5 + fts(1)
tt.slow.factor = {0.675, 0.6}
...
tt.dps.damage_min = {4, 5}
tt.dps.damage_max = {4, 5}
tt.dps.damage_type = DAMAGE_TRUE
...
tt.powers.fog.price_base = 160
tt.powers.fog.price_inc = 160
...
tt.info.enc_icon = 5
tt.info.portrait = "kr4_info_portraits_towers_0004"
tt.info.fn = scripts.tower_rocket_riders.get_info
tt.main_script.remove = scripts.tower_rocket_riders.remove
tt.main_script.update = scripts.tower_rocket_riders.update
tt.sound_events.insert = "RocketRidersTaunt"
tt.powers.mine = CC("power")
tt.powers.mine.price_base = 200
tt.powers.mine.price_inc = 175
tt.powers.mine.entity = "rr_mine_box"
tt.powers.engine = CC("power")
tt.powers.engine.max_level = 2
tt.powers.engine.price_base = 270
tt.powers.engine.price_inc = 150
tt.powers.engine.fragment_count = {5, 7}
tt.powers.engine.damage_inc = {23, 32}
...
tt.particle_system.particle_lifetime = {0.2, 0.3}
...
tt.main_script.insert = scripts.missile.insert
tt.main_script.update = scripts.missile.update
tt.main_script.remove = scripts.missile_rr.remove

tt = RT("missile_rr_nitro", "missile_rr")
tt.bullet.flight_time = fts(35)
tt.bullet.hit_fx = "fx_explosion_nitro"
tt.bullet.min_speed = 350
tt.bullet.max_speed = 500
tt.render.sprites[1].prefix = "warmongers_rocket_missile_lvl4_special"
tt.sound_events.hit_water = nil
...
tt.mod = "mod_rr_mine_stun"
tt.main_script.update = scripts.decal_rr_mine.update
tt.radius = 50
...
tt = RT("tower_balloon", "tower")
AC(tt, "barrack", "powers")
tt.tower.type = "balloon"
tt.tower.price = 375
tt.tower.menu_offset = v(0, 15)
tt.info.fn = scripts.tower_mech.get_info
tt.info.portrait = "kr4_info_portraits_towers_0015"
tt.info.enc_icon = 2
tt.main_script.update = scripts.tower_balloon.update
tt.main_script.remove = scripts.tower_barrack.remove
...
tt.powers.bomber.price_base = 150
tt.powers.bomber.max_level = 1
tt.powers.oil = E:clone_c("power")
tt.powers.oil.price_base = 120
tt.powers.oil.price_inc = 120
...
tt.sound_events.change_rally_point = "BalloonTaunt"
tt.ui.click_rect = r(-40, -10, 80, 50)
...
tt.main_script.insert = scripts.soldier_balloon.insert
tt.main_script.remove = scripts.soldier_balloon.remove
...
tt.attacks.list[1].bullet = "bomb_balloon"
tt.attacks.list[1].vis_bans = F_FLYING
tt.attacks.list[1].animations = {"shoot", "shoot"}
tt.attacks.list[1].hit_times = {fts(18), fts(18)}
tt.attacks.list[1].max_range = 105
tt.attacks.list[1].start_offsets = {v(-10, 20 + balloon_offset_y), v(10, 20 + balloon_offset_y)}
tt.attacks.list[1].cooldown = 1
tt.attacks.list[1].node_prediction = fts(38)
tt.attacks.list[2] = E:clone_c("bullet_attack")
tt.attacks.list[2].bullet = "bullet_balloon_oil"
tt.attacks.list[2].power_name = "oil"
tt.attacks.list[2].vis_bans = F_FLYING
tt.attacks.list[2].animation = "run"
tt.attacks.list[2].cooldown = 12
tt.attacks.list[2].hit_time = fts(11)
tt.attacks.list[2].start_offset = v(0, -10 + balloon_offset_y)
tt.attacks.list[2].max_range = 45
tt.attacks.list[3] = E:clone_c("custom_attack")
tt.attacks.list[3].bullet = "bullet_tower_balloon_big_guy"
...
tt.powers.oil = E:clone_c("power")
tt.powers.watcher = E:clone_c("power")
tt.powers.watcher.mod = "mod_balloon"

tt = RT("bullet_tower_balloon_big_guy", "bomb")
tt.bullet.rotation_speed = nil
tt.bullet.damage_type = DAMAGE_NONE
tt.bullet.damage_min = 0
tt.bullet.damage_max = 0
...
tt.sound_events.insert = "BalloonTrooper"
tt.sound_events.hit = "BalloonTrooper"
tt.sound_events.hit_water = nil
tt.bullet.hit_payload = "soldier_balloon_goblin"

tt = RT("bomb_balloon", "bomb")
...
tt.bullet.hit_payload = "oil_balloon_aura"
...
tt = E:register_t("oil_balloon_aura", "aura")
AC(tt, "render", "tween")
tt.aura.mod = "mod_slow_oil_balloon"
tt.aura.duration = 6
tt.aura.cycle_time = 0.3
tt.aura.radius = 60
tt.aura.vis_bans = bor(F_FRIEND, F_FLYING)
...
tt.main_script.update = scripts.aura_apply_mod.update
tt.render.sprites[1].animated = false
tt.render.sprites[1].name = "warmongers_baloon_tower_lvl4_splash_decal"
tt.render.sprites[1].z = Z_DECALS
tt.tween.props[1].name = "alpha"
tt.tween.props[1].keys = {{"this.actual_duration-0.6", 255}, {"this.actual_duration", 0}}
tt.tween.props[2] = E:clone_c("tween_prop")
tt.tween.props[2].name = "scale"
tt.tween.props[2].keys = {{0, v(0.6, 0.6)}, {0.3, v(1, 1)}}
tt.tween.remove = false
...
tt.info.portrait = "kr4_info_portraits_soldiers_0027"
tt.main_script.update = scripts.soldier_balloon_goblin.update
tt.controable = false
tt.health.hp_max = 60
tt.regen.health = 0
tt.regen.cooldown = 2
...
tt.ranged.attacks[1].bullet_start_offset = {v(6, 10)}
...
tt = RT("bomb_soldier_balloon_goblin", "bomb")
...
tt = E:register_t("mod_balloon", "modifier")
AC(tt, "render", "tween")
tt.modifier.duration = -1
tt.cooldown_factor = 0.85
tt.speed_inc = 20
tt.main_script.insert = scripts.mod_balloon.insert
tt.main_script.remove = scripts.mod_balloon.remove
tt.tween.remove = false
tt.tween.props[1].name = "scale"
tt.tween.props[1].loop = true
tt.tween.props[1].keys = {{0, v(1, 1)}, {0.5, v(0.9, 0.9)}, {1, v(1, 1)}}
...
tt.powers.burning_elemental.price_base = 225
...
tt.attacks.list[1].cooldown = 4
tt.attacks.list[1].hit_times = {fts(54), fts(10)}
tt.attacks.list[1].mods = {"mod_furnace_stun"}
tt.attacks.list[1].damage_min = 48
tt.attacks.list[1].damage_max = 56
...
tt.powers.coal.price_base = 360
tt.powers.coal.price_inc = 210
tt.powers.coal.max_level = 2
tt.powers.coal.fragment_count_base = 2
tt.powers.coal.fragment_count_inc = 2
tt.powers.heat = CC("power")
tt.powers.heat.price_base = 250
tt.powers.heat.price_inc = 250
...
tt.damage_armor = 0.0035
tt.render.sprites[1].animated = false
tt.render.sprites[1].name = "darkarmy_melting_furnace_decal_fissure"
tt.render.sprites[1].z = Z_DECALS
tt.render.sprites[2] = CC("sprite")
...
tt.tower.kind = TOWER_KIND_ENGINEER
tt.tower.price = 350
tt.info.portrait = "kr4_info_portraits_towers_0021"
tt.info.enc_icon = 21
tt.render.sprites[1].animated = false
tt.render.sprites[1].name = "terrains_%04i"
...
tt.attacks.list[2].vis_flags = bor(F_EAT, F_INSTAKILL)
tt.attacks.list[3] = CC("bullet_attack")
tt.attacks.list[3].bullet = "bomb_tower_sandworm_spit"
tt.attacks.list[3].cooldown = 14
tt.attacks.list[3].animation = "spit"
tt.attacks.list[3].shoot_time = fts(25)
tt.attacks.list[3].vis_bans = bor(F_FLYING)
...
tt.powers.eat.price_base = 250
tt.powers.eat.price_inc = 50
...
tt.bullet.level = 1
tt.bullet.flight_time = fts(25)
tt.bullet.particles_name = "ps_tower_sandworm_spit"
...
tt = RT("ps_tower_sandworm_spit", "particle_system")
tt.particle_system.name = "worm_nest_level4_spit_trail_run"
tt.particle_system.animated = true
tt.particle_system.loop = false
tt.particle_system.particle_lifetime = {0.25, 0.35}
tt.particle_system.scales_x = {1, 2.5}
tt.particle_system.scales_y = {1, 2.5}
tt.particle_system.scale_var = {0.4, 0.9}
