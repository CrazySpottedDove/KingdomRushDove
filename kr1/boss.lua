...
tt.aura.damage_min = 800
tt.aura.damage_max = 625
...
tt.melee.attacks[1].hit_time = fts(17)
tt.melee.attacks[1].damage_radius = 10
tt.melee.attacks[1].damage_type = bor(DAMAGE_PHYSICAL, DAMAGE_NO_DODGE)
tt.melee.attacks[1].hit_fx_offset = v(20, -20)
tt.melee.attacks[2] = E:clone_c("area_attack")
tt.melee.attacks[2].animation = "areaattack"
tt.melee.attacks[2].cooldown = 4
tt.melee.attacks[2].damage_max = 400
tt.melee.attacks[2].damage_min = 320
tt.melee.attacks[2].hit_time = fts(17)
tt.melee.attacks[2].damage_radius = 80
tt.melee.attacks[2].damage_type = bor(DAMAGE_MAGICAL, DAMAGE_NO_DODGE)
tt.melee.attacks[2].min_count = 2
...
tt.life_threshold_teleport = {
	away_duration = 8,
	life_percentage = {66.67, 33.33}
}
tt.teleport_away_duration = 8
...
tt.block_attack.damage_min = 0
tt.block_attack.damage_max = 0
tt.block_attack.damage_type = DAMAGE_PHYSICAL
tt.block_attack.radius = 100
tt.block_attack.vis = 0
tt.block_attack.bans = bor(F_FLYING)
tt.block_attack.min_targets = 1
tt.open_armor = 0
tt.close_armor = 0.9
tt.open_magic_armor = 0
tt.close_magic_armor = 0.9
tt.time_death = 3
tt.glare_kr5.regen_hp = 50
tt.denas_ray_resistance = 0.5
...
tt.melee.attacks[1].cooldown = 1.5
tt.melee.attacks[1].damage_max = 350
tt.melee.attacks[1].damage_min = 192
tt.melee.attacks[1].damage_radius = 60
tt.melee.attacks[1].hit_time = fts(20)
tt.melee.attacks[1].damage_type = bor(DAMAGE_PHYSICAL, DAMAGE_NO_DODGE)
...
tt.tornado_hp_trigger = {0.9, 0.6, 0.15}
tt.tornado_duration = 6
tt.tornado_speed_mult = 1.25
tt.tornado_balls_count = {3, 3, 3}
...
tt.corruption_kr5.cooldown = 10
tt.corruption_kr5.hp = 256
...
tt.melee.attacks[1] = E:clone_c("area_attack")
tt.melee.attacks[1].cooldown = 2
tt.melee.attacks[1].damage_max = 375
tt.melee.attacks[1].damage_min = 200
tt.melee.attacks[1].damage_radius = 45
...
tt.ranged.attacks[1].min_range = 80
tt.ranged.attacks[1].max_range = 300
tt.ranged.attacks[1].vis_flags = bor(F_RANGED, F_AREA)
tt.ranged.attacks[1].vis_bans = bor(F_FLYING, F_ENEMY)
...
tt.health.magic_armor = {0.3, 0.3, 0.3, 0.6}
tt.health.armor = 0.2
...
tt.melee.attacks[1] = E:clone_c("area_attack")
tt.melee.attacks[1].cooldown = 1
tt.melee.attacks[1].damage_max = 465
tt.melee.attacks[1].damage_min = 258
tt.melee.attacks[1].damage_type = DAMAGE_PHYSICAL
tt.melee.attacks[1].damage_radius = 110
...
tt.timed_attacks.list[2].first_cooldown = 10
tt.timed_attacks.list[2].nodes_limit = 30
...
tt.timed_attacks.list[3].max_targets = 1e+99
tt.timed_attacks.list[3].max_range = 106
...
tt.timed_attacks.list[3].loop_duration = 5
tt.timed_attacks.list[3].cooldown = 21
tt.timed_attacks.list[3].cooldown_init = 30
tt.timed_attacks.list[3].nodes_limit = 50
...
tt.timed_attacks.list[3].mod_loop_every = 0.3
...
tt.timed_attacks.list[4].amount = 3
tt.timed_attacks.list[4].nodes_spread_start = 3
tt.timed_attacks.list[4].nodes_offset = 8
tt.timed_attacks.list[4].nodes_spread = 6
tt.timed_attacks.list[4].cooldown = 40
tt.timed_attacks.list[4].nodes_limit = 20
tt.timed_attacks.list[4].nodes_limit_reverse = 60
tt.timed_attacks.list[4].first_cooldown = 15
tt.timed_attacks.list[4].object = "decal_boss_spider_queen_spawns"
tt.timed_attacks.list[4].use_custom_formation = false
tt.timed_attacks.list[4].custom_formation = {{{
	spi = 2,
	n = 5
}, {
	spi = 3,
...
tt.melee.attacks[3].cooldown = 5
tt.melee.attacks[3].damage_max = 625
...
tt.timed_attacks.list[1].first_cooldown = 5000
...
tt.timed_attacks.list[2].first_cooldown = 5000
tt.timed_attacks.list[2].cooldown = 20
tt.timed_attacks.list[2].cast_time = fts(44)
tt.timed_attacks.list[2].fx_time = fts(20)
tt.timed_attacks.list[2].duration = 5
tt.timed_attacks.list[2].nodes_limit = 40
...
tt.timed_attacks.list[3].activate_on_positions = {}
...
tt.timed_attacks.list[4].damage_max = 875
tt.timed_attacks.list[4].damage_min = 600
tt.timed_attacks.list[4].damage_type = DAMAGE_MAGICAL
tt.timed_attacks.list[4].damage_radius = 75
tt.timed_attacks.list[4].minimum_fires = 1
tt.timed_attacks.list[4].absorb_radius = 100
tt.timed_attacks.list[4].nodes_limit = 20
tt.timed_attacks.list[4].cooldown = 14
tt.timed_attacks.list[4].first_cooldown = 10
...
tt.timed_attacks.list[5].nodes_limit = 40
tt.timed_attacks.list[5].cooldown = 20
tt.timed_attacks.list[5].first_cooldown = 5
tt.timed_attacks.list[5].side = "boss_jump"
tt.timed_attacks.list[5].disabled = true
tt.change_path_node_start_pos = v(155, 225)
tt.change_path_target = {
	path = 3,
	node_pos = v(906, 341)
}
tt.change_path_meteorite_side = "right"
tt.vis.flags_jumping = bor(F_ENEMY, F_BOSS)
tt.vis.bans_jumping = bor(F_RANGED, F_BLOCK, F_MOD)
tt.vis.flags_normal = bor(F_ENEMY, F_BOSS)
tt.vis.bans_normal = 0
...
tt.second_manual_wave_pos = v(455, 290)
tt.main_script.insert = scripts.boss_bull_king.insert
tt.main_script.update = scripts.boss_bull_king.update
tt.melee.attacks[1].cooldown = 2.75
tt.melee.attacks[1].damage_max = 562.5
tt.melee.attacks[1].damage_min = 350
tt.melee.attacks[1].animation = "attack_melee"
tt.melee.attacks[1].hit_time = fts(20)
...
tt.melee.attacks[2].damage_max = 375
...
tt.timed_attacks.list[1].first_cooldown = 10
tt.timed_attacks.list[1].cooldown = {25, 23.5, 22, 20}
tt.timed_attacks.list[1].damage_type = DAMAGE_PHYSICAL
tt.timed_attacks.list[1].damage_max = 100
tt.timed_attacks.list[1].damage_min = 50
tt.timed_attacks.list[1].damage_radius = 450
tt.timed_attacks.list[1].nodes_limit = 20
tt.timed_attacks.list[1].mod_tower_debuff = "mod_bull_king_tower_debuff"
tt.timed_attacks.list[1].max_towers_block = 5
tt.timed_attacks.list[1].max_range = 450
tt.timed_attacks.list[1].min_range = 0
...
tt.ranged.attacks[1].only_foward = true
tt.ranged.attacks[1].only_foward_range = 50
tt.ranged.attacks[1].hold_advance = true
tt.timed_attacks.list[1] = E:clone_c("custom_attack")
tt.timed_attacks.list[1].first_cooldown = 10
tt.timed_attacks.list[1].cooldown = 5
tt.timed_attacks.list[1].animation = "tower_stun"
tt.timed_attacks.list[1].duration = 10
tt.timed_attacks.list[1].max_range = 250
tt.timed_attacks.list[1].min_range = 100
tt.timed_attacks.list[1].max_towers_blocked = 1
tt.timed_attacks.list[1].vis_flags = bor(F_MOD)
tt.timed_attacks.list[1].cast_time = fts(42)
tt.timed_attacks.list[1].bullet_mod = "boss_murglun_proyectil_tower_stun"
tt.timed_attacks.list[1].nodes_limit = 30
tt.timed_attacks.list[1].repair_cost = 100
tt.timed_attacks.list[2] = E:clone_c("custom_attack")
tt.timed_attacks.list[2].first_cooldown = 10
...
tt.timed_attacks.list[2].geisers_amount = 7
...
tt.timed_attacks.list[2].nodes_limit = 30
tt.timed_attacks.list[2].only_foward = true
tt.timed_attacks.list[3] = E:clone_c("area_attack")
tt.timed_attacks.list[3].first_cooldown = 10
tt.timed_attacks.list[3].cooldown = 5
tt.timed_attacks.list[3].animation = "ataque_bite"
tt.timed_attacks.list[3].hit_time = fts(23)
tt.timed_attacks.list[3].nodes_limit = 30
tt.timed_attacks.list[3].min_damage = 300
tt.timed_attacks.list[3].max_damage = 500
tt.timed_attacks.list[3].damage_type = DAMAGE_PHYSICAL
tt.timed_attacks.list[3].damage_radius = 50
...
tt.timed_attacks.list[tt.attack_breath_index].loop_duration = 3
...
tt.timed_attacks.list[tt.attack_chillido_index].loop_duration = 3
...
tt.health.armor = 0
tt.health.dead_lifetime = 100
tt.health.hp_max = {7700, 9900, 11000, 17875}
tt.health_bar.offset = v(-40, 110)
tt.health_bar.type = HEALTH_BAR_SIZE_LARGE
tt.info.portrait = "kr6_info_portraits_enemies_0016"
tt.main_script.insert = scripts.enemy_basic.insert
tt.main_script.update = scripts.enemy_boss_stage_208.update
tt.motion.max_speed = 16
tt.render.sprites[1].prefix = "boss_stage_208_cartDef"
tt.render.sprites[1].exo = true
tt.render.sprites[1].name = "idle"
tt.render.sprites[1].angles = {}
tt.render.sprites[1].angles.walk = {"walk", "walk", "walk"}
...
tt.unit.can_explode = false
tt.unit.hit_offset = v(-40, 40)
tt.unit.marker_offset = v(-40, 0)
tt.unit.mod_offset = v(-40, 30)
tt.unit.show_blood_pool = false
tt.unit.size = UNIT_SIZE_LARGE
...
tt.melee.attacks[1].sound = "Stage08OrcChieftainBasicAttack"
tt.melee.attacks[1].sound_args = {
	delay = fts(16)
}
tt.timed_attacks.list[1] = CC("custom_attack")
tt.timed_attacks.list[1].animation = "shout"
tt.timed_attacks.list[1].disabled = true
tt.timed_attacks.list[1].cooldown = 15
tt.timed_attacks.list[1].min_targets = 3
tt.timed_attacks.list[1].range = 1200
tt.timed_attacks.list[1].auras = {"aura_boss_stage_208_shout_stun", "aura_boss_stage_208_shout_buff"}
...
tt.is_pushing_cart = true
tt.speed_cart = 16
tt.speed_cart_rage = 100
tt.normal_speed = 16
tt.rage_hp = 0.7
tt.nodes_to_enrage = 30 + 75
tt.nodes_knockback = 30
tt.loop_walk_every = 8
tt.sound_walk_loop = "Stage08OrcChieftainMoveCartWalk"
tt.sound_death = "Stage08OrcChieftainDeath"
tt.sound_angry = "Stage08StagePhase3Run"
tt.sound_explosion = "Stage08StagePhase3CartExplosion"
tt.explosion_fx = "fx_boss_stage_208_explosion"
tt.fly_bullet = "bullet_boss_stage_208_fly"
tt.sound_steps_t = "controller_stage_208_boss_sound_steps"

tt = RT("decal_boss_stage_208", "decal_timed")
tt.render.sprites[1].prefix = "boss_stage_208_attack_decalDef"
tt.render.sprites[1].name = "decal"
tt.render.sprites[1].exo = true
tt.render.sprites[1].z = Z_DECALS

tt = RT("decal_boss_stage_208_fly_shadow", "decal")
tt.render.sprites[1].prefix = "boss_stage_208_fly_shadowDef"
tt.render.sprites[1].name = "idle"
tt.render.sprites[1].animated = true
tt.render.sprites[1].exo = true
tt.render.sprites[1].z = Z_DECALS

tt = RT("ps_boss_stage_208_fly", "particle_system")
tt.particle_system.animated = true
tt.particle_system.loop = false
tt.particle_system.z = Z_BULLET_PARTICLES
tt.particle_system.name = "stage_208_boss_particles_run"
tt.particle_system.particle_lifetime = {fts(14), fts(14)}
tt.particle_system.emission_rate = 5
tt.particle_system.emit_offset = vv(0)
tt.particle_system.emit_area_spread = v(10, 10)

tt = RT("fx_boss_stage_208_explosion", "fx")
tt.render.sprites[1].prefix = "boss_stage_208_explosionsDef"
tt.render.sprites[1].name = "run"
tt.render.sprites[1].exo = true
tt.render.sprites[1].z = Z_OBJECTS_SKY

tt = RT("bullet_boss_stage_208_fly", "bomb")
tt.bullet.damage_min = 0
tt.bullet.damage_max = 0
tt.bullet.damage_radius = 0
...
tt.bullet.align_with_trajectory = false
tt.bullet.rotation_speed = nil
tt.bullet.particles_name = "ps_boss_stage_208_fly"
...
tt.sound_events.hit = nil
tt.sound_events.insert = nil
tt.render.sprites[1].prefix = "boss_stage_208_flyDef"
...
tt.decal_shadow = "decal_boss_stage_208_fly_shadow"

tt = RT("aura_boss_stage_208_shout_stun", "aura")
tt.aura.radius = 1200
tt.aura.vis_flags = bor(F_AREA)
tt.aura.vis_bans = bor(F_FLYING, F_ENEMY)
tt.aura.cycles = 1
tt.aura.mod = "mod_boss_stage_208_shout_stun"
tt.main_script.insert = scripts.aura_apply_mod.insert
tt.main_script.update = scripts.aura_apply_mod.update

tt = RT("aura_boss_stage_208_shout_buff", "aura")
tt.aura.radius = 1200
tt.aura.vis_flags = bor(F_AREA)
tt.aura.vis_bans = bor(F_FLYING, F_FRIEND)
tt.aura.cycles = 1
tt.aura.mods = {"mod_boss_stage_208_shout_buff_damage", "mod_boss_stage_208_shout_buff_speed"}
tt.aura.allowed_templates = {"enemy_goblin_kr6", "enemy_orc_warrior", "enemy_orc_shaman", "enemy_orc_wildling", "enemy_ogre_kr6"}
tt.main_script.insert = scripts.aura_apply_mod.insert
tt.main_script.update = scripts.aura_apply_mod.update

tt = RT("mod_boss_stage_208_shout_stun", "mod_stun")
tt.modifier.duration = 2
tt.modifier.vis_flags = bor(F_MOD, F_STUN)
tt.modifier.vis_bans = bor(F_ENEMY)

tt = RT("mod_boss_stage_208_shout_buff_damage", "mod_orc_warrior_rage")
