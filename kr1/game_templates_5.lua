...
return function()
	...
	tt.tween.props[4].keys = {{fts(0), vec_2(1, 1)}, {tt.scale_timing - 0.1, vec_2(1, 1)}, {tt.scale_timing + tt.scale_duration, vec_2(1.5, 1.5)}}
	...
	tt.tween.props[1].keys = {{0, vec_2(0, 0)}, {fts(fly_frequency), vec_2(0, fly_strenght)}, {fts(fly_frequency * 2), vec_2(0, 0)}, {fts(fly_frequency * 3), vec_2(0, -fly_strenght)}, {fts(fly_frequency * 4), vec_2(0, 0)}}
	...
	tt.positions = {{{0, vec_2(100, 0)}, {0.3, vec_2(100, 50)}, {0.5, vec_2(50, 0)}, {0.7, vec_2(0, 20)}, {0.8, vec_2(10, -10)}, {1, vec_2(0, 0)}}, {{0, vec_2(0, 0)}, {0.3, vec_2(20, -20)}, {0.7, vec_2(-20, -20)}, {1, vec_2(0, 0)}}, {{0, vec_2(0, 0)}, {0.1, vec_2(-100, 0)}, {0.2, vec_2(-100, -50)}, {0.5, vec_2(-50, 0)}, {0.6, vec_2(-50, 0)}, {0.7, vec_2(0, 0)}, {0.8, vec_2(-20, -10)}, {1, vec_2(0, 0)}}}
	...
	tt.tween.props[1].name = "offset"
	tt.tween.props[1].interp = "sine"
	tt.tween.props[1].keys = {{fts(0), vec_2(0, tt.move_distance)}, {fts(tt.move_frequency), vec_2(0, 15)}, {fts(tt.move_frequency * 2), vec_2(0, tt.move_distance)}}
	tt.tween.props[1].loop = true
	tt.tween.props[1].disabled = true
	tt.tween.props[2] = E:clone_c("tween_prop")
	tt.tween.props[2].name = "offset"
	...
	tt.bullet_formation = {{vec_2(0, 50)}, {vec_2(-20, 30), vec_2(20, 30)}, {vec_2(-20, 30), vec_2(20, 30), vec_2(0, 50)}, {vec_2(-20, 40), vec_2(20, 40), vec_2(0, 60), vec_2(0, 30)}}
	...
	tt.tween.props[1].loop = true
	tt.tween.props[1].interp = "sine"
	tt.tween.props[1].keys = {{fts(0), vec_2(0, 0)}, {fts(tt.tween_frecuency), vec_2(0, tt.tween_amplitude)}, {fts(tt.tween_frecuency * 2), vec_2(0, 0)}}
	...
	tt.auto_player = {}
	tt.auto_player.enemies = {{"enemy_hog_invader", "enemy_tusked_brawler", "enemy_turtle_shaman", "enemy_bear_vanguard", "enemy_cutthroat_rat", "enemy_dreadeye_viper", "enemy_surveyor_harpy", "enemy_skunk_bombardier", "enemy_hyena5", "enemy_rhino"}, {"enemy_acolyte", "enemy_lesser_sister", "enemy_lesser_sister_nightmare", "enemy_unblinded_priest", "enemy_small_stalker", "enemy_unblinded_abomination", "enemy_spiderling", "enemy_unblinded_shackler", "enemy_crystal_golem", "enemy_corrupted_stalker"}, {"enemy_unblinded_abomination", "enemy_glareling", "enemy_blinker", "enemy_mindless_husk", "enemy_vile_spawner", "enemy_noxious_horror", "enemy_hardened_horror", "enemy_evolving_scourge", "enemy_amalgam"}}
	...
	tt.attacks.list[1].bullet_start_offset = {tt.render.sprites[tt.render.moon_sid].offset, tt.render.sprites[tt.render.moon_sid].offset}
	...
	tt.melee.attacks[6].fn_can = function(t, s, a, target)
		return target.health and target.health.hp <= target.health.hp_max * a.hp_trigger and target.unit.size == UNIT_SIZE_SMALL and not t.is_transformed
	end
	...
	tt.excluded_templates = {"enemy_acolyte_tentacle", "enemy_lesser_sister_nightmare", "enemy_spiderling", "enemy_armored_nightmare", "enemy_glareling"}
	...
	tt.render.sprites[1].z = Z_EFFECTS
	tt.render.sprites[2] = E:clone_c("sprite")
	tt.render.sprites[2].size_names = {"display_of_true_might_slow_deco", "display_of_true_might_slow_big_deco", "display_of_true_might_slow_big_deco"}
	...
	tt.pos_aura = {vec_2(661 + tt.portal_offset.x, 280 + tt.portal_offset.y), vec_2(659 + tt.portal_offset.x, 300 + tt.portal_offset.y), vec_2(658 + tt.portal_offset.x, 260 + tt.portal_offset.y)}
	...
	tt.statue_position = {vec_2(sb.x + 975, sb.y + 620), vec_2(sb.x + 1030, sb.y + 650), vec_2(sb.x + 1090, sb.y + 645), vec_2(sb.x + 1133, sb.y + 590)}
	...
	tt.soldier_path_pos = {vec_2(base.x - 20, base.y + 20), vec_2(base.x + 13, base.y + 33), vec_2(base.x + 25, base.y), vec_2(base.x - 10, base.y - 10)}
	...
	tt.boxes_decals = {"decal_item_loot_box_chest_projectile", "decal_item_loot_box_pig_projectile", "decal_item_loot_box_statue_projectile"}
