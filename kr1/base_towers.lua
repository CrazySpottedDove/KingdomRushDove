...
tt.attacks.list[1].bullet_start_offset = {v(8, 66), v(-5, 62)}
tt.render.sprites[1].animated = false
...
tt.attacks.list[1].bullet_start_offset = {v(8, 66), v(-5, 64)}
...
tt.attacks.list[1].bullet_start_offset = {v(8, 70), v(-5, 69)}
...
tt.attacks.list[1].bullet_start_offset = {v(-10, 50), v(10, 50)}
