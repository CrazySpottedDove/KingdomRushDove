...
tt.attacks.list[3].bullet = "bomb_orc_shaman_meteorite"
...
tt.powers.shock.max_level = 3
tt.powers.shock.damage_min = {8, 18, 26}
tt.powers.shock.damage_max = {16, 32, 48}
tt.powers.shock.chance = {0.35, 0.5, 0.65}
tt.powers.meteor = CC("power")
tt.powers.meteor.price_base = 180
tt.powers.meteor.price_inc = 180
tt.powers.meteor.max_level = 3
tt.powers.vines = CC("power")
tt.powers.vines.price_base = 130
tt.powers.vines.price_inc = 130
tt.powers.vines.max_level = 3
tt.powers.vines.heal_inc = 1
tt.render.sprites[1].offset = v(0, 11)
tt.render.sprites[2] = CC("sprite")
...
tt = RT("ps_bolt_orc_shaman", "particle_system")
tt.particle_system.alphas = {255, 0}
tt.particle_system.animated = true
tt.particle_system.emit_area_spread = v(3, 3)
...
tt.render.sprites[4].prefix = "warmongers_mage_tower_shooter_proyectile_hit"
...
tt = RT("bomb_orc_shaman_meteorite", "bomb")
