...
tt.attacks.list[1].bullet = "tower_spirit_mausoleum_bolt"
...
tt.powers.spectral_communion.max_charges = {4, 5}
...
tt.powers.spectral_communion.bullet_list = {"tower_spirit_mausoleum_bolt", "tower_spirit_mausoleum_bolt"}
...
tt = E:register_t("tower_spirit_mausoleum_bolt")
AC(tt, "bullet", "pos", "render", "main_script", "sound_events", "vis", "force_motion")
...
tt.render.sprites[1].z = Z_BULLETS
tt.bullet.damage_type = DAMAGE_MAGICAL
tt.bullet.damage_max = 86
tt.bullet.damage_min = 58
...
tt.render.sprites[1].draw_order = DO_MOD_FX
tt.possession_duration = {10, 12, 14}
...
tt = RT("bolt_possession")
AC(tt, "bullet", "pos", "render", "main_script", "sound_events", "tween", "vis")
