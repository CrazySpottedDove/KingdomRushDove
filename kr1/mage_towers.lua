...
tt.tween.disabled = true
tt.max_skeletons = b.curse.max_skeletons
...
tt.health.hp_max = b.skeleton.hp_max
...
tt.melee.attacks[1].damage_max = b.skeleton.melee_attack.damage_max
tt.melee.attacks[1].damage_min = b.skeleton.melee_attack.damage_min
...
tt.health.hp_max = b.skeleton_golem.hp_max
tt.health_bar.offset = vec_2(0, 47)
tt.health_bar.type = HEALTH_BAR_SIZE_MEDIUM
tt.info.portrait = "kr5_info_portraits_soldiers_0009"
tt.melee.attacks[1].damage_max = b.skeleton_golem.melee_attack.damage_max
tt.melee.attacks[1].damage_min = b.skeleton_golem.melee_attack.damage_min
...
tt.powers.instakill.price_base = b.power_instakill.price
tt.powers.instakill.price_inc = b.power_instakill.price
...
tt.attacks.range = b.mage_basic_attack.range
tt.attacks.list[1] = CC("bullet_attack")
...
tt.attacks.list[2].cooldown = b.gift_of_nature.cooldown[1]
...
tt.attacks.list[3].cooldown = b.wave_of_roots.cooldown[1]
tt.attacks.list[3].node_prediction = fts(20)
tt.attacks.list[3].damage_min = b.wave_of_roots.damage_min[1]
tt.attacks.list[3].damage_max = b.wave_of_roots.damage_max[1]
...
tt.tower.kind = TOWER_KIND_MAGE
tt.tower.price = b_dragons.price
...
tt.attacks.list[1] = CC("custom_attack")
tt.attacks.list[1].cooldown = b_dragons.ranged_attack.cooldown
tt.attacks.list[1].vis_flags = bor(F_RANGED)
tt.attacks.range = b_dragons.ranged_attack.range
...
tt.bullet.min_speed = 90
tt.bullet.max_speed = 180
tt.bullet.damage_min = b_ranged.damage_min
tt.bullet.damage_max = b_ranged.damage_max
