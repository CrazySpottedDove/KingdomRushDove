...
tt.attacks.list[2].vis_flags = bor(F_MOD, F_INSTAKILL, F_EAT, F_RANGED)
tt.attacks.list[2].vis_bans = bor(F_BOSS)
...
tt.bullet.damage_same_target_max = 20
...
tt.powers.skill_debuff.mod_duration = {1, 1, 1}
tt.powers.skill_debuff.aura_duration = {10, 10, 10}
tt.powers.skill_debuff.radius = 125
tt.powers.skill_debuff.cooldown = {20, 16, 12}
tt.powers.skill_debuff.price_base = 120
tt.powers.skill_debuff.price_inc = 120
tt.powers.skill_rider = CC("power")
tt.powers.skill_rider.cooldown = {30, 26, 22}
...
tt.attacks.list[3].min_targets = 2
...
tt.unit.fade_time_after_death = 10
...
tt.modifier_inflicted_damage_factor = {1.5, 2, 2.5}
tt.modifier_duration_config = {1, 1, 1}
...
tt.damage_min_config = {70, 130, 200}
tt.damage_max_config = {70, 130, 200}
...
tt.modifier.duration_config = {1, 1, 1}
...
tt.powers.chain.price_base = 200
tt.powers.chain.price_inc = 200
tt.powers.chain.damage_mult = {0.25, 0.5, 0.75}
tt.powers.sheep = CC("power")
tt.powers.sheep.price_base = 300
tt.powers.sheep.max_level = 1
tt.powers.sheep.cooldown = {20}
tt.main_script.update = scripts.tower_ray.update
tt.main_script.remove = scripts.tower_ray.remove
tt.attacks.min_cooldown = 2
tt.attacks.range = 180
tt.attacks.extra_range = 60
tt.attacks.attack_delay_on_spawn = fts(5)
tt.attacks.list[1] = CC("bullet_attack")
...
tt.attacks.list[1].duration = 4
tt.attacks.list[1].bullet_start_offset = vec_2(0, 93)
tt.attacks.list[2] = table.deepclone(tt.attacks.list[1])
...
tt.attacks.list[3].vis_bans = bor(F_BOSS, F_MINIBOSS)
tt.attacks.list[3].disabled = true
tt.sound_events.insert = "TowerRayTaunt"
tt.tween.remove = false
tt.render.sid_mage = 3
tt.render.sid_crystal_union = 5
tt.render.sid_crystals = 6
...
tt.render.sprites[3] = CC("sprite")
tt.render.sprites[3].prefix = "channeler_tower_lvl4_mage"
tt.render.sprites[3].draw_order = 3
tt.render.sprites[3].offset = vec_2(0, 10)
tt.render.sprites[3].angles = {}
tt.render.sprites[3].angles.idle = {"idle_back", "idle"}
tt.render.sprites[3].angles.attack_start = {"attack_back_start", "attack_start"}
tt.render.sprites[3].angles.attack_loop = {"attack_back_loop", "attack_loop"}
tt.render.sprites[3].angles.attack_end = {"attack_back_end", "attack_end"}
tt.mage_offset = vec_2(0, 10)
tt.shooter_offset = tt.mage_offset
tt.render.sprites[4] = CC("sprite")
tt.render.sprites[4].name = "channeler_tower_towers_decal"
tt.render.sprites[4].animated = false
tt.render.sprites[4].z = Z_DECALS
tt.render.sprites[4].offset = tt.render.sprites[2].offset
tt.render.sprites[5] = CC("sprite")
tt.render.sprites[5].prefix = "channeler_tower_crystal_full"
tt.render.sprites[5].name = "idle"
tt.render.sprites[5].z = Z_OBJECTS + 1
tt.render.sprites[5].offset = tt.attacks.list[1].bullet_start_offset
tt.render.sprites[5].hidden = true
...
tt.render.sid_core_rock_shadow = 26
...
tt.explosion_radius = 55
tt.explosion_factor = 0.2
tt.bullet.damage_type = DAMAGE_MAGICAL
tt.bullet.damage_min = 335
tt.bullet.damage_max = 335
-- dps: 335 / 4.5 = 74.4
tt.bullet.hit_time = fts(2)
...
tt.chain_delay = 0.1
tt.chain_range = 115
tt.chain_range_to_stay = tt.chain_range + 60
tt.vis_bans = F_NONE
...
tt.sheep_hp_mult = 0.7

tt = RT("mod_tower_ray_damage", "modifier")
AC(tt, "render", "dps", "tween")
tt.dps.damage_min = 335
tt.dps.damage_max = 335
tt.dps.damage_type = bor(DAMAGE_MAGICAL, DAMAGE_ONE_SHIELD_HIT)
...
tt.render.sprites[1].scale = vec_1(0.35)
tt.damage_from_bullet = true
tt.damage_tiers = {0.1, 0.15, 0.2, 0.25, 0.3}
...
tt.attacks.list[1].cooldown = 2.7
tt.attacks.list[1].cooldown_base = 2.7
tt.attacks.list[1].shoot_time = fts(15)
tt.attacks.list[1].ray_timing = fts(4)
tt.attacks.list[1].count = 5
tt.attacks.list[1].count_base = 5
tt.attacks.list[1].sound = "TowerElvenStargazersBasicAttack"
tt.attacks.list[1].bullet_start_offset = {vec_2(3, 90), vec_2(3, 90)}
tt.powers.teleport = CC("power")
tt.powers.teleport.price = {250, 175, 175}
tt.powers.teleport.cooldown = {25, 25, 25}
tt.powers.teleport.teleport_nodes_back = {20, 25, 30}
tt.powers.teleport.price_base = 250
tt.powers.teleport.price_inc = 175
tt.powers.stars_death = CC("power")
tt.powers.stars_death.price = {225, 225, 225}
tt.powers.stars_death.price_base = 225
tt.powers.stars_death.price_inc = 225
tt.render.sprites[1].animated = false
tt.render.sprites[1].name = "terrain_mage_%04i"
...
tt.attacks.list[2].vis_flags = bor(F_TELEPORT, F_RANGED)
tt.attacks.list[2].vis_bans = bor(F_BOSS, F_MINIBOSS)
tt.attacks.list[2].shoot_time = fts(31)
tt.attacks.list[2].load_time = fts(13)
tt.attacks.list[2].teleport_nodes_back = 20
tt.attacks.list[2].max_targets = {4, 5, 6}
...
tt.bullet.damage_max_config = {24, 42, 54}
tt.bullet.damage_min_config = {16, 28, 36}
...
tt.modifier.stars_death_min_range = 0
tt.modifier.stars_death_max_range = 120
tt.modifier.stars_death_stars = {3, 4, 5}
...
tt.powers.disintegrate.cooldown = {18, 18, 18}
tt.powers.empowerment = CC("power")
tt.powers.empowerment.price_base = 275
tt.powers.empowerment.price_inc = 200
tt.powers.empowerment.damage_factor = {1.15, 1.25, 1.4}
tt.render.sprites[1].animated = false
tt.render.sprites[1].name = "terrain_mage_%04i"
tt.render.sprites[1].offset = vec_2(0, 13)
for i = 2, 9 do
...
tt.attacks.list[3].max_range = 240
...
tt.modifier.damage = 1
tt.modifier.duration = fts(5)
tt.boss_damage_config = {200, 300, 400}
tt.modifier.allows_duplicates = true
...
AC(tt, "render", "dps")
tt.damage_min = {12, 25, 48, 87}
tt.damage_max = {18, 47, 80, 148}
...
tt.powers.instakill.price_base = 300
tt.powers.instakill.price_inc = 300
tt.powers.instakill.cooldown = {18}
tt.powers.jump = CC("power")
tt.powers.jump.price_base = 120
tt.powers.jump.price_inc = 120
tt.powers.jump.cooldown = {31, 26, 21}
tt.powers.jump.damage_min = {80, 140, 180}
tt.powers.jump.damage_max = {80, 140, 180}
tt.attacks.range = 200
tt.attacks.list[1] = CC("bullet_attack")
...
tt.attacks.list[2].cooldown = 1.3
...
tt.attacks.list[3].vis_flags = bor(tt.attacks.list[3].vis_flags, F_EAT, F_INSTAKILL)
...
tt.aura_duration = {1.75, 1.75, 1.75, 1.75}
...
tt.balance_slow_factor = {0.8, 0.7, 0.6, 0.5}
tt.balance_duration = {0.2, 0.2, 0.2, 0.2}
tt.slow.factor = nil
...
tt.powers.gift_of_nature.price_base = 120
tt.powers.gift_of_nature.price_inc = 120
tt.powers.gift_of_nature.cooldown = {20, 20, 20}
tt.powers.gift_of_nature.aura_duration = {6, 6, 6}
tt.powers.wave_of_roots = CC("power")
tt.powers.wave_of_roots.price_base = 160
tt.powers.wave_of_roots.price_inc = 160
tt.powers.wave_of_roots.cooldown = {15, 14, 12}
tt.powers.wave_of_roots.damage_min = {40, 40, 40}
tt.powers.wave_of_roots.damage_max = {40, 40, 40}
...
tt.attacks.list[1].cooldown = 1.2
tt.attacks.list[1].max_range = {160, 180, 200, 220}
tt.attacks.list[1].shoot_time = fts(20)
...
tt.attacks.list[2].cooldown = 20
tt.attacks.list[2].max_range = 230
...
tt.attacks.list[3].damage_min = 40
tt.attacks.list[3].damage_max = 40
tt.attacks.list[3].damage_type = DAMAGE_TRUE
tt.attacks.list[3].min_targets = 2
tt.attacks.list[3].max_targets = {3, 5, 8}
tt.attacks.list[3].trigger_range = 200
tt.attacks.list[3].effect_range = 220
tt.attacks.list[3].mod = "tower_arborean_emissary_root_stun_mod"
tt.attacks.list[3].mod_duration = {3, 3, 3}
tt.attacks.list[3].wave_of_roots_balance = {
	min_targets = 2,
	trigger_range = 200,
	effect_range = 220,
	price = {160, 160, 160},
...
tt.attacks.list[3].vis_bans = bor(F_FLYING, F_BOSS, F_CLIFF, F_WATER)
...
AC(tt, "render")
tt.received_damage_factor_config = {1.2, 1.3, 1.4, 1.5}
tt.modifier_duration = {5, 5, 5, 5}
...
tt.attacks.list[2].range_factor = 180 / 275
tt.attacks.list[2].min_targets = 3
tt.attacks.list[2].max_targets = 15
tt.attacks.list[2].vis_bans = bor(F_BOSS)
tt.attacks.list[2].vis_flags = bor(F_RANGED)
...
tt.attacks.list[3].range_factor = 500 / 275
tt.attacks.list[3].sound = "TowerHermitToadShootMagic"
tt.attacks.list[3].damage_min = {100, 200, 400}
tt.attacks.list[3].damage_max = {150, 300, 600}
tt.attacks.list[3].damage_radius = {50, 50, 50}
tt.attacks.list[3].damage_min_area = {20, 40, 70}
tt.attacks.list[3].damage_max_area = {30, 60, 100}
tt.attacks.list[3].damage_type = DAMAGE_MAGICAL
tt.powers.dragon_split = CC("power")
tt.powers.dragon_split.cooldown = {9.6, 9.6, 9.6}
tt.powers.dragon_split.price_base = 200
tt.powers.dragon_split.price_inc = 200
tt.powers.massive_fear = CC("power")
tt.powers.massive_fear.cooldown = {15, 12}
tt.powers.massive_fear.price_base = 200
tt.powers.massive_fear.price_inc = 200
tt.powers.massive_fear.stun_duration = {3, 4}
...
tt.flight_height = 80
tt.flight_speed_idle = 80
tt.flight_speed_busy = 800
tt.ramp_dist_idle = 80
tt.ramp_dist_busy = 20
...
tt.modifier.duration = b_ranged.slow_duration
tt.slow.factor = b_ranged.slow_factor
...
tt.info.enc_icon = 10
tt.info.portrait = "kr4_info_portraits_towers_0003"
tt.main_script.update = scripts.tower_infernal_mage.update
...
tt.attacks.list[1].node_prediction = fts(5)
tt.attacks.list[1].shoot_time = fts(21)
tt.attacks.list[1].bullet_start_offset = v(17, 74)
tt.attacks.list[2] = table.deepclone(tt.attacks.list[1])
tt.attacks.list[2].aura = "aura_lava_fissure"
...
tt.attacks.list[2].max_spread = 35
tt.attacks.list[3] = CC("aura_attack")
tt.attacks.list[3].animation = "teleport"
tt.attacks.list[3].shoot_time = fts(15)
tt.attacks.list[3].cooldown = 11
...
tt.attacks.list[4].shoot_time = fts(15)
tt.attacks.list[4].cooldown = 10
tt.attacks.list[4].aura = "aura_curse_infernal"
tt.attacks.list[4].min_nodes = 0
tt.attacks.list[4].node_prediction = fts(5)
...
tt.powers.fissure.cooldown_base = 22
tt.powers.fissure.cooldown_inc = -2
tt.powers.fissure.damage_min = {40, 70, 100}
tt.powers.fissure.damage_max = {70, 100, 130}
tt.powers.teleport = CC("power")
tt.powers.teleport.price_base = 225
tt.powers.teleport.price_inc = 115
tt.powers.teleport.max_count = {4, 6}
tt.powers.teleport.max_level = 2
tt.powers.curse = CC("power")
tt.powers.curse.max_level = 2
tt.powers.curse.price_base = 150
tt.powers.curse.price_inc = 150
tt.render.sprites[1].offset = v(0, 11)
tt.render.sprites[2] = CC("sprite")
tt.render.sprites[2].prefix = "ember_lords_mage_tower_layer1"
tt.render.sprites[2].name = "idle"
tt.render.sprites[2].offset = v(0, 46)
tt.render.sprites[3] = CC("sprite")
tt.render.sprites[3].prefix = "ember_lords_mage_tower_shooter"
tt.render.sprites[3].name = "idle"
tt.render.sprites[3].angles = {
	idle = {"idleUp", "idle"},
	shoot = {"shootUpRight", "shootDownRight"},
	affliction = {"afflictionUp", "afflictionDown"},
	overcharge = {"overchargeUp", "overchargeDown"},
	teleport = {"teleportUp", "teleportDown"}
}
tt.render.sprites[3].offset = v(1, 60)
tt.render.sprites[4] = CC("sprite")
tt.render.sprites[4].prefix = "ember_lords_mage_tower_layer2"
tt.render.sprites[4].name = "idle"
tt.render.sprites[4].offset = v(0, 46)
tt.render.sprites[5] = CC("sprite")
tt.render.sprites[5].prefix = "ember_lords_mage_tower_layer3"
tt.render.sprites[5].name = "idle"
tt.render.sprites[5].offset = v(0, 46)

tt = RT("aura_teleport_infernal", "aura")
AC(tt, "render")
tt.aura.mods = {"mod_teleport_infernal", "mod_lava_infernal_mage"}
...
tt.main_script.insert = scripts.aura_apply_mod.insert
tt.main_script.update = scripts.aura_apply_mod.update
tt.render.sprites[1].name = "ember_lords_mage_tower_shooter_teleport_decal_run"
tt.render.sprites[1].loop = false
tt.render.sprites[1].z = Z_DECALS
...
tt.main_script.insert = scripts.aura_apply_mod.insert
tt.main_script.update = scripts.aura_apply_mod.update
tt.render.sprites[1].name = "ember_lords_mage_tower_shooter_affliction_floor_sign_run"
tt.render.sprites[1].loop = false
tt.render.sprites[1].z = Z_DECALS
tt.render.sprites[1].anchor.y = 0.375
...
tt.bullet.damage_max = 95 --134
tt.bullet.damage_min = 75 --78
tt.bullet.hit_fx = "fx_bolt_infernal_mage_hit"
tt.bullet.pop = nil
tt.bullet.mod = "mod_lava_infernal_mage"
...
tt = E:register_t("mod_lava_infernal_mage", "mod_lava")
...
tt = E:register_t("aura_lava_fissure", "aura")
E:add_comps(tt, "render")
tt.aura.damage_min = 0
tt.aura.damage_max = 0
tt.aura.damage_type = DAMAGE_MAGICAL
tt.aura.radius = 35
tt.main_script.update = scripts.aura_lava_fissure.update
tt.render.sprites[1].anchor.y = 0.2916666666666667
tt.render.sprites[1].prefix = "ember_lords_mage_tower_shooter_overcharge_meteor"
tt.render.sprites[1].loop = false
...
tt.render.sprites[2].name = "ember_lords_mage_tower_shooter_overcharge_meteor_1"
tt.render.sprites[2].animated = true
tt.tween.props[1].keys = {{0, 255}, {fts(4), 255}, {fts(6), 0}}
tt.tween.props[2] = E:clone_c("tween_prop")
tt.tween.props[2].name = "scale"
tt.tween.props[2].keys = {{0, v(1, 1)}, {fts(4), v(1.84, 1.84)}, {fts(6), v(2.17, 2.17)}}
...
tt.tower.menu_offset = v(0, 14)
tt.info.enc_icon = 4
tt.info.portrait = "kr4_info_portraits_towers_0014"
tt.main_script.update = scripts.tower_orc_shaman.update
...
tt.attacks.list[1].shoot_time = fts(9)
tt.attacks.list[1].node_prediction = fts(5)
tt.attacks.list[1].payload_bullet = "bolt_orc_shaman_shock"
tt.attacks.list[1].bullet_start_offset = v(16, 74)
tt.attacks.list[2] = CC("aura_attack")
tt.attacks.list[2].animation = "healingRoots"
tt.attacks.list[2].aura = "aura_orc_shaman_healing_roots"
tt.attacks.list[2].cooldown = 16
tt.attacks.list[2].shoot_time = fts(8)
tt.attacks.list[2].min_health_factor = 0.5
tt.attacks.list[2].vis_flags = bor(F_MOD)
tt.attacks.list[2].vis_bans = bor(F_FLYING)
tt.attacks.list[3] = CC("bullet_attack")
tt.attacks.list[3].animation = "meteorites"
tt.attacks.list[3].bullet = "fireball_orc_shaman_meteorite"
tt.attacks.list[3].cooldown = 16
tt.attacks.list[3].shoot_time = fts(9)
tt.attacks.list[3].loops_base = 3
tt.attacks.list[3].loops = 3
tt.attacks.list[3].loops_inc = 1
tt.attacks.list[3].max_spread = 35
tt.attacks.list[3].vis_flags = bor(F_RANGED, F_AREA)
tt.powers.shock = CC("power")
tt.powers.shock.price_base = 200
tt.powers.shock.price_inc = 200
tt.powers.shock.damage_min = {15, 30, 45}
tt.powers.shock.damage_max = {40, 75, 110}
tt.powers.meteor = CC("power")
...
tt.render.sprites[1].offset = v(0, 11)
tt.render.sprites[2] = CC("sprite")
tt.render.sprites[2].prefix = "warmongers_mage_towers_lvl4_layer1"
tt.render.sprites[2].name = "idle"
...
tt.render.sprites[3].angles = {
	...
	healingRoots = {"healingRootsUp", "healingRootsDown"},
	meteorites = {"meteoritesUp", "meteoritesDown"}
}
tt.render.sprites[3].offset = v(0, 65)
tt.render.sprites[4] = CC("sprite")
tt.render.sprites[4].prefix = "warmongers_mage_towers_lvl4_layer2"
tt.render.sprites[4].name = "idle"
tt.render.sprites[4].offset = v(0, 31)
tt.render.sprites[5] = CC("sprite")
tt.render.sprites[5].prefix = "warmongers_mage_towers_fire"
tt.render.sprites[5].name = "idle"
tt.render.sprites[5].offset = v(32, 36)
tt.render.sprites[6] = table.deepclone(tt.render.sprites[5])
tt.render.sprites[6].offset = v(-30, 36)
tt.render.sprites[7] = table.deepclone(tt.render.sprites[5])
tt.render.sprites[7].offset = v(30, 52)
tt.render.sprites[8] = table.deepclone(tt.render.sprites[5])
tt.render.sprites[8].offset = v(-29, 52)

tt = RT("bolt_orc_shaman")
AC(tt, "bullet", "pos", "sound_events", "main_script")
tt.bullet.damage_min = 101
tt.bullet.damage_max = 221
tt.bullet.damage_type = DAMAGE_MAGICAL
...
tt = RT("fx_bolt_orc_shaman_hit", "fx")
tt.render.sprites[1].prefix = "warmongers_mage_tower_ray"
tt.render.sprites[1].name = "run"
tt.render.sprites[1].offset = v(0, 50)
tt.render.sprites[2] = table.deepclone(tt.render.sprites[1])
tt.render.sprites[2].prefix = "warmongers_mage_tower_ray_hit"
tt.render.sprites[2].name = "run"
tt.render.sprites[2].offset = v(10, 7)
tt.render.sprites[3] = table.deepclone(tt.render.sprites[1])
tt.render.sprites[3].prefix = "warmongers_mage_tower_electroshock"
tt.render.sprites[3].name = "hit"
tt.render.sprites[3].offset = v(0, 0)
tt.render.sprites[3].z = Z_DECALS

tt = RT("bolt_orc_shaman_shock", "bullet")
tt.main_script.update = scripts.bullet_orc_shaman_shock.update
...
tt.aura.mod_enemy = "mod_orc_shaman_heal_enemy"
tt.aura.vis_flags = bor(F_MOD)
tt.aura.vis_bans = bor(F_FLYING)
tt.main_script.insert = scripts.aura_orc_shaman_healing_roots.insert
tt.main_script.update = scripts.aura_orc_shaman_healing_roots.update
tt.render.sprites[1].prefix = "warmongers_mage_tower_shooter_healingRoots"
tt.render.sprites[1].name = "run"
tt.render.sprites[1].loop = false
tt.render.sprites[1].z = Z_DECALS
tt.render.sprites[2] = table.deepclone(tt.render.sprites[1])
tt.render.sprites[2].prefix = "warmongers_mage_tower_shooter_healingRoots_particles"
tt.render.sprites[2].name = "run"
...
tt.render.sprites[1].prefix = "warmongers_mage_tower_shooter_healingRoots_healeffect"
tt.render.sprites[1].name = "run"
tt.render.sprites[1].size_names = {"run", "run", "run"}
...
tt.damage_factor_magical_inc = 0.03
tt.damage_exponent = 1.02
...
tt.bullet.damage_type = DAMAGE_MAGICAL
tt.bullet.damage_flags = F_AREA
tt.bullet.particles_name = "ps_orc_shaman_meteorite"
tt.bullet.hit_fx = "fx_orc_shaman_meteorite_explosion"
tt.bullet.unit_hit_fx = "fx_orc_shaman_meteorite_hit"
tt.bullet.mod = "mod_orc_shaman_meteorite_stun"
tt.main_script.update = scripts.fireball_orc_shaman_meteorite.update
tt.render.sprites[1].prefix = "warmongers_mage_tower_meteorite_lvl4"
tt.render.sprites[1].name = "start"
tt.render.sprites[1].loop = false
tt.render.sprites[1].flip_x = true
tt.render.sprites[1].offset = v(0, 40)
tt.sound_events.hit = "OrcShamanMeteorshowerImpact"

tt = RT("ps_orc_shaman_meteorite", "particle_system")
tt.particle_system.alphas = {255, 0}
tt.particle_system.emit_area_spread = v(3, 3)
tt.particle_system.emission_rate = 80
tt.particle_system.name = "warmongers_mage_tower_shooter_proyectile_particle"
tt.particle_system.particle_lifetime = {fts(10), fts(10)}
tt.particle_system.rotation_spread = math.pi
tt.particle_system.scale_var = {1, 0.8}

tt = RT("fx_orc_shaman_meteorite_explosion", "fx")
tt.render.sprites[1].prefix = "warmongers_mage_tower_lvl4_explotion"
tt.render.sprites[1].name = "run"
...
tt = RT("fx_orc_shaman_meteorite_hit", "fx")
tt.render.sprites[1].prefix = "warmongers_mage_tower_shooter_proyectile_hit"
tt.render.sprites[1].name = "run"

tt = RT("mod_orc_shaman_meteorite_stun", "mod_stun")
tt.modifier.duration = 0.25

-- tower_spirit_mausoleum
image_y = 90
tt = RT("tower_spirit_mausoleum", "tower_mage_1")
...
tt.info.enc_icon = 12
tt.info.portrait = "kr4_info_portraits_towers_0007"
tt.main_script.insert = scripts.tower_barrack.insert
...
tt.attacks.list[2].bullet_start_offset = {v(27, 17), v(29, 34)}
tt.attacks.list[2].bullet = {"fx_bolt_possession_spawn", "bolt_possession"}
tt.attacks.list[2].cooldown = 23
tt.attacks.list[2].vis_bans = bor(F_BOSS, F_FLYING, F_CLIFF, F_WATER)
tt.attacks.list[2].vis_flags = bor(F_RANGED, F_BLOCK, F_POLYMORPH)
tt.attacks.list[2].shoot_time = 0.6
tt.attacks.list[2].min_hp = 500
...
tt.powers.spectral_communion.max_level = 1
tt.powers.spectral_communion.max_charges = {5}
...
tt.powers.gargoyles.spawn_positions = {v(2, -5), v(35, 3)}
...
tt.render.sprites[5].anchor.y = 0.07
...
tt.render.sprites[6].anchor.y = 0.07
tt.render.sprites[6].offset = v(35, 3)
tt.ui.click_rect = r(-43, 0, 86, 68)

tt = E:register_t("aura_spectral_communion", "aura")
tt.main_script.update = scripts.aura_spectral_communion.update
...
tt = RT("fx_tower_spirit_mausoleum_bolt_hit", "fx")
tt.render.sprites[1].name = "spirit_mausoleum_bolt_hit"

tt = RT("bolt_tower_spirit_mausoleum", "bullet")
AC(tt, "force_motion")
...
tt.bullet.destination_offsets = {v(-25, 5), v(25, -5), v(-25, -5), v(25, 5)}
...
tt = RT("fx_bolt_possession_spawn", "fx")
...
tt = RT("fx_bolt_possession_hit", "fx")
...
tt.info.portrait = "kr4_info_portraits_soldiers_0008"
...
tt.melee.attacks[1].hit_time = fts(14)
tt.vis.bans = bor(tt.vis.bans, F_LYCAN, F_CANNIBALIZE, F_POISON, F_SKELETON)
tt.ui.click_rect = r(-15, -2, 30, 35)

-- 深渊恶魔之礁
tt = RT("tower_deep_devils", "tower")
...
tt.main_script.insert = scripts.tower_barrack.insert
tt.main_script.update = scripts.tower_deep_devils.update
tt.main_script.remove = scripts.tower_deep_devils.remove
tt.barrack.soldier_type = "soldier_deep_devils"
...
tt.attacks.list[1].shoot_time = fts(15)
tt.attacks.list[1].bullet_start_offset = {v(10, 88), v(-10, 88)}
tt.attacks.list[1].cooldown = 1.5
tt.attacks.list[1].animation = "shoot"
tt.powers.amph = CC("power")
tt.powers.amph.price_base = 200
tt.powers.amph.max_level = 1
tt.powers.net = CC("power")
tt.powers.net.price_base = 100
tt.powers.net.price_inc = 120
tt.powers.net.max_level = 2
tt.powers.net.cooldown = {14, 12}
tt.powers.storm = CC("power")
tt.powers.storm.price_base = 175
tt.powers.storm.price_inc = 150
tt.render.sprites[1].animated = false
tt.render.sprites[1].name = "terrain_mage_%04i"
tt.render.sprites[1].offset = vec_2(0, 13)
...
tt = E:register_t("ps_bolt_deep_devils")
AC(tt, "pos", "particle_system")
...
tt.main_script.remove = scripts.bolt_tower_deep_devils.remove
tt.render.sprites[1].anchor = v(0.5, 0.5)
tt.render.sprites[1].animated = false
tt.render.sprites[1].name = "deep_devils_reef_tower_shooter_bolt"
tt.sound_events.insert = "BoltSorcererSound"

tt = RT("soldier_deep_devils", "soldier_militia")
AC(tt, "nav_grid", "powers", "ranged")
anchor_y = 0.21
image_y = 42
tt.info.portrait = "kr4_info_portraits_soldiers_0028"
...
tt.ranged.attacks[1].animation = "shoot"
tt.ranged.attacks[1].bullet = "deep_devil_arrow"
tt.ranged.attacks[1].bullet_start_offset = {v(6, 24)}
tt.ranged.attacks[1].cooldown = 2.7
...
tt.ranged.attacks[2].bullet = "net_deep_devils"
tt.ranged.attacks[2].bullet_start_offset = {v(6, 24)}
...
tt.ranged.attacks[2].vis_flags = bor(F_RANGED, F_STUN)
tt.ranged.attacks[2].vis_bans = bor(F_BOSS, F_FLYING)
tt.ranged.attacks[2].sound = "DeepDevilThrow"
tt.ranged.attacks[2].check_target_before_shot = true
tt.render.sprites[1] = CC("sprite")
tt.render.sprites[1].prefix = "deep_devils_reef_tower_redspine_lv4_layer2"
tt.render.sprites[1].name = "idle"
tt.render.sprites[1].offset = v(0, 6)
tt.render.sprites[1].anchor.y = 0.32
tt.render.sprites[1].group = "layers"
tt.render.sprites[2] = table.deepclone(tt.render.sprites[1])
tt.render.sprites[2].prefix = "deep_devils_reef_tower_redspine_lv4_layer3"
tt.render.sprites[3] = table.deepclone(tt.render.sprites[1])
tt.render.sprites[3].prefix = "deep_devils_reef_tower_redspine_lv4_layer4"
tt.render.sprites[3].hidden = true
tt.unit.marker_offset = v(0, ady(8))
tt.unit.mod_offset = v(0, ady(23))

tt = E:register_t("soldier_deep_devils_chosen", "soldier_deep_devils")
...
tt = RT("deep_devil_arrow", "arrow5_fixed_height")
...
tt.bullet.miss_decal_rotation = 0.5 * math.pi
...
tt = RT("deep_devil_arrow_chosen", "deep_devil_arrow")
tt.bullet.damage_max = 60
tt.bullet.damage_min = 45

tt = RT("net_deep_devils1", "bolt")
...
tt.bullet.mod = "mod_deep_devils_net1"
...
tt = RT("net_deep_devils2", "net_deep_devils1")
tt.bullet.mod = "mod_deep_devils_net2"

tt = RT("mod_deep_devils_net1", "mod_stun")
tt.modifier.animation_phases = true
tt.modifier.hide_target_delay = 0
tt.render.sprites[1].prefix = "deep_devils_reef_tower_redspine_skill_net_active"
tt.render.sprites[1].size_scales = {vv(0.8), vv(1.3), vv(1.8)}
tt.render.sprites[1].size_names = nil
tt.modifier.vis_bans = bor(F_BOSS, F_MINIBOSS, F_FLYING)

tt = RT("mod_deep_devils_net2", "mod_deep_devils_net1")
tt.modifier.duration = 4

tt = E:register_t("storm_deep_devils", "decal_scripted")
AC(tt, "ranged")
tt.main_script.update = scripts.storm_deep_devils.update
tt.ranged.attacks[1] = CC("bullet_attack")
tt.ranged.attacks[1].bullet = "ray_storm_deep_devils"
tt.ranged.attacks[1].shoot_time = fts(9)
...
tt = RT("ray_deep_devils", "bullet")
tt.image_width = 72
tt.main_script.update = scripts.ray_simple.update
tt.main_script.insert = scripts.ray_deep_devils.insert
...
tt = RT("mod_ray_high_elven_sentinel_hit_dd", "mod_stun")
...
tt = RT("tower_blazing_watcher", "tower_mage_1")
AC(tt, "powers")
image_y = 90
tt.attack_stage = 1
...
tt.info.portrait = "kr4_info_portraits_towers_0016"
tt.info.enc_icon = 14
tt.info.fn = scripts.tower_blazing_watcher.get_info
...
tt.powers.disintegrate = CC("power")
tt.powers.disintegrate.price_base = 250
tt.powers.disintegrate.price_inc = 160
...
tt.powers.explosion.price_inc = 200
...
tt = E:register_t("mod_blazing_watcher_bolt_blast", "mod_slow")
tt.slow.factor = 0.9

-- 女巫姐妹
tt = RT("tower_wicked_sisters", "tower")
AC(tt, "barrack", "attacks", "powers")
...
tt.render.sprites[3].offset = v(-2, 49)
tt.render.sprites[4] = CC("sprite")
...
tt.attacks.list[2].vis_flags = bor(F_RANGED, F_POLYMORPH, F_INSTAKILL)
tt.powers.frog = CC("power")
tt.powers.frog.cooldown = {22, 18}
tt.powers.silent = CC("power")
tt.powers.silent.cooldown = 15
...
tt.bullet.miss_decal = nil
tt.bullet.hit_blood_fx = "fx_blood_splat_wicked_sisters"
tt.bullet.damage_type = DAMAGE_MAGICAL
tt.render.sprites[1].name = "wicked_sisters_proyectile_travel"
tt.render.sprites[1].animated = true
...
tt.bullet.miss_decal = nil
tt.bullet.damage_type = DAMAGE_MAGICAL
tt.bullet.hit_blood_fx = "fx_blood_splat_wicked_sisters_violet"
tt.render.sprites[1].name = "wicked_sisters_proyectile_violet_travel"
tt.render.sprites[1].animated = true
tt.sound_events.insert = "WickedSistersAttack"
tt.bullet.prediction_error = false
...
tt = RT("fx_wick_pink_splat", "fx")
tt.render.sprites[1].name = "wicked_sisters_proyectile_hit_violet_run"

tt = RT("fx_blood_splat_wicked_sisters", "fx")
AC(tt, "sound_events")
tt.render.sprites[1].name = "wicked_sisters_proyectile_particle_run"
tt.render.sprites[1].anchor.x = 0.42857142857142855
tt.use_blood_color = false
tt.sound_events.insert = "BoltSorcererSound"

tt = RT("fx_blood_splat_wicked_sisters_violet", "fx")
AC(tt, "sound_events")
tt.render.sprites[1].name = "wicked_sisters_proyectile_particle_run"
tt.render.sprites[1].hidden = true
tt.render.sprites[1].anchor.x = 0.42857142857142855
...
tt = RT("ps_bullet_tower_wicked_sisters_violet_trail", "ps_bullet_tower_wicked_sisters_basic_trail")
...
-- Polymorph modifier
tt = RT("fx_mod_polymorph_wicked_sisters_big", "fx")
...
tt.polymorph.hit_fx_sizes = {"fx_mod_polymorph_wicked_sisters_big", "fx_mod_polymorph_wicked_sisters_big", "fx_mod_polymorph_wicked_sisters_big"}
tt.polymorph.pop = {"pop_puff"}
tt.polymorph.transfer_gold_factor = 1
