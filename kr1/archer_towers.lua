...
tt.attacks.list[1].animation = "shoot"
tt.attacks.list[1].bullet = "arrow_tower_shadow_archer"
tt.attacks.list[1].cooldown = 0.7
tt.attacks.list[1].shoot_time = 0.21
tt.attacks.list[1].bullet_start_offset = {v(9, 4), v(6, -5)}
tt.attacks.list[1].shot_fx = "fx_arrow_shadow_shot"
tt.attacks.list[2] = E:clone_c("custom_attack")
tt.attacks.list[2].cooldowns = {45, 39, 33}
tt.attacks.list[2].cooldown = tt.attacks.list[2].cooldowns[1]
...
tt.attacks.list[3].bullet = "arrow_tower_shadow_archer_mark"
tt.attacks.list[3].bullet_start_offset = {v(9, 4), v(6, -5)}
tt.attacks.list[3].shoot_time = 0.21
...
tt.render.sprites[4].offset = v(0, 28)
tt.render.sprites[4].disabled = true
tt.main_script.update = scripts.tower_shadow_archer.update
tt.main_script.remove = scripts.tower_shadow_archer.remove
...
tt.particle_system.name = "arrow_shadow_mark_smoke_run"
...
-- 掷骨者
tt = E:register_t("tower_bone_flingers", "tower_archer_1")
E:add_comps(tt, "powers", "barrack")
tt.info.enc_icon = 11
tt.info.i18n_key = "TOWER_BONE_FLINGERS"
tt.info.portrait = "kr4_info_portraits_towers_0009"
tt.info.fn = scripts.tower_bone_flingers.get_info
...
tt.attacks.list[1] = E:clone_c("bullet_attack")
tt.attacks.list[1].animation = "shooting"
...
tt.render.sprites[3].angles = {
	idle = {"idleUp", "idleDown"},
	shooting = {"shootingUp", "shootingDown"}
}
...
tt.main_script.update = scripts.skeleflingerbomb.update
tt.render.sprites[1].hidden = true
tt.sound_events.hit = nil
tt.sound_events.insert = nil

tt = RT("bone_flingers_skelebomb2", "bone_flingers_skelebomb")
...
tt = RT("bone_flingers_skelefrag2", "bone_flingers_skelefrag")
...
tt.main_script.update = scripts.enemies_skelespawner_bone_flingers.update
tt.render.sprites[1].hidden = true
tt.spawner.count = 1
...
tt.info.portrait = "kr4_info_portraits_soldiers_0007"
...
tt.ranged.attacks[1].bullet = "bone_flingers_bone_golem"
tt.ranged.attacks[1].bullet_start_offset = {v(-9, 41)}
...
E:add_comps(tt, "soldier", "motion", "nav_path", "nav_rally", "main_script", "vis", "info", "lifespan", "melee", "sound_events")
...
tt.melee.attacks[1].sound = "DeathSkeleton"
tt.melee.range = 60
tt.motion.max_speed = 35
tt.nav_path.dir = -1
tt.render.sprites[1].anchor.y = 0.15
tt.render.sprites[1].name = "raise"
tt.render.sprites[1].prefix = "boneflingers_skeleton"
tt.render.sprites[2] = E:clone_c("sprite")
tt.render.sprites[2].is_shadow = true
...
tt.info.portrait = "kr4_info_portraits_soldiers_0004"
tt.melee.attacks[1].damage_max = 25
tt.melee.attacks[1].damage_min = 15
tt.render.sprites[1].prefix = "boneflingers_skeletonwarrior"
