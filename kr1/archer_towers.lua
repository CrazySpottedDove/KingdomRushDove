...
tower_crossbow.attacks.list[1].critical_chance = 0.16
tower_crossbow.attacks.list[1].critical_chance_inc = 0.08
...
tt.attacks.list[2].range_factor = 2
...
tt.attacks.list[4].range_factor = 0.4
...
tt.attacks.list[1].bullet_start_offset = {vec_2(0, 67)}
...
tt.render.sprites[2].offset = vec_2(0, 44)
tt.render.sprites[3] = CC("sprite")
tt.render.sprites[3].angles = {}
tt.render.sprites[3].angles.idle = {"idleUp", "idleDown"}
tt.render.sprites[3].angles.shoot = {"shootingUp", "shootingDown"}
tt.render.sprites[3].name = "idleDown"
tt.render.sprites[3].offset = vec_2(0, 65)
...
tt.render.sprites[4].offset = vec_2(0, 44)
...
tt.bullet.mods = {"mod_arrow_arcane"}
...
tt.bullet.mods = {"mod_arrow_arcane_slumber"}
tt.bullet.particles_name = "ps_arrow_arcane_special"
tt.render.sprites[1].name = "archer_arcane_proy_0001-f"
tt.sound_events.insert = "TowerArcanePreloadAndTravel"
...
tt.attacks.critical_chances = {0.01, 0.06}
tt.attacks.list[1] = CC("bullet_attack")
...
tt.attacks.list[2].bullets = {"arrow_silver_sentence", "arrow_silver_sentence"}
...
tt.attacks.list[2].requires_magic = false
...
tt.powers.skill_soldiers.price_base = 100
tt.powers.skill_soldiers.price_inc = 125
tt.powers.skill_soldiers.cooldown = {1, 1, 1}
tt.powers.skill_soldiers.hp = {50, 115, 180}
tt.powers.skill_soldiers.damage_min = {5, 10, 15}
tt.powers.skill_soldiers.damage_max = {8, 16, 24}
tt.powers.skill_soldiers.dodge_chance = {0.6, 0.6, 0.6}
-- 士兵护甲随技能等级成长（controller_tower_dark_elf_soldiers 按 pow_level 应用）
tt.powers.skill_soldiers.armor = {0.2, 0.25, 0.3}
...
tt.attacks.list[1].bullet_start_offset = {vec_2(-15, 3), vec_2(15, 2)}
tt.attacks.list[1].cooldown = 0.8
tt.attacks.list[2] = CC("bullet_attack")
...
tt.attacks.list[2].bullet_start_offset = {vec_2(-12, 3), vec_2(-12, 2)}
...
tt.attacks.list[3].bullet_start_offset = {vec_2(-17, 8), vec_2(17, 8)}
...
tt.powers.skill_gold.price_base = 200
tt.powers.skill_gold.price_inc = 200
tt.powers.skill_gold.cooldown = 8
tt.powers.skill_big_blade = CC("power")
tt.powers.skill_big_blade.price_base = 200
tt.powers.skill_big_blade.price_inc = 200
tt.powers.skill_big_blade.cooldown = 16
tt.powers.skill_big_blade.damage_min = {5, 8, 12}
tt.powers.skill_big_blade.damage_max = {8, 14, 17}
tt.powers.skill_big_blade.duration = {4, 5, 6}
...
tt.render.sprites[2].offset = vec_2(1, 3)
tt.render.sprites[3] = CC("sprite")
...
tt.render.sprites[4] = table.deepclone(tt.render.sprites[3])
tt.render.sprites[4].offset = vec_2(10, 46)
tt.render.sprites[5] = CC("sprite")
tt.render.sprites[5].animated = false
tt.render.sprites[5].name = "tower_sand_lvl4_tower_front"
tt.render.sprites[5].offset = vec_2(1, 3)
...
tt.render.sprites[1].name = "idle"
tt.bounce_range = 150
tt.bounce_speed_mult = 1.25
tt.bounce_damage_mult = 0.6
tt.sound_hit = "TowerSandBasicAttackHit"

tt = RT("bullet_tower_sand_skill_gold", "bullet_tower_sand_lvl4")
tt.bullet.damage_min_config = {52, 102, 152}
tt.bullet.damage_max_config = {52, 102, 152}
tt.bullet.damage_min = 0
tt.bullet.damage_max = 0
...
tt.attacks.list[2].range_trigger = 140
tt.attacks.list[2].range_effect = 200
tt.attacks.list[2].shoot_time = fts(53)
tt.attacks.list[2].time_between_arrows = fts(0)
tt.attacks.list[2].nearby_range = 100
...
tt.powers.armor_piercer.price_base = 125
tt.powers.armor_piercer.price_inc = 120
tt.powers.armor_piercer.cooldown = {15, 15, 15}
tt.powers.armor_piercer.flight_time_factor = {0.2, 0.4, 0.6}
tt.powers.rapacious_hunter = CC("power")
tt.powers.rapacious_hunter.price_base = 200
tt.powers.rapacious_hunter.price_inc = 110
tt.powers.rapacious_hunter.damage_max = {30, 55, 80}
tt.powers.rapacious_hunter.damage_min = {20, 40, 60}
tt.powers.rapacious_hunter.range_config = {220, 240, 260}
tt.powers.rapacious_hunter.attack_range_factor = {1.1, 1.15, 1.2}
...
tt.max_distance_from_tower = 240
tt.min_distance_to_attack = 60
tt.orbital_speed = 100
tt.attacks.list[1] = CC("custom_attack")
tt.attacks.list[1].damage_min = {20, 40, 60}
tt.attacks.list[1].damage_max = {30, 55, 80}
...
tt.bullet.damage_min_config = {20, 40, 60}
tt.bullet.damage_max_config = {30, 60, 90}
tt.bullet.reduce_armor = {0.11, 0.26, 0.41}
...
tt.attacks.list[2].max_range = 250
tt.attacks.list[2].min_range = 80
...
tt.attacks.list[2].node_prediction = fts(40)
tt.attacks.list[2].damage_type = DAMAGE_EXPLOSION
tt.attacks.list[2].damage_max = {90, 120, 150}
tt.attacks.list[2].damage_min = {60, 80, 100}
tt.attacks.list[2].min_targets = 1
tt.attacks.list[2].sound = "TowerTricannonBasicAttackFire"
tt.powers.skill_final_shot = CC("power")
tt.powers.skill_final_shot.cooldown = {4, 4, 4}
tt.powers.skill_final_shot.price_base = 315
tt.powers.skill_final_shot.price_inc = 210
tt.powers.skill_final_shot.damage_factor = 1.5
tt.powers.skill_final_shot.damage_factor_config = {1.5, 2.1, 2.7}
tt.powers.skill_final_shot.bullet = "bullet_tower_ballista_skill_final_shot"
tt.powers.skill_bomb = CC("power")
tt.powers.skill_bomb.price_base = 150
tt.powers.skill_bomb.price_inc = 175
tt.powers.skill_bomb.cooldown = {20, 17, 14}
tt.powers.skill_bomb.duration = {6, 6, 6}
...
tt.bullet.damage_factor = 1.5
tt.bullet.damage_type = DAMAGE_AGAINST_ARMOR
...
tt.attacks.list[1].cooldown = 0.7
tt.attacks.list[1].shoot_time = fts(14)
tt.attacks.list[1].bullet_start_offset = {v(12, -5), v(6, -5)}
...
tt.attacks.list[3].bullet_start_offset = {v(12, -5), v(6, -5)}
...
tt.sound_events.hit = "TowerShadowMarkHit"
tt.render.sprites[1].scale = v(-1, -1)
...
tt.attacks.list[2].vis_bans = bor(F_FLYING, F_CLIFF)
tt.attacks.list[2].entity = "soldier_flingers_skeleton"
tt.attacks.list[3] = table.deepclone(tt.attacks.list[2])
...
-- 食人魔沉船
tt = E:register_t("tower_ogre_shipwreck", "tower_archer_1")
E:add_comps(tt, "powers", "barrack")
tt.info.enc_icon = 22
...
tt.tower.ogre_shipwreck_multishoot_rage_sound = "OgreShipwreckMusketRage"
tt.tower.ogre_shipwreck_armor_goblin_bullet = "bomb_ogre_shipwreck_goblin_skill2"
tt.tower.ogre_shipwreck_armor_cook_template = "soldier_ogre_shipwreck_cook_enhanced"
tt.tower.ogre_shipwreck_armor_deck_template = "soldier_ogre_shipwreck_deckhand_elite"
tt.tower.ogre_shipwreck_volley_bullet_lv1 = "bullet_ogre_shipwreck_musket_volley"
...
tt.attacks.list[1].cooldown = 1.5
tt.attacks.list[1].shoot_time = fts(4)
tt.attacks.list[1].bullet_start_offset = {v(0, 48), v(0, 48)}
...
tt.attacks.list[2].vis_flags = bor(F_AREA, F_RANGED)
tt.attacks.list[2].vis_bans = bor(F_FLYING)
tt.attacks.list[3] = E:clone_c("bullet_attack")
tt.attacks.list[3].bullet = "bomb_ogre_shipwreck_goblin_skill1"
tt.attacks.list[3].cooldown = 15
tt.attacks.list[3].shoot_time = fts(28)
tt.attacks.list[3].spawn_delay = fts(27)
tt.attacks.list[3].node_prediction = fts(34)
tt.attacks.list[3].bullet_start_offset = v(-39, 18)
tt.attacks.list[3].vis_flags = bor(F_AREA, F_RANGED)
tt.attacks.list[3].vis_bans = bor(F_FLYING)
tt.attacks.list[3].disabled = true
tt.attacks.list[4] = E:clone_c("bullet_attack")
tt.attacks.list[4].bullet = "bullet_ogre_shipwreck_musket_volley_lvl1"
tt.attacks.list[4].cooldown = 15
tt.attacks.list[4].shoot_time = fts(3)
tt.attacks.list[4].near_range = 96
tt.attacks.list[4].shots = 16
tt.attacks.list[4].cycle_time = fts(3)
tt.attacks.list[4].bullet_start_offset = v(0, 48)
tt.attacks.list[4].disabled = true
tt.powers.armor = E:clone_c("power")
tt.powers.armor.price_base = 150
tt.powers.armor.max_level = 1
tt.powers.multishoot = E:clone_c("power")
tt.powers.multishoot.price_base = 150
tt.powers.multishoot.price_inc = 150
...
tt.render.sprites[3].name = "idle"
tt.render.sprites[4] = E:clone_c("sprite")
tt.render.sprites[4].prefix = "ogre_shipwreck_musket"
tt.render.sprites[4].name = "idle"
tt.render.sprites[4].offset = v(0, 55)
tt.render.sid_ogre_door_a = 3
tt.render.sid_ogre_door_b = 5
tt.render.sid_ogre_musket = 4
...
tt.render.sprites[4].angles = {
	idle = {"idleUp", "idle"},
	shoot = {"shootUp", "shootDown"},
	skillin = {"skillUpIn", "skillDownIn"},
	skillloop = {"skillUpLoop", "skillDownLoop"},
	skillend = {"skillUpEnd", "skillDownEnd"}
}
...
tt = RT("bullet_ogre_shipwreck_musket", "shotgun")
tt.bullet.damage_min = 15
tt.bullet.damage_max = 20
tt.bullet.damage_type = DAMAGE_SHOT
tt.bullet.hit_blood_fx = "fx_blood_splat"
tt.bullet.hit_fx = "fx_ogre_shipwreck_musket_hit"
tt.bullet.miss_fx = "fx_smoke_bullet"
tt.bullet.miss_fx_water = "fx_splash_small"
tt.bullet.min_speed = 30 * FPS
tt.bullet.max_speed = 30 * FPS
tt.bullet.hide_radius = 35
tt.bullet.pop = {"pop_thunk"}
tt.sound_events.insert = "ShotgunSound"

tt = RT("bullet_ogre_shipwreck_musket_volley_lvl1", "bullet_ogre_shipwreck_musket")
tt.sound_events.insert = nil
tt.bullet.damage_min = 20

tt = RT("bullet_ogre_shipwreck_musket_volley_lvl2", "bullet_ogre_shipwreck_musket_volley_lvl1")
...
tt.bullet.damage_max = 70
tt.bullet.hide_radius = 13
tt.render.sprites[1].name = "goblin_bomber_projectil_0001"
tt.bullet.hit_fx = "fx_ogre_shipwreck_goblin_burst"
tt.bullet.hit_decal = nil
tt.sound_events.insert = "BombShootSound"
tt.sound_events.hit = "BombExplosionSound"

tt = RT("bomb_ogre_shipwreck_goblin_skill1", "bomb_ogre_shipwreck_goblin")
tt.render.sprites[1].name = "skill_goblin_projectile_basic_0001"
tt.bullet.damage_type = DAMAGE_PHYSICAL
tt.bullet.hit_payload = "soldier_ogre_shipwreck_red_goblin"

tt = RT("bomb_ogre_shipwreck_goblin_skill2", "bomb_ogre_shipwreck_goblin_skill1")
tt.bullet.hit_payload = "soldier_ogre_shipwreck_red_goblin_elite"

tt = E:register_t("fx_ogre_shipwreck_musket_hit", "fx")
tt.render.sprites[1].prefix = "musket_hit"
tt.render.sprites[1].name = "run"

tt = E:register_t("fx_ogre_shipwreck_goblin_burst", "fx")
tt.render.sprites[1].prefix = "goblin_bomber_burst"
tt.render.sprites[1].name = "run"

tt = RT("soldier_ogre_shipwreck_cook", "soldier_militia")
AC(tt, "powers")
tt.powers.armor = CC("power")
tt.info.portrait = "kr4_info_portraits_soldiers_0035"
tt.info.random_name_format = "SHIPWRECK_OGRE_%i_NAME"
...
tt.melee.attacks[1].power_name = "armor"
...
tt.health_bar.type = HEALTH_BAR_SIZE_MEDIUM
tt.health_bar.offset = v(0, ady(65))
...
tt = E:register_t("soldier_ogre_shipwreck_red_goblin", "soldier_militia")
...
tt.tower.price = 270
tt.tower.size = TOWER_SIZE_LARGE
tt.info.portrait = "kr4_info_portraits_towers_0008"
tt.powers.stun = CC("power")
tt.powers.stun.max_level = 1
...
tt.powers.big.damage_min = {75, 95, 115}
tt.powers.big.damage_max = {141, 178, 215}
...
tt.render.sprites[3] = CC("sprite")
tt.render.sprites[3].prefix = "warmongers_archer_tower_shooter"
tt.render.sprites[3].name = "idleDown"
tt.render.sprites[3].angles = {
	idle = {"idleUp", "idleDown"},
	shoot = {"shootUp", "shootDown"},
	big = {"bigUp", "bigDown"},
	bees = {"beesUp", "beesDown"}
}
tt.render.sprites[3].offset = v(-8, 68)
tt.render.sprites[4] = CC("sprite")
tt.render.sprites[4].prefix = "warmongers_archer_tower_shooter"
tt.render.sprites[4].name = "idleDown"
tt.render.sprites[4].offset = v(8, 68)
-- 引用，节约内存
tt.render.sprites[4].angles = tt.render.sprites[3].angles
tt.render.sprites[5] = CC("sprite")
tt.render.sprites[5].animated = false
tt.render.sprites[5].name = "warmongers_archer_tower_lvl4_over"
tt.render.sprites[5].offset = v(0, 38)
tt.main_script.update = scripts.tower_goblirang.update
tt.attacks.range = 175
tt.attacks.list[1] = CC("bullet_attack")
tt.attacks.list[1].animation = "shoot"
tt.attacks.list[1].bullet = "goblirang"
tt.attacks.list[1].cooldown = 1.75
tt.attacks.list[1].shoot_time = fts(10)
tt.attacks.list[1].bullet_start_offset = {v(8, -1), v(4, -10)}
tt.attacks.list[2] = CC("bullet_attack")
tt.attacks.list[2].animation = "big"
tt.attacks.list[2].bullet = "goblirang_big"
tt.attacks.list[2].cooldown = 12
tt.attacks.list[2].shoot_time = fts(22)
tt.attacks.list[2].bullet_start_offset = {v(8, -1), v(4, -10)}
tt.attacks.list[3] = CC("bullet_attack")
tt.attacks.list[3].animation = "bees"
tt.attacks.list[3].bullet = "honey_bees_proy"
tt.attacks.list[3].cooldown = 18
tt.attacks.list[3].shoot_time = 0.2
tt.attacks.list[3].bullet_start_offset = {v(8, -1), v(4, -10)}
tt.attacks.list[3].range = 150
tt.attacks.list[3].vis_bans = bor(F_FLYING)
tt.sound_events.insert = "GoblirangsTaunt"

tt = RT("fx_goblirang_bees", "fx")
tt.render.sprites[1].name = "explosion_honey_bees"

tt = E:register_t("honey_bees_proy", "arrow")
...
tt = RT("honey_bees_aura", "aura")
AC(tt, "render")
tt.aura.cycle_time = 0.3
tt.aura.duration = 7
tt.aura.mods = {"mod_honey_bees", "mod_honey_bees_slow"}
tt.aura.radius = 50
tt.aura.vis_bans = bor(F_FRIEND, F_FLYING)
...
tt.render.sprites[1].name = "honey_bees"
tt.render.sprites[1].offset = v(0, 10)
tt.render.sprites[2] = E:clone_c("sprite")
tt.render.sprites[2].name = "particle_honey_bees"
tt.render.sprites[2].offset = v(0, 10)
tt.sound_events.insert = "GoblirangsBeesHit"

tt = E:register_t("mod_goblirang_slow", "mod_slow")
tt.modifier.duration = 0.1

tt = E:register_t("mod_honey_bees_slow", "mod_slow")
tt.modifier.duration = 1
tt.slow.factor = 0.75

tt = E:register_t("mod_honey_bees", "mod_poison")
tt.dps.damage_min = 0
tt.dps.damage_max = 0
tt.dps.damage_inc = 4
...
tt.particle_system.name = "warmongers_archer_tower_proyectile_particle_lvl4"
tt.particle_system.particle_lifetime = {0.3, 0.3}
tt.particle_system.rotation_spread = math.pi
tt.particle_system.scale_var = {1, 1}
tt.particle_system.scales_x = {1, 1}
tt.particle_system.scales_y = {1, 1}

tt = RT("goblirang", "bullet")
tt.main_script.update = scripts.goblirang.update
...
tt = E:register_t("goblirang_big", "bullet")
tt.main_script.update = scripts.goblirang.update
...
-- 沼泽巨兽
tt = RT("tower_swamp_monster", "tower_archer_1")
AC(tt, "barrack", "powers")
tt.tower_upgrade_persistent_data.max_current_mode = 1
tt.info.portrait = "kr4_info_portraits_towers_0019"
tt.info.fn = scripts.tower_swamp_monster.get_info
tt.info.enc_icon = 18
tt.main_script.insert = scripts.tower_barrack.insert
...
tt.powers.stun = CC("power")
tt.powers.stun.price_base = 120
tt.powers.stun.price_inc = 125
tt.powers.stun.mod_chance_archer = {0.2, 0.4, 0.6}
tt.powers.instakill = CC("power")
tt.powers.instakill.price_base = 240
tt.powers.instakill.price_inc = 180
tt.powers.instakill.chance = {0.2, 0.35, 0.5}
tt.powers.instakill.damage_min_soldier = {121, 132, 143}
tt.powers.instakill.damage_max_soldier = {141, 160, 170}
tt.powers.eat = CC("power")
tt.powers.eat.price_base = 140
...
tt = RT("bullet_swamp_monster", "arrow")
tt.bullet.hit_distance = 50
tt.bullet.hit_fx = "fx_sm_splat"
tt.bullet.miss_fx = "fx_sm_splat"
tt.bullet.miss_decal = nil
tt.bullet.flight_time = fts(18)
tt.render.sprites[1].name = "swamp_monster_tower_proyectile_lvl4"
tt.sound_events.insert = "SwampMonsterAttack"
tt.sound_events.hit = "SwampMonsterExplosion"
tt.bullet.damage_min = 111
tt.bullet.damage_max = 126

tt = RT("bullet_swamp_monster_bomb_tosky", "bullet_swamp_monster")
tt.bullet.hit_fx = "fx_sm_splat_big"
tt.bullet.miss_fx = "fx_sm_splat_big"
tt.bullet.damage_min = 156
tt.bullet.damage_max = 172
tt.bullet.damage_min_inc = 17
tt.bullet.damage_max_inc = 21
tt.bullet.damage_type = DAMAGE_EXPLOSION
tt.render.sprites[1].name = "Swamp_monster_tower_proyectile_instakill_lvl4"

tt = RT("bullet_swamp_monster_bomb", "bomb")
tt.render.sprites[1].name = "Swamp_monster_tower_proyectile_instakill_lvl4"
tt.bullet.damage_min = 104
tt.bullet.damage_max = 115
tt.bullet.damage_min_inc = 10
tt.bullet.damage_max_inc = 17
tt.bullet.damage_radius = 65
tt.bullet.hit_fx = "fx_sm_splat_big"
...
tt = RT("soldier_swamp_monster", "soldier_militia")
AC(tt, "powers", "track_kills")
image_y = 64
anchor_y = 0.22
...
tt.melee.cooldown = 2.75
tt.melee.attacks[1] = CC("area_attack")
tt.melee.attacks[1].count = 5
tt.melee.attacks[1].damage_max = 99
...
tt.melee.attacks[2].damage_max = 99
...
tt.melee.attacks[3].chance_inc = 0.15
tt.melee.attacks[3].damage_radius = 75
...
tt.melee.attacks[3].damage_min = E:get_template("tower_swamp_monster").powers.instakill.damage_min_soldier[1]
tt.melee.attacks[3].damage_max = E:get_template("tower_swamp_monster").powers.instakill.damage_max_soldier[1]
...
tt.unit.mod_offset = v(0, 16)
tt.track_kills.mod = "mod_swamp_eat_slot"
tt.powers.instakill = CC("power")
...
tt.powers.eat.on_power_upgrade = function(this, power_name, power)
	this.track_kills.mod = "mod_swamp_eat"
end
tt.powers.instakill.on_power_upgrade = function(this, power_name, power)
	this.melee.attacks[3].damage_min = E:get_template("tower_swamp_monster").powers.instakill.damage_min_soldier[power.level]
	this.melee.attacks[3].damage_max = E:get_template("tower_swamp_monster").powers.instakill.damage_max_soldier[power.level]
end
tt.vis.bans = bor(tt.vis.bans, F_SKELETON)

tt = RT("mod_swamp_eat_slot", "modifier")
AC(tt, "heal_on_kill")
tt.heal_on_kill.hp = 0
tt.main_script.insert = scripts.mod_heal_on_kill.insert
tt.main_script.update = scripts.mod_heal_on_kill.update

tt = RT("mod_swamp_eat", "modifier")
AC(tt, "render", "heal_on_kill")
tt.render.sprites[1].name = "amazona_healing"
tt.render.sprites[1].hidden = true
tt.render.sprites[1].hide_after_runs = 1
tt.heal_on_kill.hp = 1050
tt.main_script.insert = scripts.mod_heal_on_kill.insert
tt.main_script.update = scripts.mod_heal_on_kill.update
