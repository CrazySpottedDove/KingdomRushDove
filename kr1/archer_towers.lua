...
tt.powers.milk.damage_inc = {6, 12, 18}
tt.powers.golem = E:clone_c("power")
tt.powers.golem.price_base = 250
tt.powers.golem.price_inc = 250
...
tt.vis.bans = bor(F_LYCAN, F_POISON, F_CANNIBALIZE, F_SKELETON)

tt = E:register_t("soldier_flingers_skeleton", "soldier")
E:add_comps(tt, "nav_path", "melee")
...
tt.health_bar.offset.y = tt.health_bar.offset.y + 10
