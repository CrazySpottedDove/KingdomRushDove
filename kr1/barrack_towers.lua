...
tt.melee.attacks[1].shared_cooldown = true
tt.melee.attacks[1].side_effect = scripts.soldier_templar.side_effect_1
...
tt.melee.attacks[2].side_effect = scripts.soldier_templar.side_effect_2
...
tt.revive.resist = {
	bans = bor(F_STUN, F_POISON, F_BURN, F_BLOOD, F_LYCAN),
	duration = 8,
	cost = 0,
...
tt.powers.blade_mail.last_level = 0
tt.ranged.range_while_blocking = true
tt.ranged.go_back_during_cooldown = true
...
tt.tower_upgrade_persistent_data.is_taking_off = {true, true, true, true}
...
tt.powers.healing_prayer.beat_back_damage_value = b.healing_prayer.beat_back_damage_value
tt.melee.range = b.soldier.basic_attack.range
...
tt.timed_attacks.list[1].beat_back_distance = b.healing_prayer.beat_back_distance
tt.timed_attacks.list[1].beat_back_duration = 1
tt.timed_attacks.list[1].beat_back_radius = b.healing_prayer.beat_back_radius
tt.timed_attacks.list[1].beat_back_damage_value = b.healing_prayer.beat_back_damage_value[1]
tt.timed_attacks.list[1].beat_back_damage_type = b.healing_prayer.beat_back_damage_type
...
tt.powers.healing_prayer = CC("power")
tt.powers.healing_prayer.price_base = b.healing_prayer.price[1]
tt.powers.healing_prayer.price_inc = b.healing_prayer.price[2]
...
tt.powers.bloodlust.price_base = 125
tt.powers.bloodlust.price_inc = 125
tt.powers.bloodlust.max_level = 3
tt.powers.bloodlust.damage_factor = {1.72, 2.44, 3.16}
tt.powers.bloodlust.last_damage_factor = 1
tt.powers.promotion = CC("power")
tt.powers.promotion.price_base = 200
tt.powers.promotion.price_inc = 200
tt.powers.promotion.max_level = 1
tt.powers.seal = CC("power")
tt.powers.seal.price_base = 135
tt.powers.seal.price_inc = 135
...
tt = RT("aura_soldier_orc_warrior_regen", "aura")
AC(tt, "regen")
tt.regen.cooldown = 0.125
tt.regen.health = 1
...
tt.timed_attacks.list[1] = CC("mod_attack")
tt.timed_attacks.list[1].animation = "roar"
tt.timed_attacks.list[1].cooldown = 12
tt.timed_attacks.list[1].mod = "mod_soldier_orc_warrior_captain_weak"
tt.timed_attacks.list[1].cast_time = fts(8)
tt.timed_attacks.list[1].range = 80
tt.timed_attacks.list[1].trigger_range = 40
tt.render.sprites[1].prefix = "warmongers_soldier_orc_captain"
tt.render.sprites[2].name = "warmongers_soldier_orc_captain_shadow"

tt = RT("mod_soldier_orc_warrior_captain_weak", "modifier")
AC(tt, "render")
tt.received_damage_factor = 1.25
tt.inflicted_damage_factor = 0.9
...
-- 黑暗骑士
tt = RT("tower_dark_knights", "tower_barrack_1")
AC(tt, "powers")
tt.info.enc_icon = 6
tt.info.portrait = "kr4_info_portraits_towers_0005"
...
tt.powers.instakill.price_base = 200
tt.powers.instakill.price_inc = 200
tt.powers.instakill.max_level = 3
tt.powers.spike = CC("power")
tt.powers.spike.price_base = 130
tt.powers.spike.price_inc = 130
tt.powers.spike.max_level = 3
tt.powers.shield = CC("power")
tt.powers.shield.price_base = 250
tt.powers.shield.price_inc = 250
tt.powers.shield.max_level = 1
tt.render.sprites[1].name = "terrain_barrack_%04i"
tt.render.sprites[1].offset = vec_2(0, 13)
tt.render.sprites[2].prefix = "darkarmy_barrack_tower_lvl4_layer1"
tt.render.sprites[2].animated = true
tt.render.sprites[2].name = "idle"
tt.render.sprites[2].offset = vec_2(0, 30)
tt.render.sprites[3].prefix = "darkarmy_barrack_tower_lvl4_layer2"
tt.render.sprites[3].animated = true
tt.render.sprites[3].name = "close"
tt.render.sprites[3].offset = vec_2(0, 30)
tt.render.sprites[3].loop = false
tt.render.door_sid = 3
tt.sound_events.insert = "TowerDarkKnightsTaunt"
tt.sound_events.change_rally_point = "TowerDarkKnightsMoveTaunt"
tt.main_script.update = scripts.tower_dark_knights.update

tt = RT("soldier_dark_knight", "soldier_militia")
AC(tt, "powers", "dodge")
...
tt.main_script.insert = scripts.soldier_dark_knight.insert
tt.main_script.update = scripts.soldier_dark_knight.update
tt.motion.max_speed = 75
tt.melee.attacks[1].animation = "attack"
...
tt.melee.attacks[2].base_chance = 0
tt.melee.attacks[2].chance_inc = 0.016
tt.melee.attacks[2].cooldown = 1.5
tt.melee.attacks[2].disabled = true
tt.melee.attacks[2].instakill = true
tt.melee.attacks[2].damage_type = bor(DAMAGE_INSTAKILL, DAMAGE_FX_EXPLODE, DAMAGE_NO_DODGE)
tt.melee.attacks[2].pop = {"pop_instakill"}
tt.melee.attacks[2].pop_chance = 1
tt.melee.attacks[2].power_name = "instakill"
tt.melee.attacks[2].forced_cooldown = true
tt.melee.attacks[2].hit_time = fts(50)
tt.melee.attacks[2].sound = "TowerDarkKnightsInstakill"
tt.melee.attacks[2].sound_hit = "TowerDarkKnightsInstakillHit"
tt.melee.attacks[2].vis_flags = F_BLOCK
tt.melee.attacks[2].vis_bans = bor(F_FLYING, F_CLIFF, F_BOSS)
tt.melee.attacks[2].side_effect = function(this, store, target, attack)
	this.melee.attacks[2].chance = this.melee.attacks[2].base_chance
end
tt.melee.forced_cooldown = tt.melee.attacks[1].cooldown
tt.melee.range = 70
tt.dodge.shield = CC("melee_attack")
...
tt.powers.spike = CC("power")
tt.powers.spike.spiked_armor_inc = 15
tt.powers.shield = CC("power")
tt.powers.instakill = CC("power")
