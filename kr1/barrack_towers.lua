...
tt.powers.instakill.chance_inc = 0.02
...
tt = RT("soldier_dark_knight_lvl4", "soldier_militia")
AC(tt, "powers", "dodge")
...
tt.melee.attacks[2].chance_inc = 0.02
...
tt.powers.spike = CC("power")
tt.powers.spike.dark_spiked_armor = {15, 30, 45}
tt.powers.shield = CC("power")
tt.powers.instakill = CC("power")
