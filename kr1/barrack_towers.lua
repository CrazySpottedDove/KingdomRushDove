...
local function barrack_towers()
    ...
    tt.powers.thunder.price_inc = 200
    ...
    tt.powers.hat.price_base = 150
    tt.powers.hat.price_inc = 200
    tt.powers.hat.enc_icon = 39
    tt.powers.hat.name = "hat"
    tt.powers.hat.max_level = 2
    tt.powers.hat.key = "HAT"
    tt.powers.teleport = CC("power")
    tt.powers.teleport.price_base = 150
    tt.powers.teleport.price_inc = 200
