...
tt.health.magic_armor_power_name = "shield"
tt.health.magic_armor_inc = 0.15
...
tt.melee.attacks[3].chance = 0.06
tt.melee.attacks[3].chance_inc = 0.06
tt.melee.attacks[3].damage_max = 35
tt.melee.attacks[3].damage_min = 20
tt.melee.attacks[3].damage_max_inc = 15
tt.melee.attacks[3].damage_min_inc = 10
tt.melee.attacks[3].damage_radius = 50
tt.melee.attacks[3].damage_type = DAMAGE_MAGICAL_EXPLOSION
...
tt.modifier.ban_types = {MOD_TYPE_POISON, MOD_TYPE_BLEED}
...
tt.powers.dual = CC("power")
tt.powers.dual.twister_damage_factor = 0.5
...
tt.powers.blood.vulnerability_factor = 1.035
tt.powers.extralife = CC("power")
tt.powers.extralife.damage_factor = 0.02
tt.powers.extralife.damage_factor_blood = 0.03
...
tt.revive.heal_factor = 0.15
tt.revive.heal_factor_inc = 0.05
...
tt.dodge.survive_cooldown = 20
tt.dodge.survive_ts = 0
tt.health.hp_max = 200
tt.health.instakill_resistance = 0.5
tt.health_bar.offset = vec_2(0, 32.86)
tt.health.on_damage = scripts.soldier_assassin.on_damage
...
tt.melee.attacks[3].disabled = true
tt.melee.attacks[3].hit_time = fts(15)
tt.melee.attacks[3].damage_type = DAMAGE_INSTAKILL
tt.melee.attacks[3].side_effect = scripts.soldier_assassin.instakill_effect
...
tt.beer.attack_cooldown_reduction = 0.4
tt.beer.ts = 0
tt.health.armor = 0.2
...
tt.melee.attacks[1].side_effect = function(this, store, damage, target)
	this.beer.ts = this.beer.ts - this.beer.attack_cooldown_reduction
end
tt.melee.range = 64
tt.powers.armor = CC("power")
tt.powers.beer = CC("power")
...
tt.bullet.damage_min_inc = 11
tt.bullet.damage_max_inc = 11
...
tt.powers.blade_mail.price_base = 120
tt.powers.blade_mail.price_inc = 120
tt.render.sprites[1].name = "terrain_barrack_%04i"
...
tt.melee.attacks[2].damage_inc = 70
...
tt.powers.shield = CC("power")
tt.powers.tear = CC("power")
tt.powers.shield.duration_base = 4
tt.powers.shield.heal_inc = 25
tt.powers.shield.cooldown_base = 20
tt.powers.shield.on_power_upgrade = function(this, power_name, power)
	this.dodge.duration = this.powers.shield.duration_base + power.level
	this.dodge.heal = this.powers.shield.heal_inc * power.level
	this.dodge.cooldown = this.powers.shield.cooldown_base - power.level
end
...
tt.attacks.list[2].retreat_duration = 10
...
tt.powers.hat = CC("power")
tt.powers.hat.cooldown = {8, 8}
tt.powers.hat.range = {180, 200}
tt.melee.range = 90
...
tt.melee.attacks[1].damage_min = 32 / #tt.melee.attacks[1].hit_times
tt.melee.attacks[1].damage_max = 39 / #tt.melee.attacks[1].hit_times
...
tt.attacks.list[1].damage_area = 100
tt.attacks.list[1].min_targets = 2
tt.attacks.list[1].mod = "mod_soldier_tower_pandas_blue_stun"
tt.ranged = nil
tt.powers = {}
tt.powers.thunder = CC("power")
tt.powers.thunder.cooldown = {15, 10}
tt.powers.thunder.range = {180, 180}
tt.powers.thunder.damage_min = {15, 28}
tt.powers.thunder.damage_max = {31, 44}
...
tt.powers = {}
tt.powers.teleport = CC("power")
tt.powers.teleport.cooldown = {20, 15}
tt.powers.teleport.range = {200, 200}
tt.powers.teleport.nodes_offset_min = {-24, -24}
tt.powers.teleport.nodes_offset_max = {-20, -20}
tt.powers.teleport.damage_min = {4, 7}
tt.powers.teleport.damage_max = {7, 11}
tt.attacks.list[1] = CC("custom_attack")
...
tt.attacks.list[1].damage_max = 0
tt.attacks.list[1].damage_type = DAMAGE_TRUE
tt.attacks.list[1].max_targets = 5
...
tt.attacks.list[1].max_times_applied = 3
tt.ranged = nil
tt.ui.click_rect = r(-17, 0, 34, 30)
tt.sound_events.death = "TowerPandasDeath"
tt.sound_events.death_args = {
...
tt.powers.phosphoric.price_base = 250
tt.powers.phosphoric.price_inc = 100
...
tt.health.hp_max = 105
tt.health.armor = 0.5
tt.health_bar.y_offset = 30
tt.motion.max_speed = 250
tt.speed_flight = 250
tt.speed_ground = 75
tt.melee.range = 72
tt.melee.attacks[1].cooldown = 1.8
tt.melee.attacks[1].damage_min = 36
...
tt.melee.attacks[2].damage_area_max = {
	[0] = 17,
	17,
	22,
	27
}
tt.melee.attacks[2].damage_area_min = {
	[0] = 13,
	13,
	18,
	22
}
tt.melee.attacks[2].damage_type = DAMAGE_AGAINST_ARMOR
...
tt.ranged.attacks[3].vis_bans = bor(F_BOSS, F_MINIBOSS)
tt.ranged.attacks[3].mark_mod = "mod_soldier_tower_rocket_gunners_sting_missiles_mark"
tt.powers.phosphoric = CC("power")
tt.powers.phosphoric.damage_factor = {1, 1, 1}
tt.powers.phosphoric.armor_reduction = {0.01, 0.02, 0.03}
tt.powers.sting_missiles = CC("power")
tt.powers.sting_missiles.max_range = {200, 200, 200}
tt.powers.sting_missiles.min_range = {20, 20, 20}
tt.powers.sting_missiles.kill_hp_factor = {0.45, 0.55, 0.65}
...
tt.powers.incendiary_ammo.price_base = 150
tt.powers.incendiary_ammo.price_inc = 175
tt.tower.type = "dwarf"
tt.tower.price = 180
tt.tower.menu_offset = v(0, 35)
...
tt.powers.soul_attack.dead_lifetime_dec = {0.5, 1, 1.5}
...
tt.render.sprites[1].loop = false
tt.render.sprites[1].hidden = true
tt.damage_min = {100, 150, 200}
tt.damage_max = {100, 150, 200}
tt.delay = fts(16)
tt.radius = 120
...
tt.powers.extra_damage = CC("power")
tt.powers.extra_damage.price_base = 150
tt.powers.extra_damage.price_inc = 150
tt.powers.soul_attack = CC("power")
tt.powers.soul_attack.price_base = 150
tt.powers.soul_attack.price_inc = 150
...
tt.sound_events.travel = "TowerGhostSoulAttackTravel"
...
tt.powers.healing_prayer.health_trigger_factor = {0.25, 0.25, 0.25}
tt.powers.healing_prayer.cooldown = {28, 24, 20}
tt.powers.healing_prayer.beat_back_damage_value = {40, 80, 120}
tt.melee.range = 70
...
tt.timed_attacks.list[1].duration = 4
...
tt.timed_attacks.list[1].beat_back_distance = 50
tt.timed_attacks.list[1].beat_back_duration = 1
tt.timed_attacks.list[1].beat_back_radius = 50
tt.timed_attacks.list[1].beat_back_damage_value = 40
tt.timed_attacks.list[1].beat_back_damage_type = DAMAGE_MAGICAL_EXPLOSION
...
tt.hps.heal_min = {4, 7, 10}
tt.hps.heal_max = {4, 7, 10}
...
tt.powers.lead = CC("power")
tt.powers.lead.price_base = 200
tt.powers.lead.price_inc = 200
tt.powers.lead.max_level = 1
tt.powers.healing_prayer = CC("power")
tt.powers.healing_prayer.price_base = 175
tt.powers.healing_prayer.price_inc = 150
...
tt.powers.abomination.price_inc = 200
tt.powers.explosion = CC("power")
tt.powers.explosion.price_base = 200
tt.powers.explosion.price_inc = 120
...
tt.ranged.attacks[1] = CC("bullet_attack")
tt.ranged.attacks[1].animation = "ranged_attack"
tt.ranged.attacks[1].max_range = 218
...
tt.area_attack.max_range = 50
tt.area_attack.radius = 50
tt.area_attack.damage_min = 12
tt.area_attack.damage_max = 20
tt.area_attack.damage_type = DAMAGE_PHYSICAL
tt.area_attack.cooldown_min = 1
...
tt.powers.seal.price_base = 150
tt.powers.seal.price_inc = 150
...
-- 僵尸
tt = E:register_t("tower_grim_cemetery", "tower")
...
tt.info.enc_icon = 13
tt.powers.hands = E:clone_c("power")
tt.powers.hands.price_base = 240
tt.powers.hands.price_inc = 120
...
tt.powers.big = E:clone_c("power")
tt.powers.big.price_base = 150
tt.powers.big.price_inc = 150
tt.powers.big.max_level = 1
tt.main_script.insert = scripts.tower_grim_cemetery.insert
tt.main_script.update = scripts.tower_grim_cemetery.update
tt.main_script.remove = scripts.tower_grim_cemetery.remove
tt.attacks.range = 180
tt.barrack.rally_range = 180
...
tt.render.sprites[3] = E:clone_c("sprite")
tt.render.sprites[3].name = "fallen_ones_grim_cemetery_fog_run"
tt.render.sprites[3].offset = v(0, 23)
tt.render.sprites[4] = E:clone_c("sprite")
tt.render.sprites[4].name = "fallen_ones_grim_cemetery_fog1_run"
tt.render.sprites[4].offset = v(0, 23)
tt.render.sprites[5] = E:clone_c("sprite")
tt.render.sprites[5].name = "fallen_ones_grim_cemetery_fog2_run"
tt.render.sprites[5].offset = v(0, 23)
tt.render.sprites[6] = E:clone_c("sprite")
tt.render.sprites[6].name = "fallen_ones_grim_cemetery_fog3_run"
tt.render.sprites[6].offset = v(0, 23)
tt.sound_events.insert = "GrimCemeteryTaunt"
tt = E:register_t("grim_cemetery_aura", "aura")
tt.main_script.update = scripts.grim_cemetery_aura.update
tt.aura.cycle_time = 0.033
tt.spawn_cooldown = 12
tt.aura.duration = -1
tt.aura.excluded_templates = {"enemy_skeleton", "enemy_skeleton_big", "enemy_lava_elemental", "enemy_cursed_golem", "enemy_cursed_shard"}
tt.entity_small = "soldier_zombie"
tt.entity_medium = "soldier_zombie_medium"
tt.entity_big = "soldier_zombie_big"
tt.min_health_for_medium = 500
tt.pestilence_mod = "mod_grim_cemetery_explode"
tt.spawn_sound = "GrimCemeterySpawn"
tt.zombies = {}
tt = E:register_t("soldier_zombie", "soldier_militia")
tt.info.portrait = "kr4_info_portraits_soldiers_0005"
tt.anchor_y = 0.18
tt.image_y = 50
tt.health.dead_lifetime = 12
...
tt.main_script.update = scripts.soldier_zombie.update
...
tt.render.sprites[2].animated = false
tt.render.sprites[2].anchor.y = 0.142
tt.render.sprites[2].name = "grim_cemetery_zombie_shadow"
tt.render.sprites[2].z = Z_DECALS + 1
...
tt = E:register_t("soldier_zombie_medium", "soldier_zombie")
tt.health_bar.offset = v(0, 35)
tt.health.hp_max = 285
...
tt = E:register_t("soldier_zombie_big", "soldier_zombie")
tt.health_bar.offset = v(0, 35)
tt.health.hp_max = 285
...
tt = E:register_t("aura_grim_cemetery_hand", "aura")
...
tt.aura.vis_flags = bor(F_MOD)
tt.main_script.insert = scripts.aura_grim_cemetery_hand.insert
tt.main_script.update = scripts.aura_grim_cemetery_hand.update
...
tt.modifier.duration = -1
tt.render.sprites[1].prefix = "grim_cemetery_zombie"
tt.render.sprites[1].size_names = {"pestilence", "pestilence", "pestilence"}
tt.render.sprites[1].name = "pestilence"
tt.main_script.insert = scripts.mod_track_target.insert
tt.main_script.update = scripts.mod_grim_cemetery_explode.update
tt.main_script.remove = scripts.mod_grim_cemetery_explode.remove
tt.explode_range = 60
tt.explode_delay = 0.633
tt.explode_damage_type = DAMAGE_MAGICAL
tt.explode_damage = {30, 80}
...
-- 暮光精灵兵营
tt = RT("tower_twilight_elves_barrack", "tower_barrack_1")

AC(tt, "powers")

tt.info.enc_icon = 8
tt.info.portrait = "kr4_info_portraits_towers_0011"
...
tt.powers.backstab.price_base = 210
tt.powers.backstab.price_inc = 180
tt.powers.arrow_storm = CC("power")
tt.powers.arrow_storm.price_base = 140
tt.powers.arrow_storm.price_inc = 140
tt.powers.last_breath = CC("power")
tt.powers.last_breath.max_level = 1
tt.powers.last_breath.price_base = 220
tt.render.sprites[1].name = "terrains_%04i"
tt.render.sprites[1].offset = v(0, 10)
...
tt.dodge.counter_attack.side_effect = scripts.soldier_elves_harasser.backstab_side_effect
tt.dodge.counter_attack.hit_time = 0.1
tt.dodge.counter_attack.power_name = "backstab"
tt.dodge.ranged = true
tt.ranged.attacks[1].animation = "shoot"
tt.ranged.attacks[1].bullet = "elves_soldier_harasser_arrow"
tt.ranged.attacks[1].bullet_start_offset = {v(5, 23)}
...
tt.ranged.attacks[2].bullet_start_offset = {v(4, 22)}
tt.ranged.attacks[2].animations = {"inshoot", "multishoot", "outshoot"}
tt.ranged.attacks[2].loops = 5
tt.ranged.attacks[2].shoot_times = {0.1}
tt.ranged.attacks[2].cooldown = 12
...
tt.powers.arrow_storm = CC("power")
tt.powers.last_breath = CC("power")
tt.death_spawns.name = "soldier_elves_espectral_harasser"
...
tt = RT("elves_soldier_harasser_arrow", "arrow5_fixed_height")
...
tt.bullet.hide_radius = 1
tt.bullet.reset_to_target_pos = true
tt = RT("elves_soldier_harasser_arrow_multishoot", "arrow5_45degrees")
