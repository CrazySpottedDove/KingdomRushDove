...
return {
	...
	chancesToUseNextDifficulty = {0.1, 0.2, 0.2, 0.3, 0.5},
	difficulties = {{
		...
		bossConfig = {
			...
			powerChance = 0.3,
			powerChanceIncrement = 0.02,
			powerDistribution = {0.34, 0.33, 0.33}
		},
		bossWaves = {{
