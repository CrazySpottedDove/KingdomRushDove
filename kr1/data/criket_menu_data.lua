...
local high_level_towers = table.append(table.append(mage, archer, true), table.append(engineer, barrack, true), true)
return table.filter(high_level_towers, function(k, item)
    return item.action ~= "tw_sell" and item.action ~= "tw_rally"
end)
