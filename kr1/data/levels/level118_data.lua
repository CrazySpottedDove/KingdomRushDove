return {
	...
	level_mode_overrides = {{
		...
		available_towers = {"tower_build_flamespitter", "tower_build_ray"},
		locked_towers = {
	...
	required_exoskeletons = {"stage_18_bubblesDef", "stage_18_bubbles_waterDef", "stage_18_light_1Def", "stage_18_light_2Def", "stage_18_light_3Def", "stage_18_light_4Def", "stage_18_tree_1Def", "stage_18_tree_2Def"},
	required_sounds = {"music_stage118", "terrain_4_common", "enemies_terrain_4", "stage_18"},
	required_textures = {"go_enemies_terrain_4", "go_stage118_bg", "go_stage118", "go_stages_terrain4"}
}
