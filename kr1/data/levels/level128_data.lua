return {
	...
	ignore_walk_backwards_paths = {5, 6, 7, 8, 9, 10},
	invalid_path_ranges = {{
		path_id = 1,
		to = 13
	}, {
	...
	level_mode_overrides = {{
		...
		available_towers = {"tower_build_hermit_toad"},
		locked_towers = {
	...
	required_exoskeletons = {"stage_28_antorchasDef"},
	required_sounds = {"music_stage128", "enemies_terrain_spiders", "stage_28"},
	required_textures = {"go_stage128_bg", "go_stage128", "go_enemies_terrain_7"}
}
