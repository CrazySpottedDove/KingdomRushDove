return {
	...
	entities_list = {
		{
			...
			sounds = {"Terrain1AmbienceSoundBirds"}
		},
		{
	...
	level_mode_overrides = {{
		...
		available_towers = {"tower_build_arcane_wizard", "tower_build_tricannon"},
		locked_towers = {"tower_arcane_wizard_lvl3", "tower_tricannon_lvl3"}
	}},
	nav_mesh = {
		{5, nil, nil, 2},
		{3, 1},
	...
	required_exoskeletons = {"Stage02TreePart2Def", "Stage02TreeDef", "stage_2_butterfly_2Def", "stage_2_butterfly_3Def", "stage_2_wisps_1Def", "stage_2_butterfly_1Def", "stage_2_wisps_2Def"},
	required_sounds = {"music_stage102", "enemies_sea_of_trees", "stage_02", "terrain_1_common"},
	required_textures = {"go_enemies_sea_of_trees", "go_stages_sea_of_trees", "go_stage102_bg", "go_stage102"}
}
