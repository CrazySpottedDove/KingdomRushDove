return {
	...
	required_sounds = {"stage_11", "music_stage111", "enemies_terrain_2", "tower_elven_stargazers"},
	required_textures = {"go_enemies_terrain_2", "go_stage111_bg", "go_stage111", "go_stages_terrain2"},
	scale_required_textures = {"go_towers_elven_stargazers"}
}
