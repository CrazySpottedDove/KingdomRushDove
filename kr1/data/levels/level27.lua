...
local x
self.nav_mesh={{4,8,x,2},{3,1,12,31},{x,4,2,31},{x,7,1,3},{x,4,3,31},[7]={x,71,8,4},[8]={7,71,9,1},[9]={71,x,x,8},[10]={8,9,x,12},[12]={31,2,x,x},[31]={x,3,12,x},[71]={x,x,9,7}}
...
U.y_wait_unconditional(store,fts(84))
...
LU.queue_insert(store,shoutbox)
U.y_wait_unconditional(store,fts(95))
LU.queue_remove(store,shoutbox)
shoutbox=E:create_entity("decal_stage01_shoutbox")
shoutbox.pos=shoutbox_pos
shoutbox.texts.list[1].text=_("Muahahahahahahahahaha!")
LU.queue_insert(store,shoutbox)
U.y_wait_unconditional(store,fts(115))
LU.queue_remove(store,shoutbox)
