return {
	...
	ignore_walk_backwards_paths = {1, 4, 5, 6},
	invalid_path_ranges = {},
	level_mode_overrides = {{}, {}, {
		available_towers = {"tower_build_demon_pit", "tower_build_arcane_wizard"},
		locked_towers = {"tower_build_royal_archers", "tower_build_paladin_covenant", "tower_build_tricannon", "tower_build_arborean_emissary", "tower_build_elven_stargazers", "tower_build_rocket_gunners", "tower_build_necromancer", "tower_build_ballista"}
	}},
	nav_mesh = {
		{3, nil, nil, 2},
		{4, 1},
	...
	required_sounds = {"stage_09", "music_stage109", "enemies_terrain_2", "terrain_2_common"},
	required_textures = {"go_enemies_terrain_2", "go_stage109_bg", "go_stage109", "go_stages_terrain2"}
}
