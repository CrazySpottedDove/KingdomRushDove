local log=require("lib.klua.log"):new("level18")
...
elseif store.level_mode==GAME_MODE_IRON and table.contains({"3","4","8"},h.id) then
...
local x
self.nav_mesh={{2,x,x,3},{8,x,1,3},{8,1,4,12},{3,1,x,10},{9,6,12,13},{9,7,3,5},{9,8,3,6},{x,2,3,7},{x,7,5,13},{12,4,4,11},{73,10,x,x},{13,3,10,73},{9,5,12,x},[73]={13,12,11,x}}
local e
local grx=game.game_ref_origin.x
local water_sparks={V.v(25,405),V.v(25,312),V.v(89,512),V.v(232,540),V.v(290,448),V.v(329,367),V.v(350,535),V.v(409,698),V.v(477,531),V.v(446,317),V.v(530,711),V.v(563,332),V.v(576,238),V.v(647,538),V.v(739,590),V.v(731,188),V.v(771,65),V.v(840,585),V.v(816,134),V.v(200,-2),V.v(151,777),V.v(-46,360),V.v(-121,315)}
...
LU.queue_insert(store,e)
self.barricade=e
self.tentacle_pos={{317,295,true},{522,207,true},{695,130,true},{60,437,false},{666,595,true},{626,277,false},{294,612,false}}
self.tentacle_waves={[3]={{3,3}},[6]={{2,5},{9,4}},[9]={{0,2},{8,7},{20,6}},[12]={{1,5},{5,1},{9,6}},[15]={{1,2},{1,6},{6,5},{11,4}}}
self.boss_head_waves={[9]={236,530,true},[12]={236,530,true},[15]={786,590,false}}
self.boss_tentacle_seq={{1,2,3},{5,6,4},{1,2,3},{6,2,5,7},{4,3,6},{1,2,5,7},{1,4,5,7},{1,2,4,5,7},{1,4,5,7},{1,2,4,5,7},{1,4,5,7}}
self.boss_spawn_seq={{0,5,1,{enemy_redspine=2}},{8,5,2,{enemy_deviltide=4}},{10,3,2,{enemy_greenfin=10}},{30,5,3,{enemy_redspine=2}},{40,3,3,{enemy_redspine=2}},{46,5,1,{enemy_deviltide=4}},{48,3,2,{enemy_redspine=2}},{60,3,2,{enemy_deviltide=4}},{60,5,2,{enemy_deviltide=4}},{65,5,3,{enemy_redspine=2}},{75,3,2,{enemy_bloodshell=1}},{76,2,1,{enemy_greenfin=10}},{85,3,2,{enemy_greenfin=10}},{100,2,1,{enemy_deviltide=4}},{100,5,2,{enemy_bloodshell=1}},{115,5,2,{enemy_deviltide=4}},{120,3,2,{enemy_deviltide=4}},{140,3,1,{enemy_bluegale=1,enemy_deviltide=5}},{150,5,1,{enemy_bluegale=1,enemy_deviltide=5}},{157,5,1,{enemy_bloodshell=1}},{157,3,1,{enemy_bloodshell=1}},{160,5,1,{enemy_bloodshell=1}},{160,3,1,{enemy_bloodshell=1}},{163,5,1,{enemy_bloodshell=1}},{163,3,1,{enemy_bloodshell=1}},{166,5,1,{enemy_bloodshell=1}},{166,3,1,{enemy_bloodshell=1}}}
end
...
table.insert(spawn_queue[time],{e,pi})
end
end
