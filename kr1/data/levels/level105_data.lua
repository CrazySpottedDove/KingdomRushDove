return {
	...
	level_mode_overrides = {{}, {}, {
		available_towers = {"tower_build_arcane_wizard", "tower_build_paladin_covenant"},
		locked_towers = {"tower_build_royal_archers", "tower_build_tricannon", "tower_build_arborean_emissary", "tower_build_demon_pit", "tower_build_elven_stargazers"}
	}},
	nav_mesh = {
		{4, 3, nil, 2},
		{7, 4, 1},
	...
	required_exoskeletons = {"stage5TreesDef", "bear_woodcutterDef"},
	required_sounds = {"music_stage105", "enemies_sea_of_trees", "stage_05", "terrain_1_common"},
	required_textures = {"go_enemies_sea_of_trees", "go_stage105_bg", "go_stage105", "go_stages_sea_of_trees"}
}
