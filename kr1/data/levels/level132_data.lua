return {
	...
	level_mode_overrides = {{
		...
		available_towers = {"tower_build_ghost", "tower_build_dwarf"},
		locked_towers = {
	...
	required_sounds = {"music_stage132", "enemies_terrain_wukong_1", "stage_32", "terrain_wukong_common", "tower_royal_archers", "tower_ray"},
	required_textures = {"go_stage132_bg", "go_stage132", "go_enemies_terrain_8_1_a", "go_enemies_terrain_8_1_b", "go_wukong_elemental_holders"},
	scale_required_textures = {"go_towers_ray", "go_towers_royal_archers"}
}
