...
local function y_set_middle_path_walkable(store)
    ...
    local dirt_fx_timings_and_positions = {
        {ts = timing_start + 1.85 + 0,    pos = V.v(moving_island.pos.x + 110, moving_island.pos.y + -50)},
        {ts = timing_start + 1.85 + 0,    pos = V.v(moving_island.pos.x + 125, moving_island.pos.y + -20)},
        {ts = timing_start + 1.85 + 0.1,  pos = V.v(moving_island.pos.x + 100, moving_island.pos.y + 10)},
        {ts = timing_start + 1.85 + 0,    pos = V.v(moving_island.pos.x - 60,  moving_island.pos.y + -50)},
        {ts = timing_start + 1.85 + 0.05, pos = V.v(moving_island.pos.x + 60,  moving_island.pos.y + -30)},
        {ts = timing_start + 1.85 + 0.1,  pos = V.v(moving_island.pos.x + 0,   moving_island.pos.y + -50)},
        {ts = timing_start + 1.85 + 0.15, pos = V.v(moving_island.pos.x + -30, moving_island.pos.y + -30)},
        {ts = timing_start + 1.85 + 0,    pos = V.v(moving_island.pos.x - 60,  moving_island.pos.y + 70)},
        {ts = timing_start + 1.85 + 0.05, pos = V.v(moving_island.pos.x + 60,  moving_island.pos.y + 50)},
        {ts = timing_start + 1.85 + 0.1,  pos = V.v(moving_island.pos.x + 0,   moving_island.pos.y + 70)},
        {ts = timing_start + 1.85 + 0.15, pos = V.v(moving_island.pos.x + -30, moving_island.pos.y + 50)},
        {ts = timing_start + 1.85 + 0.05, pos = V.v(moving_island.pos.x - 100, moving_island.pos.y + 10)},
        {ts = timing_start + 1.85 + 0.15, pos = V.v(moving_island.pos.x - 90,  moving_island.pos.y + -10)},
        {lock_moving_island = true, ts = timing_start + 1.85 + 0.1},
        {hide_storm = true,         ts = timing_start + 1.85 + 0.12},
        {boss_flight = true,        ts = timing_start + 0.6},
        {shake = true,              ts = timing_start + 1.9},
        {holders = true,            ts = timing_start + 1.9},
    }
