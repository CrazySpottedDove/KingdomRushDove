return {
	...
	level_mode_overrides = {{
		...
		available_towers = {"tower_build_sand", "tower_build_necromancer"},
		locked_towers = {
	...
	required_sounds = {"music_stage120", "enemies_terrain_crocs", "tower_ghost", "stage_20"},
	required_textures = {"go_stage120_bg", "go_stage120", "go_enemies_terrain_5"}
}
