return {
	...
	level_mode_overrides = {{
		...
		available_towers = {"tower_build_elven_stargazers", "tower_build_arborean_emissary"},
		locked_towers = {
	...
	required_sounds = {"music_stage131", "enemies_terrain_wukong_1", "stage_31", "terrain_wukong_common", "tower_barrel"},
	required_textures = {"go_stage131_bg", "go_stage131", "go_enemies_terrain_8_1_a", "go_enemies_terrain_8_1_b", "go_wukong_elemental_holders"},
	scale_required_textures = {"go_towers_barrel"}
}
