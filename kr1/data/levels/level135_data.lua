return {
	...
	required_sounds = {"music_stage135", "enemies_terrain_wukong_1", "enemies_terrain_wukong_2", "enemies_terrain_wukong_3", "stage_35", "terrain_wukong_common", "tower_rocket_gunners"},
	required_textures = {"go_stage135_bg", "go_stage135", "go_enemies_terrain_8_1_b", "go_enemies_terrain_8_2_b", "go_enemies_terrain_8_3", "go_wukong_elemental_holders"},
	scale_required_textures = {"go_towers_rocket_gunners", "go_towers_paladin_covenant"}
}
