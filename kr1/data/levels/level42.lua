...
local x
self.nav_mesh={{2,13,141,14},{x,13,1,x},{141,7,4,x},{3,5,6,x},{7,9,6,4},{5,5,x,4},{10,8,5,3},{12,x,9,11},{7,8,x,5},{13,11,7,141},{13,8,7,10},{x,x,8,13},{x,12,10,2},{2,141,3,x},[141]={1,10,3,14}}
local e
local water_sparks={V.v(-110,430),V.v(-20,431),V.v(240,769),V.v(378,708),V.v(411,602),V.v(415,772),V.v(432,538),V.v(453,675),V.v(492,338),V.v(516,399),V.v(516,483),V.v(520,548),V.v(590,453),V.v(617,526),V.v(686,581),V.v(710,660),V.v(764,731),V.v(874,737),V.v(1024,750),V.v(1104,725)}
...
self.gunboat_waves={[2]={{delay=5,shots={0,4,0}}},[4]={{delay=5,shots={4,0,4}}},[6]={{delay=3,shots={4,6,6}}},[8]={{delay=5,shots={5,5,0}}},[11]={{delay=2,shots={11,0,12}}},[14]={{delay=18,shots={0,0,20}}}}
elseif store.level_mode==GAME_MODE_IRON then
self.gunboat_waves={{{delay=0,shots={2,12,4}},{delay=25,shots={2,3,4}},{delay=57,shots={4,4,3}},{delay=85,shots={3,0,2}},{delay=123,shots={3,3,3}},{delay=185,shots={3,3,35}},{delay=200,shots={3,27,0}},{delay=210,shots={25,0,0}},{delay=280,shots={3,3,25}},{delay=290,shots={3,17,0}},{delay=300,shots={15,0,0}}}}
end
end
