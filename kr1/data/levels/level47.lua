...
function level:load(store)
	...
	LU.queue_insert(store, e)
	local trees = {v(-2, 445), v(98, 449), v(162, 512), v(67, 376), v(197, 400), v(225, 471)}
	...
	e.pos = v(61, 493)
	LU.queue_insert(store, e)
	local stones = {{2, v(103, 111), 0.175}, {3, v(41, 161), 0.0625}, {4, v(425, 291), 0.1625, true}}
	...
	local torches = {v(85, 643), v(130, 630), v(283, 564), v(329, 552), v(372, 564), v(663, 564), v(708, 552), v(751, 564), v(1007, 670)}
	...
	if store.level_mode == GAME_MODE_CAMPAIGN then
		self.moon_controller.waves = {{2, fts(780), 15}, {6, fts(1100), 8}, {7, fts(700), 25}, {11, fts(800), 32}, {12, fts(590), 35}, {13, fts(1200), 10}, {15, fts(2300), 400000}}
	elseif store.level_mode == GAME_MODE_HEROIC then
		self.moon_controller.waves = {{5, fts(1400), 15}, {6, fts(2100), 10}}
	elseif store.level_mode == GAME_MODE_IRON then
		self.moon_controller.waves = {{1, fts(1), 400000}}
	end
	...
	if store.level_mode == GAME_MODE_CAMPAIGN then
		e.spawner_waves = {
			{{0.6666666666666666, 0.5, 7, 0, 5, true, 2, 3, "enemy_halloween_zombie"}, {6.666666666666667, 0.5, 102, 0, 4, true, 2, 3, "enemy_halloween_zombie"}},
			{{6.666666666666667, 0.5, 4, 0, 4, true, 2, 3, "enemy_halloween_zombie"}, {26.333333333333332, 0.5, 103, 0, 3, true, 2, 3, "enemy_halloween_zombie"}},
			{{2, 0.5, 103, 0, 4, true, 2, 3, "enemy_halloween_zombie"}, {13.333333333333334, 0.5, 8, 0, 3, true, 2, 6, "enemy_ghost"}, {18.333333333333332, 0.5, 9, 0, 4, true, 2, 6, "enemy_ghost"}},
			{{19.666666666666668, 0.5, 102, 0, 1, true, 2, 3, "enemy_ghoul"}},
			{{13.333333333333334, 0.5, 102, 0, 2, true, 3, 5, "enemy_ghoul"}, {0.6666666666666666, 0.5, 1000, 0, 2, true, 3, 3, "elvira_bat"}, {35, 0.5, 1000, 0, 3, true, 2, 2, "elvira_bat"}, {60, 0.5, 1000, 0, 4, true, 1, 1, "elvira_bat"}},
			[8] = {{5, 0.5, 1002, 0, 2, true, 2, 2, "elvira_bat"}, {5.666666666666667, 0.5, 1003, 0, 2, true, 3, 3, "elvira_bat"}, {10, 0.5, 1000, 0, 2, true, 2, 2, "elvira_bat"}, {10.066666666666666, 0.5, 1001, 0, 2, true, 3, 3, "elvira_bat"}, {18.333333333333332, 0.5, 1002, 0, 3, true, 2, 2, "elvira_bat"}, {28.333333333333332, 0.5, 1001, 0, 3, true, 1, 1, "elvira_bat"}, {43.333333333333336, 0.5, 1100, 0, 3, true, 3, 3, "elvira_bat"}},
			[9] = {{3.3333333333333335, 0.5, 1002, 0, 3, true, 3, 5, "elvira_bat"}, {6.666666666666667, 0.5, 1000, 0, 3, true, 3, 3, "elvira_bat"}, {10, 0.5, 100, 0, 3, true, 2, 6, "enemy_halloween_zombie"}, {50, 0.5, 1000, 0, 3, true, 1, 1, "elvira_bat"}, {46.666666666666664, 0.5, 1002, 0, 3, true, 1, 1, "elvira_bat"}},
			[10] = {{0.6666666666666666, 0.5, 102, 0, 2, true, 4, 5, "enemy_ghost"}, {20, 0.5, 8, 0, 4, true, 2, 2, "enemy_ghost"}, {60, 0.5, 102, 0, 5, true, 2, 3, "enemy_ghost"}},
			[11] = {{0.6666666666666666, 0.5, 1100, 0, 2, true, 2, 2, "elvira_bat"}, {16.666666666666668, 0.5, 1000, 0, 2, true, 2, 2, "elvira_bat"}, {16.666666666666668, 0.5, 1002, 0, 2, true, 2, 2, "elvira_bat"}, {30.333333333333332, 0.5, 1100, 0, 2, true, 2, 2, "elvira_bat"}, {50, 0.5, 1100, 0, 2, true, 1, 1, "elvira_bat"}},
			[12] = {{20, 0.5, 102, 0, 2, true, 4, 5, "enemy_ghost"}, {36.666666666666664, 0.5, 102, 0, 3, true, 2, 2, "enemy_ghost"}, {60, 0.5, 102, 0, 5, true, 2, 3, "enemy_ghost"}},
			[13] = {{3.3333333333333335, 0.5, 1003, 0, 3, true, 1, 1, "elvira_bat"}, {2.6666666666666665, 0.5, 7, 0, 5, true, 1, 3, "enemy_halloween_zombie"}, {8.333333333333334, 0.5, 1001, 0, 3, true, 1, 1, "elvira_bat"}, {7.666666666666667, 0.5, 3, 0, 6, true, 1, 3, "enemy_halloween_zombie"}, {16.666666666666668, 0.5, 1000, 0, 3, true, 1, 1, "elvira_bat"}, {15.666666666666666, 0.5, 103, 0, 3, true, 1, 3, "enemy_halloween_zombie"}, {40, 1.5, 1100, 0, 3, true, 1, 1, "elvira_bat"}, {266.6666666666667, 1.5, 100, 0, 2, true, 3, 5, "enemy_halloween_zombie"}, {40, 0.5, 100, 0, 2, true, 5, 5, "enemy_ghoul"}},
			[15] = {{60, 0.5, 103, 0, 2, true, 2, 2, "enemy_ghoul"}, {60, 0.5, 3, 0, 1, true, 2, 2, "enemy_ghoul"}},
			BOSS = {
				{0, 0, 2001, 2, 2, true, 2, 2, "elvira_bat"},
				{0, 0, 2001, 3, 2, true, 2, 2, "elvira_bat"},
				{17, 0, 1000, 2, 3, true, 8, 8, "elvira_bat"},
				{17, 0, 1000, 3, 3, true, 8, 8, "elvira_bat"},
				{15, 0, 1000, 1, 3, true, 8, 8, "elvira_bat"},
				{5, 0, 2002, 2, 6, true, 3, 6, "enemy_ghost"},
				{5, 0, 2002, 3, 6, true, 3, 6, "enemy_ghost"},
				{21.666666666666668, 0, 102, 0, 3, true, 2, 2, "enemy_halloween_zombie"},
				{21.666666666666668, 0, 1000, 0, 9, true, 3, 6, "elvira_bat"},
				{55, 0, 102, 0, 4, true, 3, 4, "enemy_halloween_zombie"},
				{60, 0, 102, 0, 2, true, 3, 5, "enemy_ghoul"},
				{65, 0, 2001, 0, 12, true, 1, 1, "elvira_bat"},
				{71, 0, 1000, 0, 5, true, 1, 1, "elvira_bat"},
				{73, 0, 1001, 0, 5, true, 1, 1, "elvira_bat"},
				{71.66666666666667, 0, 102, 0, 2, true, 1, 2, "enemy_halloween_zombie"},
				{76.66666666666667, 0, 9, 0, 5, true, 2, 4, "enemy_ghoul"}
			},
			BOSS_ANGRY = {{6.666666666666667, 0, 2001, 2, 10, false, 3, 3, "elvira_bat"}, {8.666666666666668, 0, 2001, 3, 10, false, 3, 3, "elvira_bat"}, {13.333333333333334, 0, 1000, 0, 10, false, 3, 3, "elvira_bat"}, {15.333333333333334, 0, 1001, 0, 5, false, 6, 8, "elvira_bat"}, {83.33333333333333, 0, 1002, 3, 10, false, 4, 4, "elvira_bat"}, {85.33333333333333, 0, 1002, 2, 6, false, 4, 4, "elvira_bat"}, {85.33333333333333, 0, 1002, 1, 3, false, 6, 8, "elvira_bat"}}
		}
	elseif store.level_mode == GAME_MODE_HEROIC then
		e.spawner_waves = {
			[3] = {{16.666666666666668, 0.5, 1002, 0, 2, true, 6, 6, "elvira_bat"}, {16.666666666666668, 0.5, 1003, 0, 2, true, 6, 6, "elvira_bat"}},
			[4] = {{10, 0.5, 1002, 0, 4, true, 1, 1, "elvira_bat"}, {25, 0.5, 1002, 0, 4, true, 3, 3, "elvira_bat"}, {28.333333333333332, 0.5, 1003, 0, 2, true, 1, 1, "elvira_bat"}, {43.333333333333336, 0.5, 1002, 0, 4, true, 2, 2, "elvira_bat"}}
		}
	elseif store.level_mode == GAME_MODE_IRON then
