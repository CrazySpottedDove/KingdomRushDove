...
self.boss_waves={[2]={{"taunt",fts(20)}},[3]={{"summoner",fts(10),0,0,150},{"summoner",fts(500),0,0,150},{"summoner",fts(1000),0,0,150}},[5]={{"summoner",fts(50),1,1,180},{"summoner",fts(650),1,1,180},{"summoner",fts(1150),1,1,180}},[6]={{"powers",fts(50),1500,4,5,{0,1},11}},[8]={{"summoner",fts(80),2,0,200},{"summoner",fts(300),2,1,200},{"summoner",fts(700),2,0,200},{"summoner",fts(950),2,1,200}},[9]={{"powers",fts(150),2500,4,5,{1,0},9},{"powers",fts(1250),2500,3,4,{0.25,0.75},15}},[11]={{"summoner",fts(20),3,0,250},{"summoner",fts(420),4,1,250},{"summoner",fts(1000),3,0,250},{"summoner",fts(1000),4,1,250}},[12]={{"powers",fts(10),3500,4,5,{0.3,0.7},17},{"powers",fts(950),3500,3,4,{0.3,0.7},15}},[15]={{"summoner",fts(20),5,0,250},{"summoner",fts(20),5,1,250},{"powers",fts(250),4500,3,4,{0.3,0.7},15},{"powers",fts(850),4500,3,4,{0.3,0.7},15},{"summoner",fts(1050),5,0,250},{"summoner",fts(1050),5,1,250},{"fight",fts(2300)},{"summoner",fts(6000),5,1,300},{"summoner",fts(6000),5,0,300}}}
self.boss_fight_rounds={{5000,4,5,{0.5,0.7},20,{6,6},{4,2,4},2,3},{5000,3,4,{0,1},20,{7,7},{5,3,5},5,3},{7000,2,3,{0,1},12,{7,7,7},{5,3,2},2,3}}
end
