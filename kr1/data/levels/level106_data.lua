return {
	...
	entities_list = {
		{
			...
			sounds = {"Terrain1AmbienceSoundWind"}
		},
		{
	...
	ignore_walk_backwards_paths = {4, 5},
	invalid_path_ranges = {},
	level_mode_overrides = {{}, {}, {
		available_towers = {"tower_build_royal_archers", "tower_build_demon_pit"},
		locked_towers = {"tower_build_arcane_wizard", "tower_build_paladin_covenant", "tower_build_tricannon", "tower_build_arborean_emissary", "tower_build_elven_stargazers"}
	}},
	nav_mesh = {
		{4, 3, nil, 2},
		{5, 1},
	...
	required_exoskeletons = {"GoregrindDef", "GoregrindPoolDef"},
	required_sounds = {"music_stage106", "enemies_sea_of_trees", "stage_06", "terrain_1_common"},
	required_textures = {"go_enemies_sea_of_trees", "go_stage106_bg", "go_stage106", "go_stages_sea_of_trees"}
}
