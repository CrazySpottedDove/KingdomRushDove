return {
	...
	entities_list = {
		...
		},
		{
			...
			sounds = {"Terrain6AmbienceSoundForge"}
		},
		{
	...
	ignore_walk_backwards_paths = {5, 6, 9},
	invalid_path_ranges = {},
	level_mode_overrides = {{
		...
		available_towers = {"tower_build_ray", "tower_build_dwarf"},
		locked_towers = {
	...
	required_sounds = {"music_stage124", "terrain_6_common", "enemies_terrain_6", "stage_24", "tower_dwarf"},
	required_textures = {"go_enemies_terrain_6", "go_stage124_bg", "go_stage124", "go_stages_terrain6"},
	scale_required_textures = {"go_towers_dwarf"}
}
