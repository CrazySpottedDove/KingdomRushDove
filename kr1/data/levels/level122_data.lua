return {
	...
	level_mode_overrides = {{
		...
		available_towers = {"tower_build_dark_elf", "tower_build_barrel"},
		locked_towers = {
	...
	required_sounds = {"music_stage122", "enemies_terrain_crocs", "stage_22"},
	required_textures = {"go_stage122_bg", "go_stage122", "go_enemies_terrain_5"},
	scale_required_textures = {"go_towers_hermit_toad"}
}
