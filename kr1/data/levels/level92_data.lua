return {
    ...
    level_mode_overrides = {{
        ...
        locked_towers = {"tower_build_engineer", "tower_build_mage", "tower_ballista_lvl4", "tower_musketeer",
                         "tower_sand_lvl4", "tower_archer_dwarf", "tower_pirate_watchtower", "tower_dark_elf_lvl4",
                         "tower_baby_ashbite", "tower_rocket_gunners_lvl4"},
        max_upgrade_level = 6
    }},
