return {
	...
	level_mode_overrides = {{
		...
		locked_towers = {"tower_build_engineer", "tower_build_barrack"},
		max_upgrade_level = 6
	}},
	...
	required_textures = {"go_stage92_bg", "go_stages_jungle", "go_enemies_jungle", "go_stage36", "go_stage35", "go_krdove_enemy_shaman_gravity", "go_stage34"}
}
