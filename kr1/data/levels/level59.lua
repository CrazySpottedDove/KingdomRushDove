...
function level:load(store)
	...
	self.portal_packs = {
		[0] = {{"enemy_satyr_cutthroat", 20, 1, 0}, {"enemy_satyr_cutthroat", 0, 1, 1}, {"enemy_satyr_cutthroat", 20, 1, 2}, {"enemy_satyr_cutthroat", 0, 1, 0}},
		{{"enemy_satyr_hoplite", 20, 1, 0}, {"enemy_satyr_cutthroat", 0, 1, 2}, {"enemy_satyr_cutthroat", 20, 1, 1}, {"enemy_satyr_cutthroat", 0, 1, 2}, {"enemy_satyr_cutthroat", 20, 1, 1}},
		{{"enemy_twilight_elf_harasser", 0, 1, 2}, {"enemy_twilight_elf_harasser", 20, 1, 1}, {"enemy_twilight_scourger", 0, 1, 0}},
		{{"enemy_twilight_scourger", 20, 1, 0}, {"enemy_twilight_scourger", 0, 1, 1}, {"enemy_twilight_scourger", 0, 1, 2}},
		{{"enemy_twilight_avenger", 30, 1, 0}, {"enemy_twilight_elf_harasser", 0, 1, 1}, {"enemy_twilight_elf_harasser", 0, 1, 2}},
		{{"enemy_twilight_scourger", 20, 1, 0}, {"enemy_twilight_elf_harasser", 0, 1, 1}, {"enemy_twilight_elf_harasser", 20, 1, 2}, {"enemy_twilight_elf_harasser", 0, 1, 1}, {"enemy_twilight_elf_harasser", 20, 1, 2}},
		{{"enemy_satyr_cutthroat", 0, 1, 1}, {"enemy_satyr_cutthroat", 50, 1, 2}, {"enemy_twilight_scourger", 0, 1, 1}, {"enemy_twilight_scourger", 50, 1, 2}, {"enemy_satyr_cutthroat", 0, 1, 0}, {"enemy_satyr_cutthroat", 0, 1, 1}, {"enemy_satyr_cutthroat", 50, 1, 2}, {"enemy_satyr_cutthroat", 0, 1, 1}, {"enemy_satyr_cutthroat", 50, 1, 2}},
		{{"enemy_twilight_scourger", 50, 1, 0}, {"enemy_twilight_avenger", 50, 2, 1}, {"enemy_twilight_avenger", 50, 0, 2}, {"enemy_twilight_avenger", 0, 1, 1}},
		{{"enemy_twilight_avenger", 0, 1, 1}, {"enemy_twilight_avenger", 70, 1, 2}, {"enemy_twilight_elf_harasser", 0, 2, 1}, {"enemy_twilight_elf_harasser", 70, 0, 2}, {"enemy_twilight_scourger", 0, 1, 1}, {"enemy_twilight_scourger", 70, 1, 2}, {"enemy_twilight_elf_harasser", 0, 1, 1}, {"enemy_twilight_elf_harasser", 70, 1, 2}, {"enemy_twilight_elf_harasser", 0, 1, 0}}
	}
	...
	self.boss_waves = {
		[2] = {{"taunt", fts(20)}},
		[3] = {{"summoner", fts(10), 0, 0, 150}, {"summoner", fts(500), 0, 0, 150}, {"summoner", fts(1000), 0, 0, 150}},
		[5] = {{"summoner", fts(50), 1, 1, 180}, {"summoner", fts(650), 1, 1, 180}, {"summoner", fts(1150), 1, 1, 180}},
		[6] = {{"powers", fts(50), 1800, 4, 5, {0, 1}, 13}},
		[8] = {{"summoner", fts(80), 2, 0, 200}, {"summoner", fts(300), 2, 1, 200}, {"summoner", fts(700), 2, 0, 200}, {"summoner", fts(950), 2, 1, 200}},
		[9] = {{"powers", fts(150), 3000, 4, 5, {1, 0}, 11}, {"powers", fts(1250), 3000, 3, 4, {0.25, 0.75}, 18}},
		[11] = {{"summoner", fts(20), 3, 0, 250}, {"summoner", fts(420), 4, 1, 250}, {"summoner", fts(1000), 3, 0, 250}, {"summoner", fts(1000), 4, 1, 250}},
		[12] = {{"powers", fts(10), 4200, 4, 5, {0.3, 0.7}, 20}, {"powers", fts(950), 4200, 3, 4, {0.3, 0.7}, 18}},
		[15] = {{"summoner", fts(20), 5, 0, 250}, {"summoner", fts(20), 5, 1, 250}, {"powers", fts(250), 5400, 3, 4, {0.3, 0.7}, 18}, {"powers", fts(850), 5400, 3, 4, {0.3, 0.7}, 18}, {"summoner", fts(1050), 5, 0, 250}, {"summoner", fts(1050), 5, 1, 250}, {"fight", fts(2300)}, {"summoner", fts(6000), 5, 1, 300}, {"summoner", fts(6000), 5, 0, 300}}
	-- 0
	}
