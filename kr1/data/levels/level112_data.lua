return {
	...
	entities_list = {
		{
			...
			sounds = {"Terrain3AmbienceSoundGutural"}
		},
		{
		...
		},
		{
			...
			waves = {{2, 12, 25}, {5, 35, 15}, {8, 5, 25}, {11, 10, 20}, {13, 15, 25}, {14, 10, 20}, {15, 50, 15}}
		},
		{
			template = "controller_terrain_3_local_glare",
			["editor.game_mode"] = 2,
		...
		},
		{
			...
			waves = {{1, 10, 25}, {1, 90, 25}, {1, 210, 40}, {1, 270, 40}}
		},
		{
	...
	ignore_walk_backwards_paths = {5, 6},
	invalid_path_ranges = {},
	level_mode_overrides = {{
		...
		available_towers = {"tower_build_rocket_gunners", "tower_build_flamespitter"},
		locked_towers = {"tower_build_royal_archers", "tower_build_arcane_wizard", "tower_build_tricannon", "tower_build_arborean_emissary", "tower_build_demon_pit", "tower_build_elven_stargazers", "tower_build_ballista", "tower_build_necromancer", "tower_build_paladin_covenant", "tower_build_barrel"}
	}},
	nav_mesh = {
		{2},
		{4, 3, 1},
	...
	required_exoskeletons = {"BKtentacleDef", "stage_12_glareDef", "t3_windmillDef", "stranger_thingsDef", "stage_12_sheepyDef"},
	required_sounds = {"music_stage112", "stage_12", "terrain_3_common", "enemies_terrain_3", "tower_sand"},
	required_textures = {"go_enemies_terrain_3", "go_stage112_bg", "go_stage112", "go_stages_terrain3"},
	scale_required_textures = {"go_towers_sand"}
}
