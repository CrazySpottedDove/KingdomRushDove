return {
	...
	ignore_walk_backwards_paths = {11},
	invalid_path_ranges = {},
	level_mode_overrides = {{
		...
		available_towers = {"tower_build_hermit_toad", "tower_build_sparking_geode"},
		locked_towers = {
	...
	required_sounds = {"music_stage134", "enemies_terrain_wukong_2", "stage_34", "terrain_wukong_common"},
	required_textures = {"go_stage120", "go_stage134_bg", "go_stage134", "go_enemies_terrain_8_2_a", "go_enemies_terrain_8_2_b", "go_enemies_terrain_8_4", "go_wukong_elemental_holders"}
}
