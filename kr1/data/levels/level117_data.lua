return {
	...
	level_mode_overrides = {{
		...
		available_towers = {"tower_build_rocket_gunners", "tower_build_demon_pit"},
		locked_towers = {"tower_build_arcane_wizard", "tower_build_paladin_covenant", "tower_build_tricannon", "tower_build_arborean_emissary", "tower_build_elven_stargazers", "tower_build_necromancer", "tower_build_barrel", "tower_build_ghost", "tower_build_ray", "tower_build_royal_archers"}
	}},
	nav_mesh = {
		{13, 2},
		{3, 4, 1, 1},
	...
	required_sounds = {"music_stage117", "stage_17", "terrain_4_common", "enemies_terrain_4"},
	required_textures = {"go_enemies_terrain_4", "go_stage117_bg", "go_stage117", "go_stages_terrain4"}
}
