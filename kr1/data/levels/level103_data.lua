return {
	...
	level_mode_overrides = {{
		...
		available_towers = {"tower_build_royal_archers", "tower_build_paladin_covenant"},
		locked_towers = {"tower_royal_archers_lvl4", "tower_paladin_covenant_lvl4"}
	}},
	nav_mesh = {{4, 2}, {4, 3, nil, 1}, {8, nil, nil, 2}, {5, nil, 1}, {6, nil, 4}, {7, nil, 5}, {9, nil, 6}, {
		[3] = 3,
		[4] = 10
	}, {nil, 10, 7}, {nil, 8, nil, 9}},
	...
	required_sounds = {"music_stage103", "enemies_sea_of_trees", "stage_03", "terrain_1_common"},
	required_textures = {"go_enemies_sea_of_trees", "go_stage103_bg", "go_stage103", "go_stages_sea_of_trees"}
}
