return {
	...
	entities_list = {
		...
		},
		{
			...
			eyes_t = {"decal_terrain_3_glare_eye_big_stage_15", "decal_terrain_3_glare_eye_small_1_stage_15", "decal_terrain_3_glare_eye_small_2_stage_15", "decal_terrain_3_glare_eye_small_3_stage_15"},
			pos = {
				x = 570,
				y = 374
			},
			waves = {{1, 6, 25}, {3, 6, 30}, {6, 6, 25}, {7, 10, 30}, {10, 6, 30}, {11, 6, 45}, {13, 6, 30}, {15, 6, 30}, {16, 6, 30}}
		},
		{
			template = "controller_terrain_3_local_glare",
			["editor.game_mode"] = 2,
			...
			waves = {{2, 10, 26}, {3, 30, 30}, {5, 10, 30}, {6, 40, 25}}
		},
		{
			template = "controller_terrain_3_local_glare",
			["editor.game_mode"] = 3,
			...
			waves = {{1, 45, 25}, {1, 115, 30}, {1, 170, 35}, {1, 273, 35}}
		},
		{
	...
	ignore_walk_backwards_paths = {1, 5},
	invalid_path_ranges = {},
	level_mode_overrides = {{
		...
		available_towers = {"tower_build_rocket_gunners", "tower_build_ray"},
		locked_towers = {"tower_build_royal_archers", "tower_build_arcane_wizard", "tower_build_tricannon", "tower_build_arborean_emissary", "tower_build_demon_pit", "tower_build_elven_stargazers"}
	}},
	nav_mesh = {
		{4, nil, nil, 2},
		{3, 1, nil, 3},
	...
	required_exoskeletons = {"BKtentacle_S15Def", "stage_15_glareDef", "mydrias_finalstage_topDef", "mydrias_finalstage_bottomDef", "mutamydriasDef", "mutamydrias_ray_decalDef", "mutamydrias_rayDef", "t3stage15_eastereggDef", "t3stage15_easteregg_tempportalDef"},
	required_sounds = {"music_stage115", "terrain_3_common", "enemies_terrain_3", "stage_15", "stage_11", "tower_necromancer"},
	required_textures = {"go_enemies_terrain_3", "go_stage115_bg", "go_stage115", "go_stages_terrain3"},
	scale_required_textures = {"go_towers_necromancer"}
}
