return {
	...
	entities_list = {
		...
		},
		{
			...
			sounds = {"Terrain4AmbienceSoundWind"}
		},
		{
	...
	ignore_walk_backwards_paths = {5, 6, 7, 8},
	invalid_path_ranges = {},
	level_mode_overrides = {{
		...
		available_towers = {"tower_build_tricannon", "tower_build_arborean_emissary"},
		locked_towers = {
	...
	required_exoskeletons = {"spawner_mausoleumDef", "spawner_mausoleum_lightDef", "stage_19_statue_decoDef", "stage_19_bubblesDef", "stage_19_bubbles_waterDef", "stage_19_smokeDef"},
	required_sounds = {"music_stage119", "stage_19", "terrain_4_common", "enemies_terrain_4", "tower_dark_elf"},
	required_textures = {"go_enemies_terrain_4", "go_stage119_bg", "go_stage119", "go_stages_terrain4"},
	scale_required_textures = {"go_towers_dark_elf"}
}
