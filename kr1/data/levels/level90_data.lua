return {
	...
	required_sounds = {"FrontiersJungleAmbienceSounds", "music_stage33"},
	required_textures = {"go_enemies_sarelgaz", "go_stage90_bg", "go_enemies_jungle", "go_enemies_rotten", "go_enemies_underground", "go_enemies_ancient_metropolis", "go_stage13"}
}
