...
local data = {
    ...
    path_enemy_map = {
        ...
        [11] = {"enemy_shaman_priest", "enemy_shaman_magic", "enemy_shaman_rage", "enemy_shaman_shield",
                "enemy_shaman_necro", "enemy_shaman_gravity"}
    } -- 每条路径允许出哪些敌人
    ,
    enemy_weight_map = {
        ["enemy_cannibal"] = 1,
