...
GS.archer_towers = {"tower_archer_1", "tower_archer_2", "tower_archer_3", "tower_ranger", "tower_musketeer", "tower_crossbow",
            "tower_totem", "tower_archer_dwarf", "tower_pirate_watchtower", "tower_arcane", "tower_silver","tower_dark_elf_lvl4","tower_sand_lvl4","tower_royal_archers_lvl4","tower_ballista_lvl4"}
...
GS.engineer_towers = {"tower_engineer_1", "tower_engineer_2", "tower_engineer_3", "tower_bfg", "tower_tesla", "tower_dwaarp",
            "tower_mech", "tower_frankenstein", "tower_druid", "tower_entwood","tower_tricannon_lvl4","tower_demon_pit_lvl4", "tower_flamespitter_lvl4", "tower_barrel_lvl4"}
...
GS.last_level = 26
GS.heroes_require_scaled_texture = {
--     ["hero_hunter"] = true,
--     ["hero_raelyn"] = true,
