...
tt.hero.skills.ultimate = CC("hero_skill")
tt.hero.skills.ultimate.xp_gain = {80, 160, 240, 320}
tt.hero.skills.ultimate.xp_level_steps = {
	[1] = 1,
	[4] = 2,
	[7] = 3,
...
tt.hero.skills.ultimate.max_targets = {6, 8, 10, 12}
...
tt.hero.level_stats.melee_damage_max = {9, 11, 13, 16, 18, 20, 23, 25, 27, 29}
tt.hero.level_stats.melee_damage_min = {6, 8, 9, 11, 12, 13, 14, 17, 18, 19}
tt.hero.level_stats.ranged_damage_max = {12, 16, 20, 24, 28, 33, 37, 42, 48, 52}
tt.hero.level_stats.ranged_damage_min = {6, 8, 10, 12, 14, 18, 20, 23, 25, 28}
tt.hero.level_stats.selfdestruct_damage_config = {50, 50, 50, 50, 75, 75, 75, 75, 100, 100}
tt.hero.level_stats.regen_health = {16, 17, 18, 20, 21, 22, 24, 25, 27, 28}
tt.regen.cooldown = 1
tt.render.sprites[1].anchor.y = 0.12
tt.render.sprites[1].name = "idle"
tt.render.sprites[1].scale = v(1.2, 1.2)
...
-- 3技能 地狱注入
tt = RT("range_mod_oloch", "modifier")
AC(tt, "render", "tween")
tt.modifier.duration = 6
tt.range_factor = 1.0
tt.range_factor_inc = 0
tt.main_script.insert = scripts.range_mod_oloch.insert
tt.main_script.remove = scripts.range_mod_oloch.remove
tt.main_script.update = scripts.range_mod_oloch.update
tt.tween.remove = false
tt.tween.props[1].name = "scale"
tt.tween.props[1].loop = true
...
tt = RT("mod_hero_oloch_ultimate_mark", "modifier")
AC(tt, "mark_flags")
tt.mark_flags.vis_bans = F_TELEPORT
tt.modifier.duration = fts(50)
