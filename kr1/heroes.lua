...
tt.ranged.attacks[1].cooldown = 22.5
...
tt = RT("arrow_hero_builder_defensive_turret", "arrow5")
...
tt.hero.skills.double_trouble.hr_cost = {2, 2, 2}
...
tt.hero.skills.wild_eruption.hr_cost = {2, 2, 2}
