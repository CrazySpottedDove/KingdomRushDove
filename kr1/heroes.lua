...
tt.hero.level_stats.ranged_damage_max = {31, 37, 42, 48, 54, 61, 68, 74, 81, 87}
...
tt.hero.skills.smash.damage_min = {26, 31, 41}
tt.hero.skills.smash.damage_max = {35, 42, 52}
tt.hero.skills.smash.stun_chance = {0.3, 0.4, 0.5}
...
tt.hero.skills.fissure.damage_min = {5, 14, 23, 32}
tt.hero.skills.fissure.damage_max = {25, 34, 43, 52}
...
tt.hero.level_stats.melee_damage_max = {22, 23, 25, 27, 28, 30, 32, 34, 36, 38}
tt.hero.level_stats.melee_damage_min = {9, 9, 10, 10, 11, 22, 12, 13, 13, 14}
...
tt.hero.skills.timber.cooldown = {28.5 + fts(35), 24.5 + fts(35), 20.5 + fts(35)}
...
tt.hero.skills.lethalstrike.damage_min = {240, 360, 480}
tt.hero.skills.lethalstrike.damage_max = {240, 360, 480}
...
tt.hero.level_stats.armor = {0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05}
...
tt.melee.range = 51.2
tt.melee.attacks[1] = CC("melee_attack")
tt.melee.attacks[1].cooldown = 1.45 - fts(23) + fts(9)
tt.melee.attacks[1].damage_max = nil
tt.melee.attacks[1].damage_min = nil
tt.melee.attacks[1].hit_time = fts(9)
tt.melee.attacks[1].sound = "MeleeSword"
...
tt.ranged.attacks[1].cooldown = 1.45
tt.timed_attacks.list[1] = CC("bullet_attack")
tt.timed_attacks.list[1].disabled = true
...
tt.timed_attacks.list[2].damage_type = DAMAGE_RUDE
tt.timed_attacks.list[2].loops = nil
tt.timed_attacks.list[2].range = 100
...
tt.hero.level_stats.melee_damage_max = {8, 10, 11, 12, 13, 14, 16, 17, 18, 19}
tt.hero.level_stats.melee_damage_min = {6, 6, 7, 8, 9, 10, 10, 11, 12, 13}
tt.hero.level_stats.ranged_damage_min = {14, 15, 17, 18, 20, 22, 26, 27, 29, 30}
