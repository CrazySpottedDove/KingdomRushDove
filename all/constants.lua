...
DAMAGE_NONE = 0
DAMAGE_MAGICAL_GROUP = DAMAGE_MAGICAL + DAMAGE_MAGICAL_EXPLOSION
DAMAGE_PHYSICAL_GROUP = DAMAGE_PHYSICAL + DAMAGE_EXPLOSION + DAMAGE_SHOT + DAMAGE_RUDE + DAMAGE_STAB + DAMAGE_ELECTRICAL
DR_NONE = 0
DR_DAMAGE = 1
DR_KILL = 2
DR_ARMOR = 4
...
TERRAIN_STYLE_WILDBOAR = 8
TERRAIN_STYLE_TEMPLE = 1
TERRAIN_STYLE_ROTTEN = 1
TERRAIN_STYLE_ROTTEN = 1
TERRAIN_STYLE_ANGER = 1
TERRAIN_STYLE_HUNGER = 1
TERRAIN_STYLE_DWARF = 1
TERRAIN_STYLE_FACTORY = 1
TERRAIN_STYLE_WUKONG_1 = 1
TERRAIN_STYLE_WUKONG_2 = 1
TERRAIN_STYLE_WUKONG_3 = 1
TERRAIN_STYLE_WUKONG_4 = 1
TERRAIN_STYLE_WUKONG_5 = 1
TERRAIN_STYLE_WUKONG_6 = 1
TERRAIN_STYLE_WUKONG_7 = 1
TERRAIN_STYLES = {
