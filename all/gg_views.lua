...
GGImageButton.static.init_arg_names = {"default_image_name", "hover_image_name", "click_image_name"}
...
GGToggleButton.static.init_arg_names = {"true_image_name", "false_image_name"}
...
GG9SlicesView.static.init_arg_names = {"size", "slices_prefix", "direction"}
GG9SlicesView.static.image_suffixes = {"lt", "ct", "rt", "lc", "cc", "rc", "lb", "cb", "rb"}
...
GGLayout.static.init_arg_names = {"size", "layout", "space"}
...
GGExo.static.init_arg_names = {"size", "exo_name", "exo_animation", "exo_scale_factor"}
