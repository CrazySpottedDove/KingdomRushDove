...
function particle_system:init(store)
	self.phase_interp = phase_interp
	store.particle_systems = {}
end

function particle_system:on_insert_unconditional(entity, store)
...
function particle_system:on_remove_unconditional(entity, store)
	if entity.particle_system then
		local ps = entity.particle_system
...
function particle_system:on_render_update(dt, ts, store)
