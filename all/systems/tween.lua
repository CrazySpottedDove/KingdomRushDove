...
function tween:init(store)
	store.entities_with_tween = {}
end

function tween:on_insert_unconditional(entity, store)
...
function tween:on_render_update(dt, ts, store)
...
function tween:on_remove_unconditional(entity, store)
	if entity.tween then
