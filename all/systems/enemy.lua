...
function enemy:on_insert_unconditional(entity, store)
...
function enemy:on_remove_unconditional(entity, store)
	if entity.enemy then
		-- spatial index
...
function enemy:on_update(dt, ts, store)
	perf.start("enemy")
