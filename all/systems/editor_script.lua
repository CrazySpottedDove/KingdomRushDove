...
editor_script.name = "editor_script"

function editor_script:on_insert(entity, store)
...
function editor_script:on_remove(entity, store)
...
function editor_script:on_update(dt, ts, store)
